...
Game = __TS__Class()
Game.name = "Game"
__TS__ClassExtends(Game, LuaObject)
function Game.prototype.____constructor(self)
    ...
    self.SETTINGS = {
        COMP = {name = "", prev_name = "", submission_name = nil, score = 0},
        ...
        WINDOW = {
            ...
            DISPLAYS = {{
                ...
                screen_resolutions = {strings = {}, values = {}},
                DPI_scale = 1,
                MONITOR_DIMS = {width = 0 / 0, height = 0 / 0}
            }}
        },
    ...
    self.COLLABS = {pos = {Jack = {x = 0, y = 0}, Queen = {x = 1, y = 0}, King = {x = 2, y = 0}}, options = {Spades = {
        "default",
        "collab_TW",
        "collab_CYP",
        "collab_SK",
    ...
    self.ASSET_ATLAS = {Planet = {}, Tarot = {}, Spectral = {}}
    self.MOVEABLES = {}
    self.ANIMATIONS = {}
    self.DRAW_HASH = {}
    ...
    self.C = {
        ...
        MONEY = HEX(_G, "f3b958"),
        XMULT = HEX(_G, "FE5F55"),
        FILTER = HEX(_G, "ff9a00"),
        BLUE = HEX(_G, "009dff"),
        RED = HEX(_G, "FE5F55"),
        GREEN = HEX(_G, "4BC292"),
        PALE_GREEN = HEX(_G, "56a887"),
        ORANGE = HEX(_G, "fda200"),
        IMPORTANT = HEX(_G, "ff9a00"),
        GOLD = HEX(_G, "eac058"),
        YELLOW = {1, 1, 0, 1},
        CLEAR = {0, 0, 0, 0},
        WHITE = {1, 1, 1, 1},
        PURPLE = HEX(_G, "8867a5"),
        BLACK = HEX(_G, "374244"),
        L_BLACK = HEX(_G, "4f6367"),
        GREY = HEX(_G, "5f7377"),
        CHANCE = HEX(_G, "4BC292"),
        JOKER_GREY = HEX(_G, "bfc7d5"),
        VOUCHER = HEX(_G, "cb724c"),
        BOOSTER = HEX(_G, "646eb7"),
        EDITION = {1, 1, 1, 1},
        DARK_EDITION = {0, 0, 0, 1},
        ETERNAL = HEX(_G, "c75985"),
        PERISHABLE = HEX(_G, "4f5da1"),
        RENTAL = HEX(_G, "b18f43"),
        DYN_UI = {
            MAIN = HEX(_G, "374244"),
            DARK = HEX(_G, "374244"),
            BOSS_MAIN = HEX(_G, "374244"),
            BOSS_DARK = HEX(_G, "374244"),
            BOSS_PALE = HEX(_G, "374244")
        },
        SO_1 = {
            Hearts = HEX(_G, "f03464"),
            Diamonds = HEX(_G, "f06b3f"),
            Spades = HEX(_G, "403995"),
            Clubs = HEX(_G, "235955")
        },
        SO_2 = {
            Hearts = HEX(_G, "f83b2f"),
            Diamonds = HEX(_G, "e29000"),
            Spades = HEX(_G, "4f31b9"),
            Clubs = HEX(_G, "008ee6")
        },
        SUITS = {
            Hearts = HEX(_G, "FE5F55"),
            Diamonds = HEX(_G, "FE5F55"),
            Spades = HEX(_G, "374649"),
            Clubs = HEX(_G, "424e54")
        },
        UI = {
            TEXT_LIGHT = {1, 1, 1, 1},
            TEXT_DARK = HEX(_G, "4F6367"),
            TEXT_INACTIVE = HEX(_G, "88888899"),
            BACKGROUND_LIGHT = HEX(_G, "B8D8D8"),
            BACKGROUND_WHITE = {1, 1, 1, 1},
            BACKGROUND_DARK = HEX(_G, "7A9E9F"),
            BACKGROUND_INACTIVE = HEX(_G, "666666FF"),
            OUTLINE_LIGHT = HEX(_G, "D8D8D8"),
            OUTLINE_LIGHT_TRANS = HEX(_G, "D8D8D866"),
            OUTLINE_DARK = HEX(_G, "7A9E9F"),
            TRANSPARENT_LIGHT = HEX(_G, "eeeeee22"),
            TRANSPARENT_DARK = HEX(_G, "22222222"),
            HOVER = HEX(_G, "00000055")
        },
        SET = {
            Default = HEX(_G, "cdd9dc"),
            Enhanced = HEX(_G, "cdd9dc"),
            Joker = HEX(_G, "424e54"),
            Tarot = HEX(_G, "424e54"),
            Planet = HEX(_G, "424e54"),
            Spectral = HEX(_G, "424e54"),
            Voucher = HEX(_G, "424e54")
        },
        SECONDARY_SET = {
            Default = HEX(_G, "9bb6bdFF"),
            Enhanced = HEX(_G, "8389DDFF"),
            Joker = HEX(_G, "708b91"),
            Tarot = HEX(_G, "a782d1"),
            Planet = HEX(_G, "13afce"),
            Spectral = HEX(_G, "4584fa"),
            Voucher = HEX(_G, "fd682b"),
            Edition = HEX(_G, "4ca893")
        },
        RARITY = {
            HEX(_G, "009dff"),
            HEX(_G, "4BC292"),
        ...
        UI_CHIPS = {0 / 0, 0 / 0, 0 / 0, 0 / 0},
        UI_MULT = {0 / 0, 0 / 0, 0 / 0, 0 / 0}
    }
    self.UIT = {
        T = 1,
        B = 2,
    ...
    self.button_mapping = {a = G.F_SWAP_AB_BUTTONS and "b" or nil, b = G.F_SWAP_AB_BUTTONS and "a" or nil, y = G.F_SWAP_XY_BUTTONS and "x" or nil, x = G.F_SWAP_XY_BUTTONS and "y" or nil}
...
function Game.prototype.set_globals(self)
    self.VERSION = VERSION
    self.F_QUIT_BUTTON = true
    self.F_SKIP_TUTORIAL = false
    self.F_BASIC_CREDITS = false
    ...
    if love.system.getOS() == "ps4" or love.system.getOS() == "ps5" then
        self.F_HIDE_BETA_LANGS = true
        self.F_NO_ERROR_HAND = true
        self.F_QUIT_BUTTON = false
        self.F_SKIP_TUTORIAL = false
    ...
    G.C.HAND_LEVELS[1] = G.C.RED
    G.C.UI_CHIPS = copy_table(_G, G.C.BLUE)
    G.C.UI_MULT = copy_table(_G, G.C.RED)
    self.UIT = {
        T = 1,
        B = 2,
        C = 3,
...
function Game.prototype.start_up(self)
    local settings = get_compressed(_G, "settings.jkr")
    local settings_ver = nil
    if settings then
        local settings_file = STR_UNPACK(_G, settings)
        if G.VERSION >= "1.0.0" and love.system.getOS() == "NOPE" and (not settings_file.version or settings_file.version < "1.0.0") then
            do
                local i = 1
                while i <= 3 do
                    love.filesystem.remove(tostring(i) .. "/" .. "profile.jkr")
                    love.filesystem.remove(tostring(i) .. "/" .. "save.jkr")
                    love.filesystem.remove(tostring(i) .. "/" .. "meta.jkr")
                    love.filesystem.remove(tostring(i) .. "/" .. "unlock_notify.jkr")
                    love.filesystem.remove(tostring(i) .. "")
                    i = i + 1
                end
            end
    ...
    local new_colour_proto = self.C["SO_" .. tostring(self.SETTINGS.colourblind_option and 2 or 1)]
    ...
    boot_timer(_G, "start", "settings", 0.1)
    ...
    for ____, ____value in __TS__Iterator(Array.prototype.entries(sound_files)) do
        local _ = ____value[1]
        local filename = ____value[2]
        local extension = String.prototype.substring(filename, -4)
        if extension == ".ogg" then
            local sound_code = String.prototype.substring(filename, 1, -5)
            SOURCES[sound_code] = {}
        end
    end
    self.SETTINGS.language = self.SETTINGS.language or "en-us"
    boot_timer(_G, "settings", "window init", 0.2)
    self:init_window()
    if G.F_SOUND_THREAD then
        boot_timer(_G, "window init", "soundmanager2")
        self.SOUND_MANAGER = {
        ...
        while not sound_loaded and false do
            local ____opt_2 = self.SOUND_MANAGER
            local ____opt_0 = ____opt_2 and ____opt_2.load_channel
            local request = ____opt_0 and ____opt_0:pop()
            if request then
                if request == "finished" then
                    sound_loaded = true
                else
                    boot_timer(_G, request, prev_file)
                    prev_file = request
                end
            end
            love.timer.sleep(0.001)
        end
        boot_timer(_G, "soundmanager2", "savemanager", 0.22)
    end
    boot_timer(_G, "window init", "savemanager")
    G.SAVE_MANAGER = {
    ...
    boot_timer(_G, "savemanager", "shaders", 0.4)
    G.HTTP_MANAGER = {
    ...
    if G.F_HTTP_SCORES then
        local ____opt_4 = G.HTTP_MANAGER
        if ____opt_4 ~= nil then
            ____opt_4.thread:start()
        end
    end
    self.SHADERS = {}
    local shader_files = love.filesystem.getDirectoryItems("resources/shaders")
    for ____, ____value in __TS__Iterator(Array.prototype.entries(shader_files)) do
        local k = ____value[1]
        local filename = ____value[2]
        local extension = String.prototype.substring(filename, -3)
        if extension == ".fs" then
            local shader_name = String.prototype.substring(filename, 1, -4)
            self.SHADERS[shader_name] = love.graphics.newShader("resources/shaders/" .. tostring(filename))
        end
    end
    boot_timer(_G, "shaders", "controllers", 0.7)
    self.CONTROLLER = __TS__New(Controller)
    love.joystick.loadGamepadMappings("resources/gamecontrollerdb.txt")
    if self.F_RUMBLE then
        local joysticks = love.joystick.getJoysticks()
        if joysticks then
            if joysticks[2] then
                self.CONTROLLER:set_gamepad(joysticks[3] or joysticks[2])
            end
        end
    end
    boot_timer(_G, "controllers", "localization", 0.8)
    if self.SETTINGS.GRAPHICS.texture_scaling then
        self.SETTINGS.GRAPHICS.texture_scaling = self.SETTINGS.GRAPHICS.texture_scaling > 1 and 2 or 1
    end
    ...
    boot_timer(_G, "protos", "shared sprites", 0.9)
    self.shared_debuff = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
        self.CARD_H,
        self.ASSET_ATLAS.centers,
        {x = 4, y = 0}
    )
    self.shared_soul = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
        self.CARD_H,
        self.ASSET_ATLAS.centers,
        self.P_CENTERS.soul.pos
    )
    self.shared_undiscovered_joker = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
    ...
    self.shared_undiscovered_tarot = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
    ...
    self.shared_sticker_eternal = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
        self.CARD_H,
        self.ASSET_ATLAS.stickers,
        {x = 0, y = 0}
    )
    self.shared_sticker_perishable = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
    ...
    self.shared_sticker_rental = __TS__New(
        Sprite,
        0,
        0,
        self.CARD_W,
    ...
    boot_timer(_G, "shared sprites", "prep stage", 0.95)
    G.STAGE_OBJECT_INTERRUPT = true
    self.CURSOR = __TS__New(
        Sprite,
        0,
        0,
        0.3,
        0.3,
        self.ASSET_ATLAS.gamepad_ui,
        {x = 18, y = 0}
    )
    self.CURSOR.states.collide.can = false
    G.STAGE_OBJECT_INTERRUPT = false
    self.E_MANAGER = __TS__New(EventManager)
    self.SPEEDFACTOR = 1
    initSteamodded(_G)
    set_profile_progress(_G)
    boot_timer(_G, "prep stage", "splash prep", 1)
    self:splash_screen()
    boot_timer(_G, "splash prep", "end", 1)
end
function Game.prototype.init_item_prototypes(self)
    self.P_SEALS = {Red = {order = 1, discovered = false, set = "Seal"}, Blue = {order = 2, discovered = false, set = "Seal"}, Gold = {order = 3, discovered = false, set = "Seal"}, Purple = {order = 4, discovered = false, set = "Seal"}}
    self.P_TAGS = {
        tag_uncommon = {
            name = "Uncommon Tag",
            set = "Tag",
    ...
    self.P_BLINDS = {
        ...
        bl_ox = {
            ...
            dollars = 5,
            mult = 2,
            vars = {localize(_G, "ph_most_played")},
            debuff = {},
            pos = {x = 0, y = 2},
            boss = {min = 6, max = 10},
            boss_colour = HEX(_G, "b95b08")
        },
        bl_hook = {
            name = "The Hook",
            defeated = false,
    ...
    self.P_CENTERS = {
        ...
        c_empress = {
            ...
            effect = "Enhance",
            cost_mult = 1,
            config = {mod_conv = "m_mult", max_highlighted = 2}
        },
        c_emperor = {
            order = 5,
            discovered = false,
        ...
        c_heirophant = {
            ...
            effect = "Enhance",
            cost_mult = 1,
            config = {mod_conv = "m_bonus", max_highlighted = 2}
        },
        c_lovers = {
            order = 7,
            discovered = false,
        ...
        c_chariot = {
            ...
            effect = "Enhance",
            cost_mult = 1,
            config = {mod_conv = "m_steel", max_highlighted = 1}
        },
        c_justice = {
            order = 9,
            discovered = false,
        ...
        c_strength = {
            ...
            effect = "Round Bonus",
            cost_mult = 1,
            config = {mod_conv = "up_rank", max_highlighted = 2}
        },
        c_hanged_man = {
            order = 13,
            discovered = false,
        ...
        c_star = {
            ...
            cost_mult = 1,
            config = {suit_conv = "Diamonds", max_highlighted = 3}
        },
        c_moon = {
            order = 19,
            discovered = false,
            ...
            effect = "Suit Conversion",
            cost_mult = 1,
            config = {suit_conv = "Clubs", max_highlighted = 3}
        },
        c_sun = {
            order = 20,
            discovered = false,
            ...
            effect = "Suit Conversion",
            cost_mult = 1,
            config = {suit_conv = "Hearts", max_highlighted = 3}
        },
        c_judgement = {
            order = 21,
            discovered = false,
        ...
        c_world = {
            ...
            effect = "Suit Conversion",
            cost_mult = 1,
            config = {suit_conv = "Spades", max_highlighted = 3}
        },
        c_mercury = {
            order = 1,
            discovered = false,
        ...
        c_grim = {
            ...
            pos = {x = 1, y = 4},
            set = "Spectral",
            config = {remove_card = true, extra = 2}
        },
        c_incantation = {
            order = 3,
            discovered = false,
            ...
            pos = {x = 2, y = 4},
            set = "Spectral",
            config = {remove_card = true, extra = 4}
        },
        c_talisman = {
            order = 4,
            discovered = false,
            ...
            pos = {x = 3, y = 4},
            set = "Spectral",
            config = {extra = "Gold", max_highlighted = 1}
        },
        c_aura = {
            order = 5,
            discovered = false,
        ...
        c_immolate = {
            ...
            pos = {x = 9, y = 4},
            set = "Spectral",
            config = {remove_card = true, extra = {destroy = 5, dollars = 20}}
        },
        c_ankh = {
            order = 11,
            discovered = false,
        ...
        c_deja_vu = {
            ...
            pos = {x = 1, y = 5},
            set = "Spectral",
            config = {extra = "Red", max_highlighted = 1}
        },
        c_hex = {
            order = 13,
            discovered = false,
        ...
        c_trance = {
            ...
            pos = {x = 3, y = 5},
            set = "Spectral",
            config = {extra = "Blue", max_highlighted = 1}
        },
        c_medium = {
            order = 15,
            discovered = false,
            ...
            pos = {x = 4, y = 5},
            set = "Spectral",
            config = {extra = "Purple", max_highlighted = 1}
        },
        c_cryptid = {
            order = 16,
            discovered = false,
        ...
        v_overstock_plus = {
            ...
            unlock_condition = {type = "c_shop_dollars_spent", extra = 2500}
        },
        v_liquidation = {
            order = 4,
            discovered = false,
            ...
            unlock_condition = {type = "run_redeem", extra = 10}
        },
        v_glow_up = {
            order = 6,
            discovered = false,
            ...
            config = {extra = 4},
            requires = {"v_hone"},
            unlock_condition = {type = "have_edition", extra = 5}
        },
        v_reroll_glut = {
            order = 8,
            discovered = false,
            ...
            unlock_condition = {type = "c_shop_rerolls", extra = 100}
        },
        v_omen_globe = {
            order = 10,
            discovered = false,
            ...
            unlock_condition = {type = "c_tarot_reading_used", extra = 25}
        },
        v_observatory = {
            order = 12,
            discovered = false,
            ...
            unlock_condition = {type = "c_planetarium_used", extra = 25}
        },
        v_nacho_tong = {
            order = 14,
            discovered = false,
            ...
            config = {extra = 1},
            requires = {"v_grabber"},
            unlock_condition = {type = "c_cards_played", extra = 2500}
        },
        v_recyclomancy = {
            order = 16,
            discovered = false,
            ...
            config = {extra = 1},
            requires = {"v_wasteful"},
            unlock_condition = {type = "c_cards_discarded", extra = 2500}
        },
        v_tarot_tycoon = {
            order = 18,
            discovered = false,
            ...
            unlock_condition = {type = "c_tarots_bought", extra = 50}
        },
        v_planet_tycoon = {
            order = 20,
            discovered = false,
            ...
            unlock_condition = {type = "c_planets_bought", extra = 50}
        },
        v_money_tree = {
            order = 22,
            discovered = false,
            ...
            unlock_condition = {type = "interest_streak", extra = 10}
        },
        v_antimatter = {
            order = 24,
            discovered = false,
            ...
            config = {extra = 15},
            requires = {"v_blank"},
            unlock_condition = {type = "blank_redeems", extra = 10}
        },
        v_illusion = {
            order = 26,
            discovered = false,
            ...
            unlock_condition = {type = "c_playing_cards_bought", extra = 20}
        },
        v_petroglyph = {
            order = 28,
            discovered = false,
            ...
            unlock_condition = {type = "ante_up", ante = 12, extra = 12}
        },
        v_retcon = {
            order = 30,
            discovered = false,
            ...
            unlock_condition = {type = "blind_discoveries", extra = 25}
        },
        v_palette = {
            order = 32,
            discovered = false,
            ...
            unlock_condition = {type = "min_hand_size", extra = 5}
        },
        b_red = {
            name = "Red Deck",
            stake = 1,
    ...
    self.P_LOCKED = {}
    self:save_progress()
    local TESTHELPER_unlocks = false
    if not love.filesystem.getInfo(tostring(G.SETTINGS.profile) .. "") then
        love.filesystem.createDirectory(tostring(G.SETTINGS.profile) .. "")
    end
    if not love.filesystem.getInfo(tostring(G.SETTINGS.profile) .. "/" .. "meta.jkr") then
        love.filesystem.append(
            tostring(G.SETTINGS.profile) .. "/" .. "meta.jkr",
            "return {}"
        )
    end
    convert_save_to_meta(_G)
    ...
    for ____, ____value in __TS__Iterator(__TS__ArrayEntries({G.P_CENTERS, G.P_BLINDS, G.P_TAGS, G.P_SEALS})) do
        local _ = ____value[1]
        local t = ____value[2]
        for k in pairs(t) do
            local v = t[k]
    ...
    for k, v in pairs(self.P_CENTERS) do
        if not v.wip and not v.demo then
            ...
            if not v.unlocked and (({string.find(k, "^j_")}) or ({string.find(k, "^b_")}) or ({string.find(k, "^v_")})) then
                self.P_LOCKED[#self.P_LOCKED + 1 + 1] = v
            end
    ...
    table.sort(
        self.P_CENTER_POOLS.Tarot,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Planet,
        function(a, b)
            return a.order < b.order
        end
    )
    ...
    table.sort(
        self.P_CENTER_POOLS.Spectral,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Voucher,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Booster,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Consumeables,
        function(a, b)
            return a.order < b.order
        end
    )
    ...
    table.sort(
        self.P_CENTER_POOLS.Enhanced,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Edition,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Stake,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Tag,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        self.P_CENTER_POOLS.Seal,
        function(a, b)
            return a.order < b.order
        end
    )
    table.sort(
        ...
        function(a, b)
            return (a and a.order or 0) + (a.set == "Joker" and 1000 or 0) < (b and b.order or 0) + (b.set == "Joker" and 1000 or 0)
        end
    )
    do
        local i = 0
...
function Game.prototype.load_profile(self, _profile)
    if not G.PROFILES[_profile + 1] then
        _profile = 1
    end
    G.SETTINGS.profile = _profile
    local info = {love.filesystem.read(tostring(_profile) .. "/profile.jkr")}
    if info ~= nil then
        for k, v in pairs(STR_UNPACK(_G, info)) do
            G.PROFILES[G.SETTINGS.profile or ""][k] = v
        end
    end
    local temp_profile = {
        MEMORY = {deck = "Red Deck", stake = 1},
        stake = 1,
        high_scores = {
    ...
    recursive_init = function(self, t1, t2)
        for k, v in pairs(t1) do
            if not t2[k] then
                t2[k] = v
            else
                if type(t2[k]) == "table" and type(v) == "table" then
                    recursive_init(_G, v, t2[k])
                end
            end
        end
    end
    recursive_init(_G, temp_profile, G.PROFILES[G.SETTINGS.profile or ""])
end
function Game.prototype.set_language(self)
    if not self.LANGUAGES then
        self.LANGUAGES = {
            ["en-us"] = {
                ...
                warning = {"This language is still in Beta. To help us", "improve it, please click on the feedback button.", "Click again to confirm"}
            },
            de = {
                font = 1,
                label = "Deutsch",
                ...
                warning = {"Diese Übersetzung ist noch im Beta-Stadium. Willst du uns helfen,", "sie zu verbessern? Dann klicke bitte auf die Feedback-Taste.", "Zum Bestätigen erneut klicken"}
            },
            es_419 = {
                font = 1,
                ...
                warning = {"Este idioma todavía está en Beta. Pulsa el botón", "de sugerencias para ayudarnos a mejorarlo.", "Haz clic de nuevo para confirmar"}
            },
            es_ES = {
                font = 1,
            ...
            fr = {
                ...
                warning = {"La traduction française est encore en version bêta. ", "Veuillez cliquer sur le bouton pour nous donner votre avis.", "Cliquez à nouveau pour confirmer"}
            },
            id = {
                font = 1,
                ...
                warning = {"Bahasa ini masih dalam tahap Beta. Untuk membantu", "kami meningkatkannya, silakan klik tombol umpan balik.", "Klik lagi untuk mengonfirmasi"}
            },
            it = {
                font = 1,
                label = "Italiano",
                ...
                warning = {"Questa traduzione è ancora in Beta. Per", "aiutarci a migliorarla, clicca il tasto feedback", "Fai clic di nuovo per confermare"}
            },
            ja = {
                font = 5,
                label = "日本語",
                ...
                beta = nil,
                button = "提案する",
                warning = {"この翻訳は現在ベータ版です。提案があった場合、", "ボタンをクリックしてください。", "もう一度クリックして確認"}
            },
            ko = {
                font = 4,
                label = "한국어",
                ...
                beta = nil,
                button = "번역 피드백",
                warning = {"이 언어는 아직 베타 단계에 있습니다. ", "번역을 도와주시려면 피드백 버튼을 눌러주세요.", "다시 클릭해서 확인하세요"}
            },
            nl = {
                font = 1,
                label = "Nederlands",
                ...
                warning = {"Deze taal is nog in de Beta fase. Help ons het te ", "verbeteren door op de suggestie knop te klikken.", "Klik opnieuw om te bevestigen"}
            },
            pl = {
                font = 1,
                label = "Polski",
                ...
                warning = {"Polska wersja językowa jest w fazie Beta. By pomóc nam poprawić", " jakość tłumaczenia, kliknij przycisk i podziel się swoją opinią i uwagami.", "Kliknij ponownie, aby potwierdzić"}
            },
            pt_BR = {
                font = 1,
                label = "Português",
                ...
                warning = {"Esta tradução ainda está em Beta. Se quiser nos ajudar", "a melhorá-la, clique no botão de feedback por favor", "Clique novamente para confirmar"}
            },
            ru = {
                font = 6,
                label = "Русский",
                ...
                warning = {"Этот язык все еще находится в Бета-версии. Чтобы помочь", "нам его улучшить, пожалуйста, нажмите на кнопку обратной связи.", "Щелкните снова, чтобы подтвердить"}
            },
            zh_CN = {
                font = 2,
                label = "简体中文",
                ...
                beta = nil,
                button = "意见反馈",
                warning = {"这个语言目前尚为Beta版本。 请帮助我们改善翻译品质，", "点击”意见反馈” 来提供你的意见。", "再次点击确认"}
            },
            zh_TW = {
                font = 3,
                label = "繁體中文",
                ...
                beta = nil,
                button = "意見回饋",
                warning = {"這個語言目前尚為Beta版本。請幫助我們改善翻譯品質，", "點擊”意見回饋” 來提供你的意見。", "再按一下即可確認"}
            },
    ...
    if localization ~= nil then
        self.localization = ({assert({loadstring(({love.filesystem.read("localization/" .. G.SETTINGS.language .. ".lua")}) or ({love.filesystem.read("localization/en-us.lua")}))})})(_G)
        init_localization(_G)
    end
end
function Game.prototype.set_render_settings(self)
    self.SETTINGS.GRAPHICS.texture_scaling = self.SETTINGS.GRAPHICS.texture_scaling or 2
    love.graphics.setDefaultFilter(self.SETTINGS.GRAPHICS.texture_scaling == 1 and "nearest" or "linear", self.SETTINGS.GRAPHICS.texture_scaling == 1 and "nearest" or "linear", 1)
    love.graphics.setLineStyle("rough")
    self.animation_atli = {
        {
            name = "blind_chips",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/BlindChips.png",
            px = 34,
            py = 34,
            frames = 21
        },
        {
            name = "shop_sign",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/ShopSignAnimation.png",
            px = 113,
            py = 57,
            frames = 4
        }
    ...
    self.asset_atli = {
        {
            name = "cards_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/8BitDeck.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "cards_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/8BitDeck_opt2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "centers",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/Enhancers.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "Joker",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/Jokers.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "Tarot",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/Tarots.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "Voucher",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/Vouchers.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "Booster",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/boosters.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "ui_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/ui_assets.png",
            px = 18,
            py = 18,
            type = nil
        },
        {
            name = "ui_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/ui_assets_opt2.png",
            px = 18,
            py = 18,
            type = nil
        },
        {
            name = "balatro",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/balatro.png",
            px = 333,
            py = 216,
            type = nil
        },
        {
            name = "gamepad_ui",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/gamepad_ui.png",
            px = 32,
            py = 32,
            type = nil
        },
        {
            name = "icons",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/icons.png",
            px = 66,
            py = 66,
            type = nil
        },
        {
            name = "tags",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/tags.png",
            px = 34,
            py = 34,
            type = nil
        },
        {
            name = "stickers",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/stickers.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "chips",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/chips.png",
            px = 29,
            py = 29,
            type = nil
        },
        {
            name = "collab_AU_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_AU_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_AU_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_AU_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_TW_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_TW_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_TW_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_TW_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_VS_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_VS_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_VS_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_VS_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_DTD_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_DTD_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_DTD_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_DTD_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_CYP_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_CYP_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_CYP_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_CYP_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_STS_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_STS_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_STS_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_STS_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_TBoI_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_TBoI_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_TBoI_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_TBoI_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_SV_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_SV_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_SV_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_SV_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_SK_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_SK_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_SK_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_SK_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_DS_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_DS_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_DS_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_DS_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_CL_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_CL_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_CL_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_CL_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_D2_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_D2_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_D2_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_D2_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_PC_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_PC_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_PC_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_PC_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_WF_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_WF_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_WF_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_WF_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_EG_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_EG_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_EG_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_EG_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_XR_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_XR_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_XR_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_XR_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_CR_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_CR_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_CR_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_CR_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_BUG_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_BUG_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_BUG_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_BUG_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_FO_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_FO_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_FO_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_FO_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_DBD_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_DBD_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_DBD_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_DBD_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_C7_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_C7_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_C7_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_C7_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_R_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_R_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_R_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_R_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_AC_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_AC_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_AC_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_AC_2.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_STP_1",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_STP_1.png",
            px = 71,
            py = 95,
            type = nil
        },
        {
            name = "collab_STP_2",
            path = "resources/textures/" .. tostring(self.SETTINGS.GRAPHICS.texture_scaling) .. "x/collabs/collab_STP_2.png",
            px = 71,
            py = 95,
            type = nil
        }
    ...
    do
        local i = 1
        while i <= #self.animation_atli do
            self.ANIMATION_ATLAS[self.animation_atli[i + 1].name] = {}
            self.ANIMATION_ATLAS[self.animation_atli[i + 1].name].name = self.animation_atli[i + 1].name
            self.ANIMATION_ATLAS[self.animation_atli[i + 1].name].image = love.graphics.newImage(self.animation_atli[i + 1].path, {mipmaps = true, dpiscale = self.SETTINGS.GRAPHICS.texture_scaling})
            self.ANIMATION_ATLAS[self.animation_atli[i + 1].name].px = self.animation_atli[i + 1].px
            self.ANIMATION_ATLAS[self.animation_atli[i + 1].name].py = self.animation_atli[i + 1].py
            self.ANIMATION_ATLAS[self.animation_atli[i + 1].name].frames = self.animation_atli[i + 1].frames
            i = i + 1
        end
    end
    do
        local i = 1
        while i <= #self.asset_atli do
            self.ASSET_ATLAS[self.asset_atli[i + 1].name] = {}
            self.ASSET_ATLAS[self.asset_atli[i + 1].name].name = self.asset_atli[i + 1].name
            self.ASSET_ATLAS[self.asset_atli[i + 1].name].image = love.graphics.newImage(self.asset_atli[i + 1].path, {mipmaps = true, dpiscale = self.SETTINGS.GRAPHICS.texture_scaling})
            ...
            if mipmap_level and mipmap_level > 0 then
                self.ASSET_ATLAS[self.asset_atli[i + 1].name].image:setMipmapFilter("linear", mipmap_level)
            end
            self.ASSET_ATLAS[self.asset_atli[i + 1].name].type = self.asset_atli[i + 1].type
            self.ASSET_ATLAS[self.asset_atli[i + 1].name].px = self.asset_atli[i + 1].px
            self.ASSET_ATLAS[self.asset_atli[i + 1].name].py = self.asset_atli[i + 1].py
            i = i + 1
        end
    end
    do
        local i = 1
        while i <= #self.asset_images do
            self.ASSET_ATLAS[self.asset_images[i + 1].name] = {}
            self.ASSET_ATLAS[self.asset_images[i + 1].name].name = self.asset_images[i + 1].name
            self.ASSET_ATLAS[self.asset_images[i + 1].name].image = love.graphics.newImage(self.asset_images[i + 1].path, {mipmaps = true, dpiscale = 1})
            self.ASSET_ATLAS[self.asset_images[i + 1].name].type = self.asset_images[i + 1].type
            self.ASSET_ATLAS[self.asset_images[i + 1].name].px = self.asset_images[i + 1].px
            self.ASSET_ATLAS[self.asset_images[i + 1].name].py = self.asset_images[i + 1].py
            i = i + 1
        end
    end
...
function Game.prototype.init_window(self, reset)
...
function Game.prototype.delete_run(self)
    if self.ROOM then
        remove_all(_G, G.STAGE_OBJECTS[G.STAGE + 1])
        ...
        for k, v in pairs(G) do
            if __TS__InstanceOf(v, CardArea) then
                G[k] = nil
            end
        end
        G.I.CARD = {}
...
function Game.prototype.save_progress(self)
    G.ARGS.save_progress = G.ARGS.save_progress or ({SETTINGS = nil, PROFILE = nil, UDA = nil})
    G.ARGS.save_progress.UDA = EMPTY(_G, G.ARGS.save_progress.UDA or ({}))
    G.ARGS.save_progress.SETTINGS = G.SETTINGS
    G.ARGS.save_progress.PROFILE = G.PROFILES[G.SETTINGS.profile or ""]
    for k, v in pairs(self.P_CENTERS) do
...
function Game.prototype.save_notify(self, card)
    local ____opt_12 = G.SAVE_MANAGER
    local ____opt_10 = ____opt_12 and ____opt_12.channel
    if ____opt_10 ~= nil then
        ____opt_10:push({type = "save_notify", save_notify = card.key, profile_num = G.SETTINGS.profile})
    end
end
function Game.prototype.save_settings(self)
    G.ARGS.save_settings = G.SETTINGS
    G.FILE_HANDLER = G.FILE_HANDLER or ({})
    G.FILE_HANDLER.settings = true
    G.FILE_HANDLER.update_queued = true
end
function Game.prototype.save_metrics(self)
    G.ARGS.save_metrics = G.METRICS
    G.FILE_HANDLER = G.FILE_HANDLER or ({})
    G.FILE_HANDLER.settings = true
    G.FILE_HANDLER.update_queued = true
end
function Game.prototype.prep_stage(self, new_stage, new_state, new_game_obj)
    ...
    self.ROOM = __TS__New(LuaNode, {T = {x = self.ROOM_PADDING_W, y = self.ROOM_PADDING_H, w = self.TILE_W, h = self.TILE_H}})
    self.ROOM.jiggle = 0
    self.ROOM.states.drag.can = false
    self.ROOM:set_container(self.ROOM)
    self.ROOM_ATTACH = __TS__New(Moveable, {T = {
        x = 0,
        y = 0,
        w = self.TILE_W,
        h = self.TILE_H,
...
function Game.prototype.sandbox(self)
    G.TIMERS.REAL = 0
    G.TIMERS.TOTAL = 0
    self:prep_stage(G.STAGES.SANDBOX, G.STATES.SANDBOX, true)
    self.GAME.selected_back = __TS__New(Back, G.P_CENTERS.b_red)
    ease_background_colour(_G, {new_colour = G.C.BLACK, contrast = 1})
    G.SANDBOX = {
        vort_time = 7,
        vort_speed = 0,
        col_op = {
    ...
    G.SPLASH_BACK:define_draw_steps({{shader = "splash", send = {
    ...
    local function create_UIBox_sandbox_controls(self)
        G.FUNCS.col1change = function(self, args)
            G.SANDBOX.col1 = G.C[args.to_val]
        end
        G.FUNCS.col2change = function(self, args)
            G.SANDBOX.col2 = G.C[args.to_val]
        end
        G.FUNCS.edition_change = function(self, args)
            G.SANDBOX.edition = args.to_val
            if G.SANDBOX.joker then
                G.SANDBOX.joker:set_edition({[args.to_val] = true}, true, true)
            end
        end
        G.FUNCS.pulseme = function(self, e)
            if math.random() > 0.998 then
                e.config.object:pulse(1)
            end
        end
        G.FUNCS.spawn_joker = function(self, e)
            G.FUNCS:rem_joker()
            G.SANDBOX.joker = add_joker(_G, G.SANDBOX.joker_text, G.SANDBOX.edition)
        end
        G.FUNCS.rem_joker = function(self, e)
            if G.SANDBOX.joker then
                G.SANDBOX.joker:remove()
                G.SANDBOX.joker = nil
            end
        end
        G.FUNCS.do_time = function(self, args)
            ...
            nodes = {{
                ...
                nodes = {
                    ...
                    }),
                    {
                        ...
                        nodes = {
                            UIBox_button(_G, {label = {"+"}, button = "spawn_joker", minw = 0.7, col = true}),
                            create_text_input(_G, {
                            ...
                            UIBox_button(_G, {label = {"-"}, button = "rem_joker", minw = 0.7, col = true})
                        }
                    },
                    create_option_cycle(_G, {
                        options = {
    ...
    G.SANDBOX.UI = __TS__New(
        UIBox,
        {
            definition = create_UIBox_sandbox_controls(_G),
            config = {align = "cli", offset = {x = 0, y = 0}, major = G.ROOM_ATTACH, bond = "Weak"}
        }
    )
    G.SANDBOX.UI:recalculate(true)
end
function Game.prototype.splash_screen(self)
                ...
                G.E_MANAGER:add_event(__TS__New(
                    GameEvent,
                    {
                        ...
                        func = function(self)
                            ...
                            SC = __TS__New(
                                Card,
                                G.ROOM.T.w / 2 - SC_scale * G.CARD_W / 2,
                                10 + G.ROOM.T.h / 2 - SC_scale * G.CARD_H / 2,
                                SC_scale * G.CARD_W,
                                SC_scale * G.CARD_H,
                                G.P_CARDS.empty,
                                G.P_CENTERS.j_joker
                            ...
                            play_sound(_G, "whoosh1", 0.7, 0.2)
                            play_sound(_G, "introPad1", 0.704, 0.6)
                            return true
                        end
                    }
                ))
                G.E_MANAGER:add_event(__TS__New(
                    GameEvent,
                    {
                        ...
                        func = function(self)
                            ...
                            play_sound(_G, "magic_crumple", 1, 0.5)
                            play_sound(_G, "splash_buildup", 1, 0.7)
                            return true
                        end
                    }
                ))
                local function make_splash_card(self, args)
                    args = args or ({})
                    ...
                    while i <= 200 do
                        ...
                        G.E_MANAGER:add_event(__TS__New(
                            GameEvent,
                            {
                                ...
                                delay = temp_del,
                                func = function(self)
                                    local card, card_pos = __TS__Unpack(make_splash_card(_G, {scale = 2 - i / 300}))
                                        ...
                                        GameEvent,
                                        {
                                            ...
                                            func = function(self)
                                                if card.T.scale <= 0 then
                                                    ...
                                                    if temp_i == 15 then
                                                        play_sound(_G, "whoosh_long", 0.9, 0.7)
                                                    end
                        ...
                        temp_del = temp_del + math.max(
                            1 / i,
                            math.max(0.2 * (170 - i) / 500, 0.016)
                        )
                        i = i + 1
                    end
                end
...
function Game.prototype.main_menu(self, change_context)
    if change_context ~= "splash" then
        G.TIMERS.REAL = 12
        G.TIMERS.TOTAL = 12
    else
        RESET_STATES(_G, G.STATES.MENU)
    end
    self:prep_stage(G.STAGES.MAIN_MENU, G.STATES.MENU, true)
    self.GAME.selected_back = __TS__New(Back, G.P_CENTERS.b_red)
    local ____temp_18 = not G.SETTINGS.tutorial_complete
    if ____temp_18 then
        local ____opt_16 = G.SETTINGS.tutorial_progress
        ____temp_18 = ____opt_16 and ____opt_16.completed_parts.big_blind
    end
    if ____temp_18 then
    ...
    ease_value(
        ...
        splash_args,
        "mid_flash",
        -(change_context == "splash" and 1.6 or 0),
        nil,
        nil,
        nil,
        4
    ...
    local replace_card = __TS__New(
        Card,
        self.title_top.T.x,
        self.title_top.T.y,
        1.2 * G.CARD_W * SC_scale,
        1.2 * G.CARD_H * SC_scale,
        G.P_CARDS.S_A,
        G.P_CENTERS.c_base
    )
        ...
        GameEvent,
        {
            ...
            func = function(self)
                if change_context == "splash" then
                    ...
                    play_sound(
                        _G,
                        "crumple" .. tostring(math.random(1, 5)),
                        math.random() * 0.2 + 0.6,
                        0.65
                    )
                else
    ...
    G.E_MANAGER:add_event(__TS__New(
        GameEvent,
        {
            ...
            func = function(self)
                play_sound(
                    _G,
                    "magic_crumple" .. tostring(change_context == "splash" and 2 or 3),
                    change_context == "splash" and 1 or 1.3,
                    0.9
                )
                play_sound(_G, "whoosh1", 0.4, 0.8)
                ease_value(
                    _G,
                    G.SPLASH_LOGO,
                    "dissolve",
    ...
    delay(_G, 0.1 + (change_context == "splash" and 2 or change_context == "game" and 1.5 or 0))
    if replace_card and G.P_CENTERS.j_blueprint.unlocked then
        local viable_unlockables = {}
        for ____, ____value in __TS__Iterator(Array.prototype.entries(self.P_LOCKED)) do
            local k = ____value[1]
            local v = ____value[2]
        ...
        if viable_unlockables.length > 0 then
            local card
            G.E_MANAGER:add_event(__TS__New(
                GameEvent,
                {
                    ...
                    func = function(self)
                        card = __TS__New(
                            ...
                            1.2 * G.CARD_H * SC_scale,
                            nil,
                            pseudorandom_element(_G, viable_unlockables) or self.P_CENTERS.j_joker
                        )
    ...
    for k, v in pairs(G.PROFILES[G.SETTINGS.profile or ""].career_stats) do
        check_for_unlock(_G, {type = "career_stat", statname = k})
    end
    check_for_unlock(_G, {type = "blind_discoveries"})
    G.E_MANAGER:add_event(__TS__New(
        GameEvent,
        {
            blockable = false,
    ...
    __TS__New(UIBox, {definition = {n = G.UIT.ROOT, config = {align = "cm", colour = G.C.UI.TRANSPARENT_DARK}, nodes = {{n = G.UIT.T, config = {text = G.VERSION, scale = 0.3, colour = G.C.UI.TEXT_LIGHT}}}}, config = {align = "tri", offset = {x = 0, y = 0}, major = G.ROOM_ATTACH, bond = "Weak"}})
end
function Game.prototype.demo_cta(self)
    ...
    G.E_MANAGER:add_event(__TS__New(
        GameEvent,
        {
            ...
            blocking = false,
            func = function(self)
                play_sound(_G, "magic_crumple" .. 2, 1, 0.9)
                play_sound(_G, "whoosh1", 0.4, 0.8)
                ease_value(
                    _G,
                    G.SPLASH_LOGO,
    ...
    self.title_top:align_cards()
    self.title_top:hard_set_cards()
    local playstack = __TS__New(
        Sprite,
        0,
        0,
        1.7,
        1.7,
        G.ASSET_ATLAS.playstack_logo,
        {x = 0, y = 0}
    )
    playstack.states.drag.can = false
    local localthunk = __TS__New(
        Sprite,
        0,
        0,
        1 * 1390 / 560,
        1,
        G.ASSET_ATLAS.localthunk_logo,
        {x = 0, y = 0}
    )
    localthunk.states.drag.can = false
    self.MAIN_MENU_UI = __TS__New(
        UIBox,
        {
            definition = {
                n = G.UIT.ROOT,
                ...
                nodes = {
                    ...
                    },
                    {
                        ...
                        nodes = {
                            ...
                            {n = G.UIT.C, config = {align = "cr", minw = 5, minh = 1}, nodes = {{n = G.UIT.O, config = {object = localthunk}}, {n = G.UIT.O, config = {object = playstack}}}}
                        }
                    }
                }
            },
...
function Game.prototype.init_game_object(self)
    local cards_played = {}
    for ____, ____value in __TS__Iterator(Array.prototype.entries(SMODS.Rank.obj_buffer)) do
        local _ = ____value[1]
        local v = ____value[2]
    ...
    return {
        ...
        stake = 1,
        modifiers = {},
        starting_params = get_starting_params(_G),
        banned_keys = {},
        round = 0,
...
function Game.prototype.start_run(self, args)
    args = args or ({})
    ...
    if saveTable then
        check_for_unlock(_G, {type = "continue_game"})
    end
    G.STATE_COMPLETE = false
    G.RESET_BLIND_STATES = true
    if not saveTable then
        ease_background_colour_blind(_G, G.STATE, "Small Blind")
    else
    ...
    selected_back = get_deck_from_name(_G, selected_back)
    ...
    self.GAME.selected_back = __TS__New(Back, selected_back)
    self.GAME.selected_back_key = selected_back
    local ____temp_19 = {G.C.BLUE[2], G.C.BLUE[3], G.C.BLUE[4], G.C.BLUE[5]}
    G.C.UI_CHIPS[2] = ____temp_19[1]
    G.C.UI_CHIPS[3] = ____temp_19[2]
    G.C.UI_CHIPS[4] = ____temp_19[3]
    G.C.UI_CHIPS[5] = ____temp_19[4]
    local ____temp_20 = {G.C.RED[2], G.C.RED[3], G.C.RED[4], G.C.RED[5]}
    G.C.UI_MULT[2] = ____temp_20[1]
    G.C.UI_MULT[3] = ____temp_20[2]
    G.C.UI_MULT[4] = ____temp_20[3]
    G.C.UI_MULT[5] = ____temp_20[4]
    if not saveTable then
        if false then
        ...
        SMODS:setup_stake(self.GAME.stake)
        ...
        if args.challenge then
            ...
            if _ch.jokers then
                for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.jokers)) do
                    local k = ____value[1]
                    local v = ____value[2]
                    G.E_MANAGER:add_event(__TS__New(
                        GameEvent,
                        {func = function(self)
                            local _joker = add_joker(_G, v.id, v.edition, k ~= 1)
                            if v.eternal then
            ...
            if _ch.consumeables then
                for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.consumeables)) do
                    local k = ____value[1]
                    local v = ____value[2]
                    G.E_MANAGER:add_event(__TS__New(
                        GameEvent,
                        {func = function(self)
                            add_joker(_G, v.id, nil, k ~= 1)
                            return true
                        end}
                    ))
                end
            ...
            if _ch.vouchers then
                for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.vouchers)) do
                    local k = ____value[1]
                    local v = ____value[2]
            ...
            if _ch.rules then
                if _ch.rules.modifiers then
                    for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.rules.modifiers)) do
                        local k = ____value[1]
                        local v = ____value[2]
                ...
                if _ch.rules.custom then
                    for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.rules.custom)) do
                        local k = ____value[1]
                        local v = ____value[2]
            ...
            if _ch.restrictions then
                if _ch.restrictions.banned_cards then
                    for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.restrictions.banned_cards)) do
                        local k = ____value[1]
                        local v = ____value[2]
                        G.GAME.banned_keys[v.id] = true
                        if v.ids then
                            for ____, ____value in __TS__Iterator(Array.prototype.entries(v.ids)) do
                                local kk = ____value[1]
                                local vv = ____value[2]
                ...
                if _ch.restrictions.banned_tags then
                    for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.restrictions.banned_tags)) do
                        local k = ____value[1]
                        local v = ____value[2]
                        G.GAME.banned_keys[v.id] = true
                    end
                ...
                if _ch.restrictions.banned_other then
                    for ____, ____value in __TS__Iterator(Array.prototype.entries(_ch.restrictions.banned_other)) do
                        local k = ____value[1]
                        local v = ____value[2]
                        G.GAME.banned_keys[v.id] = true
                    end
    ...
    if not saveTable then
        ...
        local ____self_GAME_pseudorandom_25 = self.GAME.pseudorandom
        local ____args_seed_24 = args.seed
        if not ____args_seed_24 then
            local ____G_SETTINGS_tutorial_complete_23 = G.SETTINGS.tutorial_complete
            if not ____G_SETTINGS_tutorial_complete_23 then
                local ____opt_21 = G.SETTINGS.tutorial_progress
                ____G_SETTINGS_tutorial_complete_23 = ____opt_21 and ____opt_21.completed_parts.big_blind
            end
            ____args_seed_24 = not ____G_SETTINGS_tutorial_complete_23 and "TUTORIAL"
        end
        ____self_GAME_pseudorandom_25.seed = ____args_seed_24 or generate_starting_seed(_G)
    end
    for k, v in pairs(self.GAME.pseudorandom) do
        if v == 0 then
            self.GAME.pseudorandom[k] = pseudohash(_G, k + self.GAME.pseudorandom.seed)
        end
    end
    self.GAME.pseudorandom.hashed_seed = pseudohash(_G, self.GAME.pseudorandom.seed)
    G:save_settings()
    if not self.GAME.round_resets.blind_tags then
        self.GAME.round_resets.blind_tags = {}
    end
    if not saveTable then
        self.GAME.round_resets.blind_choices.Boss = get_new_boss(_G)
        self.GAME.current_round.voucher = G.SETTINGS.tutorial_progress and G.SETTINGS.tutorial_progress.forced_voucher or get_next_voucher_key(_G)
        self.GAME.round_resets.blind_tags.Small = G.SETTINGS.tutorial_progress and G.SETTINGS.tutorial_progress.forced_tags and G.SETTINGS.tutorial_progress.forced_tags[1] or get_next_tag_key(_G)
        self.GAME.round_resets.blind_tags.Big = G.SETTINGS.tutorial_progress and G.SETTINGS.tutorial_progress.forced_tags and G.SETTINGS.tutorial_progress.forced_tags[2] or get_next_tag_key(_G)
    else
    ...
    self.vouchers = __TS__New(
        CardArea,
        G.discard.T.x,
        G.discard.T.y,
        G.discard.T.w,
        G.discard.T.h,
        {type = "discard", card_limit = 1e+308}
    )
    self.deck = __TS__New(
        CardArea,
        0,
    ...
    G.SPLASH_BACK:define_draw_steps({{shader = "background", send = {
        {name = "time", ref_table = G.TIMERS, ref_value = "REAL_SHADER"},
    ...
    if saveTable then
        ...
        for k, v in pairs(cardAreas) do
            if G[k] then
                ...
                G["load_" .. tostring(k)] = v
                print("ERROR LOADING GAME: Card area '" .. tostring(k) .. "' not instantiated before load")
            end
        end
        for k, v in pairs(G.I.CARD) do
        ...
        if not card_protos then
            ...
            for k, v in pairs(self.P_CARDS) do
                if not (type(SMODS.Ranks[v.value].in_pool) == "function" and not SMODS.Ranks[v.value]:in_pool({initial_deck = true, suit = v.suit}) or type(SMODS.Suits[v.suit].in_pool) == "function" and not SMODS.Suits[v.suit]:in_pool({initial_deck = true, rank = v.value})) then
                    local _ = nil
                    if self.GAME.starting_params.erratic_suits_and_ranks then
                        v, k = pseudorandom_element(
                            _G,
                            G.P_CARDS,
                            pseudoseed(_G, "erratic"),
                            {starting_deck = true}
                        )
                    end
                    ...
                    if self.GAME.starting_params.no_faces and SMODS.Ranks[v.value].face then
                        keep = false
                    end
                    if keep then
        ...
        table.sort(
            card_protos,
            function(a, b)
                return (a.s or "") + ((a.r or "") + ((a.e or "") + ((a.d or "") + (a.g or "")))) < (b.s or "") + ((b.r or "") + ((b.e or "") + ((b.d or "") + (b.g or ""))))
            end
        )
        for ____, ____value in __TS__Iterator(Array.prototype.entries(card_protos)) do
            local k = ____value[1]
            local v = ____value[2]
            card_from_control(_G, v)
        end
        self.GAME.starting_deck_size = G.playing_cards.length
    end
    delay(_G, 0.5)
    if not saveTable then
        ...
        for ____, ____value in __TS__Iterator(Array.prototype.entries(SMODS.mod_list)) do
            local _ = ____value[1]
    ...
    self.HUD = __TS__New(
        UIBox,
        {
            definition = create_UIBox_HUD(_G),
            config = {align = "cli", offset = {x = -0.7, y = 0}, major = G.ROOM_ATTACH}
        }
    )
    self.HUD_blind = __TS__New(
        UIBox,
        {
            definition = create_UIBox_HUD_blind(_G),
            config = {
                major = G.HUD:get_UIE_by_ID("row_blind_bottom"),
                align = "bmi",
                offset = {x = 0, y = -10},
                bond = "Weak"
            }
    ...
    check_and_set_high_score(_G, "most_money", G.GAME.dollars)
    if saveTable then
        G.GAME.blind:load(saveTable.BLIND)
        G.GAME.tags = {}
        local tags = saveTable.tags or ({})
        for ____, ____value in __TS__Iterator(Array.prototype.entries(tags)) do
            local k = ____value[1]
            local v = ____value[2]
            local _tag = Tag(_G, "tag_uncommon")
            _tag:load(v)
            add_tag(_G, _tag)
        end
    else
...
function Game.prototype.update(self, dt)
    nuGC(_G, nil, nil, true)
    G.MAJORS = 0
    G.MINORS = 0
    G.FRAMES.MOVE = G.FRAMES.MOVE + 1
    timer_checkpoint(_G, "start->discovery", "update")
    if not G.SETTINGS.tutorial_complete then
        G.FUNCS:tutorial_controller()
    end
    timer_checkpoint(_G, "tallies", "update")
    modulate_sound(_G, dt)
    timer_checkpoint(_G, "sounds", "update")
    update_canvas_juice(_G, dt)
    timer_checkpoint(_G, "canvas and juice", "update")
    ...
    if self.real_dt > 0.05 then
        print("LONG DT @ " .. tostring(math.floor(G.TIMERS.REAL)) .. ": " .. tostring(self.real_dt))
    end
    if not G.fbf or G.new_frame then
        G.new_frame = false
        set_alerts(_G)
        timer_checkpoint(_G, "alerts", "update")
        ...
        self.SPEEDFACTOR = self.SPEEDFACTOR + math.max(
            0,
            math.abs(G.ACC) - 2
        )
        self.TIMERS.TOTAL = self.TIMERS.TOTAL + dt * self.SPEEDFACTOR
        self.C.DARK_EDITION[2] = 0.6 + 0.2 * math.sin(self.TIMERS.REAL * 1.3)
        self.C.DARK_EDITION[4] = 0.6 + 0.2 * (1 - math.sin(self.TIMERS.REAL * 1.3))
        self.C.DARK_EDITION[3] = math.min(self.C.DARK_EDITION[4], self.C.DARK_EDITION[2])
        self.C.EDITION[2] = 0.7 + 0.2 * (1 + math.sin(self.TIMERS.REAL * 1.5 + 0))
        self.C.EDITION[4] = 0.7 + 0.2 * (1 + math.sin(self.TIMERS.REAL * 1.5 + 3))
        self.C.EDITION[3] = 0.7 + 0.2 * (1 + math.sin(self.TIMERS.REAL * 1.5 + 6))
        for k, v in pairs(SMODS.Rarities) do
            if v.gradient and type(v.gradient) == "function" then
                v:gradient(dt)
            end
        end
        self.E_MANAGER:update(self.real_dt)
        timer_checkpoint(_G, "e_manager", "update")
        if G.GAME.blind and G.boss_throw_hand and self.STATE == self.STATES.SELECTING_HAND then
            if not self.boss_warning_text then
                self.boss_warning_text = __TS__New(
                    UIBox,
                    {
                        definition = {
                            n = G.UIT.ROOT,
                            ...
                            nodes = {
                                {
                                    ...
                                    nodes = {{
                                        ...
                                        config = {object = DynaText(
                                            ...
                                            {
                                                scale = 0.7,
                                                string = localize(_G, "ph_unscored_hand"),
                                                maxw = 9,
                                                colours = {G.C.WHITE},
                                                float = true,
                                                shadow = true,
                        ...
                        config = {align = "cm", offset = {x = 0, y = -3.1}, major = G.play}
                    }
                )
        ...
        timer_checkpoint(_G, "states", "update")
        remove_nils(_G, self.ANIMATIONS)
        for k, v in pairs(self.ANIMATIONS) do
            v:animate(self.real_dt * self.SPEEDFACTOR)
        end
        timer_checkpoint(_G, "animate", "update")
        ...
        timer_checkpoint(_G, "move", "update")
        for k, v in pairs(self.MOVEABLES) do
            v:update(dt * self.SPEEDFACTOR)
            v.states.collide.is = false
        end
        timer_checkpoint(_G, "update", "update")
    end
    self.CONTROLLER:update(self.real_dt)
    if G.prev_small_state ~= G.GAME.round_resets.blind_states.Small or G.prev_large_state ~= G.GAME.round_resets.blind_states.Big or G.prev_boss_state ~= G.GAME.round_resets.blind_states.Boss or G.RESET_BLIND_STATES then
        ...
        G.GAME.round_resets.loc_blind_states.Small = localize(_G, G.GAME.round_resets.blind_states.Small, "blind_states")
        G.GAME.round_resets.loc_blind_states.Big = localize(_G, G.GAME.round_resets.blind_states.Big, "blind_states")
        G.GAME.round_resets.loc_blind_states.Boss = localize(_G, G.GAME.round_resets.blind_states.Boss, "blind_states")
    end
    if G.STEAM and G.STEAM.send_control.update_queued and (G.STEAM.send_control.force or G.STEAM.send_control.last_sent_stage ~= G.STAGE or G.STEAM.send_control.last_sent_time < G.TIMERS.UPTIME - 120) then
    ...
    if G.DEBUG then
        ...
        G.DEBUG_VALUE = "text: " .. tostring(text_count) .. "\\n" .. "uie: " .. tostring(uie_count) .. "\\n" .. "card: " .. tostring(card_count) .. "\\n" .. "uib: " .. tostring(uib_count) .. "\\n" .. "all: " .. tostring(all)
    end
    if G.FILE_HANDLER and G.FILE_HANDLER and G.FILE_HANDLER.update_queued and (G.FILE_HANDLER.force or G.FILE_HANDLER.last_sent_stage ~= G.STAGE or G.FILE_HANDLER.last_sent_pause ~= G.SETTINGS.paused and G.FILE_HANDLER.run or (not G.FILE_HANDLER.last_sent_time or G.FILE_HANDLER.last_sent_time < G.TIMERS.UPTIME - G.F_SAVE_TIMER)) then
        ...
        if G.FILE_HANDLER.progress then
            ...
            if G.FILE_HANDLER.settings then
                G.SAVE_MANAGER.channel:push({type = "save_settings", save_settings = G.ARGS.save_settings, profile_num = G.SETTINGS.profile, save_profile = G.PROFILES[G.SETTINGS.profile or ""]})
            end
        end
...
function Game.prototype.draw(self)
    ...
    timer_checkpoint(_G, "start->canvas", "draw")
    ...
    if not G.debug_UI_toggle then
        ...
        if G.debug_splash_size_toggle then
            ...
            if not self.OVERLAY_MENU or not self.F_HIDE_BG then
                timer_checkpoint(_G, "primatives", "draw")
                ...
                timer_checkpoint(_G, "uiboxes", "draw")
                for k, v in pairs(self.I.CARDAREA) do
                    if not v.parent then
                        love.graphics.push()
                        v:translate_container()
                ...
                if self.OVERLAY_TUTORIAL then
                    ...
                    if self.OVERLAY_TUTORIAL.highlights then
                        for ____, ____value in __TS__Iterator(Array.prototype.entries(self.OVERLAY_TUTORIAL.highlights)) do
                            local k = ____value[1]
                            local v = ____value[2]
                            love.graphics.push()
                            v:translate_container()
            ...
            if self.CONTROLLER.focused.target and __TS__InstanceOf(self.CONTROLLER.focused.target, Card) and (self.CONTROLLER.focused.target.area ~= G.hand or self.CONTROLLER.focused.target == self.CONTROLLER.dragging.target) then
                love.graphics.push()
    ...
    if (not G.recording_mode or G.video_control) and true then
        ...
        G.SHADERS.CRT:send(
            ...
            }) or ({G.ARGS.eased_cursor_pos.sx, G.ARGS.eased_cursor_pos.sy})
        )
    ...
    if not _RELEASE_MODE and G.DEBUG and not G.video_control and G.F_VERBOSE then
        ...
        if G.check and G.SETTINGS.perf_mode then
            ...
            local poll_w = 1
            local v_off = 100
            for ____, ____value in __TS__Iterator(Array.prototype.entries({G.check.update, G.check.draw})) do
                local a = ____value[1]
                local b = ____value[2]
                for ____, ____value in __TS__Iterator(Array.prototype.entries(b.checkpoint_list)) do
                    local k = ____value[1]
                    local v = ____value[2]
                    ...
                    love.graphics.rectangle(
                        ...
                        12,
                        20 + v_off,
                        poll_w + poll_w * v.trend.length,
                        -section_h + 5
                    )
                    for ____, ____value in __TS__Iterator(Array.prototype.entries(v.trend)) do
                        local kk = ____value[1]
                        local vv = ____value[2]
                        if a == 2 then
                    ...
                    love.graphics.print(
                        tostring(v.label) .. ": " .. tostring(stringFormat(_G, "%.2f", 1000 * (v.average or 0))) .. "\\n",
                        10,
                        -section_h + 30 + v_off
                    )
    ...
    timer_checkpoint(_G, "debug", "draw")
end
function Game.prototype.state_col(self, _state)
    return {_state * 15251252.2 / 5.132 % 1, _state * 1422.5641311 / 5.42 % 1, _state * 1522.1523122 / 5.132 % 1, 1}
end
function Game.prototype.update_selecting_hand(self, dt)
    if not self.deck_preview and not G.OVERLAY_MENU and (self.deck and self.deck.cards[1] and self.deck.cards[1].states.collide.is and (not self.deck.cards[1].states.drag.is or self.CONTROLLER.HID.touch) and not self.CONTROLLER.HID.controller or G.CONTROLLER.held_buttons.triggerleft) then
        if self.buttons then
            self.buttons.states.visible = false
        end
        self.deck_preview = __TS__New(
            UIBox,
            {
        ...
        self.E_MANAGER:add_event(__TS__New(
            GameEvent,
            {
                blocking = false,
                blockable = false,
                        ...
                        self.E_MANAGER:add_event(__TS__New(
                            ...
                            {func = function(self)
                                if _card and _card.area and _card.area == G.hand then
                                    local _x, _y = __TS__Unpack(_card:put_focused_cursor())
    ...
    if G.hand.cards.length < 1 and G.deck.cards.length < 1 and G.play.cards.length < 1 then
        end_round(_G)
    end
    if self.shop then
        self.shop:remove()
    ...
    if not G.STATE_COMPLETE then
        ...
        if G.hand.cards.length < 1 and G.deck.cards.length < 1 then
            end_round(_G)
        else
            save_run(_G)
...
function Game.prototype.update_shop(self, dt)
    if not G.STATE_COMPLETE then
        stop_use(_G)
        ease_background_colour_blind(_G, G.STATES.SHOP)
        local shop_exists = not not G.shop
        G.shop = G.shop or __TS__New(
            UIBox,
            {
                            ...
                            if math.abs(G.shop.T.y - G.shop.VT.y) < 3 then
                                ...
                                if not shop_exists then
                                    if G.load_shop_jokers then
                                        ...
                                        for ____, ____value in __TS__Iterator(Array.prototype.entries(G.shop_jokers.cards)) do
                                            local k = ____value[1]
                                            local v = ____value[2]
                                            create_shop_card_ui(_G, v)
                                            if v.ability.consumeable then
                                                v:start_materialize()
                                            end
                                            for ____, ____value in __TS__Iterator(Array.prototype.entries(G.GAME.tags)) do
                                                local _kk = ____value[1]
                                                local vvv = ____value[2]
                                                if vvv:apply_to_run({type = "store_joker_modify", card = v}) then
                                                    break
                                                end
                                            end
                                        end
                                        ...
                                        do
                                            ...
                                            while i <= G.GAME.shop.joker_max - G.shop_jokers.cards.length do
                                                G.shop_jokers:emplace(create_card_for_shop(_G, G.shop_jokers))
                                                i = i + 1
                                            end
                                        end
                                    end
                                    if G.load_shop_vouchers then
                                        ...
                                        for ____, ____value in __TS__Iterator(Array.prototype.entries(G.shop_vouchers.cards)) do
                                            local k = ____value[1]
                                            local v = ____value[2]
                                            create_shop_card_ui(_G, v)
                                            v:start_materialize()
                                    ...
                                    if G.load_shop_booster then
                                        ...
                                        for ____, ____value in __TS__Iterator(Array.prototype.entries(G.shop_booster.cards)) do
                                            local k = ____value[1]
                                            local v = ____value[2]
                                            create_shop_card_ui(_G, v)
                                            v:start_materialize()
                                        ...
                                        do
                                            ...
                                            while i <= 2 do
                                                ...
                                                if not G.GAME.current_round.used_packs[i] then
                                                    G.GAME.current_round.used_packs[i] = get_pack(_G, "shop_pack").key
                                                end
                                                if G.GAME.current_round.used_packs[i] ~= "USED" then
                                                    ...
                                                    create_shop_card_ui(_G, card, "Booster", G.shop_booster)
...
function Game.prototype.update_play_tarot(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
end
function Game.prototype.update_hand_played(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
...
function Game.prototype.update_draw_to_hand(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
    ...
    if not G.STATE_COMPLETE then
        ...
        ease_background_colour_blind(_G, G.STATES.DRAW_TO_HAND)
        G.E_MANAGER:add_event(__TS__New(
            GameEvent,
            {
                trigger = "immediate",
...
function Game.prototype.update_new_round(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
...
function Game.prototype.update_blind_select(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
    ...
    if not G.STATE_COMPLETE then
        stop_use(_G)
        ease_background_colour_blind(_G, G.STATES.BLIND_SELECT)
        G.E_MANAGER:add_event(__TS__New(
            GameEvent,
            {func = function(self)
                save_run(_G)
            ...
            {func = function(self)
                G.E_MANAGER:add_event(__TS__New(
                    GameEvent,
                    {
                        trigger = "immediate",
                        func = function(self)
                            play_sound(_G, "cancel")
                            G.blind_select = __TS__New(
                                UIBox,
                                {
                                    definition = create_UIBox_blind_select(_G),
...
function Game.prototype.update_round_eval(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
        ...
        G.E_MANAGER:add_event(__TS__New(
            GameEvent,
            {
                ...
                func = function(self)
                    ...
                    G.round_eval = __TS__New(
                        UIBox,
                        {
                            definition = create_UIBox_round_evaluation(_G),
...
function Game.prototype.update_arcana_pack(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
    ...
    if not G.STATE_COMPLETE then
        ...
        G.E_MANAGER:add_event(__TS__New(
            GameEvent,
            {
                trigger = "immediate",
                func = function(self)
                    G.booster_pack_sparkles = Particles(
                        _G,
                        1,
                        1,
                        0,
                        0,
                        {
                            ...
                            colours = {
                                G.C.WHITE,
                                lighten(_G, G.C.PURPLE, 0.4),
                                lighten(_G, G.C.PURPLE, 0.2),
                                lighten(_G, G.C.GOLD, 0.2)
                            },
                            fill = true
                        }
                    )
                    ...
                    G.booster_pack = __TS__New(
                        UIBox,
                        {
                            definition = create_UIBox_arcana_pack(_G),
                            config = {align = "tmi", offset = {x = 0, y = G.ROOM.T.y + 9}, major = G.hand, bond = "Weak"}
                        }
                    )
                    G.booster_pack.alignment.offset.y = -2.2
                    G.ROOM.jiggle = G.ROOM.jiggle + 3
                    ease_background_colour_blind(_G, G.STATES.TAROT_PACK)
                    G.E_MANAGER:add_event(__TS__New(
                        GameEvent,
                        {
                            trigger = "immediate",
...
function Game.prototype.update_spectral_pack(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
            ...
            GameEvent,
            {
                ...
                func = function(self)
                    ...
                    G.booster_pack = __TS__New(
                        UIBox,
                        {
                            definition = create_UIBox_spectral_pack(_G),
                            config = {align = "tmi", offset = {x = 0, y = G.ROOM.T.y + 9}, major = G.hand, bond = "Weak"}
                        }
                    )
                    G.booster_pack.alignment.offset.y = -2.2
                    G.ROOM.jiggle = G.ROOM.jiggle + 3
                    ease_background_colour_blind(_G, G.STATES.SPECTRAL_PACK)
                    G.E_MANAGER:add_event(__TS__New(
                        GameEvent,
                        {
                            trigger = "immediate",
...
function Game.prototype.update_standard_pack(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
            ...
            GameEvent,
            {
                ...
                func = function(self)
                    ...
                    G.booster_pack = __TS__New(
                        UIBox,
                        {
                            definition = create_UIBox_standard_pack(_G),
                            config = {align = "tmi", offset = {x = 0, y = G.ROOM.T.y + 9}, major = G.hand, bond = "Weak"}
                        }
                    )
                    G.booster_pack.alignment.offset.y = -2.2
                    G.ROOM.jiggle = G.ROOM.jiggle + 3
                    ease_background_colour_blind(_G, G.STATES.STANDARD_PACK)
                    G.E_MANAGER:add_event(__TS__New(
                        GameEvent,
                        {
                            trigger = "immediate",
...
function Game.prototype.update_buffoon_pack(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
            ...
            GameEvent,
            {
                ...
                func = function(self)
                    G.booster_pack = __TS__New(
                        UIBox,
                        {
                            definition = create_UIBox_buffoon_pack(_G),
                            config = {align = "tmi", offset = {x = 0, y = G.ROOM.T.y + 9}, major = G.hand, bond = "Weak"}
                        }
                    )
                    G.booster_pack.alignment.offset.y = -2.2
                    G.ROOM.jiggle = G.ROOM.jiggle + 3
                    ease_background_colour_blind(_G, G.STATES.BUFFOON_PACK)
                    G.E_MANAGER:add_event(__TS__New(
                        GameEvent,
                        {
                            trigger = "immediate",
...
function Game.prototype.update_celestial_pack(self, dt)
    if self.buttons then
        self.buttons:remove()
        self.buttons = nil
    end
    ...
    if not G.STATE_COMPLETE then
        ...
        G.E_MANAGER:add_event(__TS__New(
            GameEvent,
            {
                trigger = "immediate",
                func = function(self)
                    ease_background_colour_blind(_G, G.STATES.PLANET_PACK)
                    G.booster_pack_stars = Particles(
                        _G,
                        1,
                        1,
                        0,
                    ...
                    G.booster_pack_meteors = Particles(
                        _G,
                        1,
                        1,
                        0,
                    ...
                    G.booster_pack = __TS__New(
                        UIBox,
                        {
                            definition = create_UIBox_celestial_pack(_G),
                            config = {align = "tmi", offset = {x = 0, y = G.ROOM.T.y + 9}, major = G.hand, bond = "Weak"}
                        }
                    )
                    G.booster_pack.alignment.offset.y = -2.2
...
function Game.prototype.update_game_over(self, dt)
    if not G.STATE_COMPLETE then
        remove_save(_G)
        if G.GAME.round_resets.ante <= G.GAME.win_ante then
            if not G.GAME.seeded and not G.GAME.challenge then
                inc_career_stat(_G, "c_losses", 1)
                set_deck_loss(_G)
                set_joker_loss(_G)
            end
        end
        play_sound(_G, "negative", 0.5, 0.7)
        play_sound(_G, "whoosh2", 0.9, 0.7)
        G.SETTINGS.paused = true
        G.FUNCS:overlay_menu({
            definition = create_UIBox_game_over(_G),
            config = {no_esc = true}
        })
        G.ROOM.jiggle = G.ROOM.jiggle + 3
        if G.GAME.round_resets.ante <= G.GAME.win_ante then
...
function Game.prototype.update_menu(self, dt)
end
G = __TS__New(Game)
