                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "While in collection, hover over a card",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "and press the following keys:",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: "[1] Unlock", scale: 0.25, colour: G.C.WHITE },
                      },
                    ],
                  },
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: "[2] Discover", scale: 0.25, colour: G.C.WHITE },
                      },
                    ],
                  },
                  {
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "Hover over any Joker/Playing card",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "and press [Q] to cycle Edition",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "Press [H] to isolate background",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "Press [J] to play splash animation",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: "Press [9] to toggle all tooltips",
                      scale: 0.25,
                      colour: G.C.WHITE,
                      shadow: true,
                    },
...
function create_UIBox_notify_alert(_achievement, _type): void {
  let [_c, _atlas] = [
    ...
    (_type === "Joker" && G.ASSET_ATLAS["Joker"]) ||
      (_type === "Voucher" && G.ASSET_ATLAS["Voucher"]) ||
      (_type === "Back" && G.ASSET_ATLAS["centers"]) ||
      G.ASSET_ATLAS["icons"],
  ];
  let _smods_atlas =
    _c && ((G.SETTINGS.colourblind_option && _c.hc_atlas) || _c.lc_atlas || _c.atlas);
  if (_smods_atlas) {
  ...
  let subtext =
    (_type === "achievement" && localize((G.F_TROPHIES && "k_trophy") || "k_achievement")) ||
    (_type === "Joker" && localize("k_joker")) ||
    (_type === "Voucher" && localize("k_voucher")) ||
    (_type === "Back" && localize("k_deck")) ||
    "ERROR";
            ...
            nodes: [
              {
                n: G.UIT.R,
                config: { align: "cm", r: 0.1 },
                nodes: [{ n: G.UIT.O, config: { object: t_s } }],
              },
              (_type !== "achievement" && {
                n: G.UIT.R,
                ...
                nodes: [
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: name, scale: 0.4, colour: G.C.UI.TEXT_LIGHT, shadow: true },
                      },
                    ],
                  },
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: subtext, scale: 0.3, colour: G.C.FILTER, shadow: true },
                      },
                    ],
                  },
                  {
...
function create_UIBox_online_high_scores(): void {
  ...
  let t = {
    n: G.UIT.ROOT,
    config: { align: "cm", minw: minw, r: 0.1, colour: col, padding: padding },
    nodes: [
...
function create_UIBox_high_scores_filling(_resp): void {
  ...
  if (!_resp) {
    return {
      n: G.UIT.ROOT,
      config: { align: "cm", r: 0.1, colour: G.C.L_BLACK, padding: 0.05 },
      nodes: [
        {
          n: G.UIT.R,
          config: { align: "cm", padding: 0.1, minh: 1.3 },
          nodes: [
  ...
  for (let i = 1; i <= 6; i++) {
    ...
    let name_col =
      (v.username === ((G.SETTINGS.COMP && G.SETTINGS.COMP.name) || undefined) && G.C.FILTER) ||
      G.C.WHITE;
      ...
      nodes: [
        {
          ...
          nodes: [
            {
              n: G.UIT.T,
              config: { text: i + ".", scale: 0.5, colour: G.C.UI.TEXT_LIGHT, shadow: true },
            },
          ],
        },
        {
          ...
          nodes: [
            {
              ...
              config: {
                text: v.username,
                scale: math.min(0.6, (8 * 0.56) / v.username.len()),
                colour: (v.score && name_col) || G.C.UI.TRANSPARENT_LIGHT,
                shadow: true,
              },
            },
          ],
        ...
        {
          n: G.UIT.C,
          config: { align: "cl", minh: 0.8, r: 0.1, minw: 2.5, colour: G.C.BLACK, emboss: 0.05 },
          nodes: [
            {
              n: G.UIT.C,
                  ...
                  nodes: [
                    {
                      ...
                      config: {
                        object: DynaText({
                          string: [(type(v.score) === "number" && number_format(v.score)) || ""],
                          colours: [G.C.RED],
                          shadow: true,
                          float: true,
                          maxw: 2.5,
                          scale: math.min(0.75, score_number_scale(1.5, v.score)),
                        }),
                      },
                    },
                  ],
              ...
              nodes: [
                ...
                },
                {
                  ...
                  nodes: [
                    {
                      n: G.UIT.T,
                      config: { text: localize("$"), colour: G.C.WHITE, scale: 0.4, shadow: true },
                    },
                    {
                      n: G.UIT.T,
                      config: {
      ...
      nodes: [
        {
          ...
          config: {
            ...
            r: 0.08,
            minw: 1.25,
            minh: (card.area && card.area.config.type === "joker" && 0) || 1,
            hover: true,
            shadow: true,
            colour: G.C.UI.BACKGROUND_INACTIVE,
            one_press: true,
...
G.UIDEF.card_focus_ui = function (card) {
  let card_width =
    card.T.w +
    ((card.ability.consumeable && -0.1) || (card.ability.set === "Voucher" && -0.16) || 0);
  ...
  let [tcnx, tcny] = [
    card.T.x + card.T.w / 2 - G.ROOM.T.w / 2,
    card.T.y + card.T.h / 2 - G.ROOM.T.h / 2,
  ];
  let base_background = new UIBox({
    T: [card.VT.x, card.VT.y, 0, 0],
    definition: ((!G.hand || card.area !== G.hand) && {
      n: G.UIT.ROOT,
      config: {
        align: "cm",
        minw: card_width + 0.3,
        minh: card.T.h + 0.3,
        r: 0.1,
        colour: adjust_alpha(G.C.BLACK, 0.7),
    ...
    config: {
      ...
      parent: card,
      r_bond: ((!G.hand || card.area !== G.hand) && "Weak") || "Strong",
    },
  });
  base_background.set_alignment = function () {
    ...
    Moveable.set_alignment(card.children.focused_ui, {
      offset: { x: 0.007 * cnx * card.T.w, y: 0.007 * cny * card.T.h },
    });
  };
  ...
  if (
    ((card.area === G.consumeables && G.consumeables) ||
      (card.area === G.pack_cards && G.pack_cards)) &&
  ...
  if (
    ((card.area === G.jokers && G.jokers) || (card.area === G.consumeables && G.consumeables)) &&
    G.STATE !== G.STATES.TUTORIAL
  ) {
...
G.UIDEF.card_focus_button = function (args) {
  ...
  if (args.type === "sell") {
    ...
    button_contents = {
      n: G.UIT.T,
      config: { text: localize("b_buy"), colour: G.C.WHITE, scale: 0.5 },
    };
  } else if (args.type === "select") {
    button_contents = {
      n: G.UIT.T,
      config: { text: localize("b_select"), colour: G.C.WHITE, scale: 0.3 },
    };
  } else if (args.type === "redeem") {
    button_contents = {
      n: G.UIT.T,
      config: { text: localize("b_redeem"), colour: G.C.WHITE, scale: 0.5 },
    };
  } else if (args.type === "use") {
    button_contents = {
      n: G.UIT.T,
      config: { text: localize("b_use"), colour: G.C.WHITE, scale: 0.5 },
    };
      ...
      nodes: [
        ...
        },
        {
          ...
          nodes: [
            {
              n: G.UIT.T,
              config: { text: localize("b_and_use"), colour: G.C.WHITE, scale: 0.3, shadow: true },
            },
          ],
        },
      ],
  ...
  return new UIBox({
      ...
      nodes: [
        {
          n: G.UIT.R,
          config: {
            id: (args.type === "buy_and_use" && "buy_and_use") || undefined,
            ref_table: args.card,
            ref_parent: args.parent,
            align: (args.type === "sell" && "cl") || "cr",
            colour: G.C.BLACK,
            shadow: true,
            r: 0.08,
            func: args.func,
          ...
          nodes: [
            {
              ...
              config: {
                align: (args.type === "sell" && "cl") || "cr",
                minw: 1 + ((args.type === "select" && 0.1) || 0),
                minh: (args.type === "sell" && 1.5) || 1,
                padding: 0.08,
                focus_args: {
                  button:
                    (args.type === "sell" && "leftshoulder") ||
                    (args.type === "buy_and_use" && "leftshoulder") ||
                    "rightshoulder",
                  scale: 0.55,
                  orientation: (args.type === "sell" && "tli") || "tri",
                  offset: { x: (args.type === "sell" && 0.1) || -0.1, y: 0 },
                  type: "none",
                },
                func: "set_button_pip",
              },
              nodes: [
                { n: G.UIT.R, config: { align: "cm", minh: 0.3 }, nodes: {} },
                {
                  ...
                  nodes: [
                    (args.type !== "sell" && {
                      n: G.UIT.C,
                      config: { align: "cm", minw: 0.2, minh: 0.6 },
                      nodes: {},
                    }) ||
                      undefined,
                    { n: G.UIT.C, config: { align: "cm", maxw: 1 }, nodes: [button_contents] },
                    (args.type === "sell" && {
                      n: G.UIT.C,
                      config: { align: "cm", minw: 0.2, minh: 0.6 },
                      nodes: {},
    ...
    config: {
      ...
      offset: {
        x:
          ((args.type === "sell" && -1) || 1) * ((args.card_width || 0) - 0.17 - args.card.T.w / 2),
        y: (args.type === "buy_and_use" && 0.6) || (args.buy_and_use && -0.6) || 0,
      },
      parent: args.parent,
    },
  });
...
G.UIDEF.deck_preview = function (args) {
  ...
  wheel_flipped_text =
    (wheel_flipped > 0 && {
      n: G.UIT.T,
      config: { text: "?", colour: G.C.FILTER, scale: 0.25, shadow: true },
    }) ||
    undefined;
  ...
  suit_labels[suit_labels.length + 1] = {
    ...
    nodes: [
      (stones && {
        n: G.UIT.T,
        config: {
          text: localize("ph_deck_preview_stones") + ": ",
          colour: G.C.WHITE,
          scale: 0.25,
          shadow: true,
        },
      ...
      (stones && {
        ...
        config: {
          text: "" + stones,
          colour: (stones > 0 && G.C.WHITE) || G.C.UI.TRANSPARENT_LIGHT,
          scale: 0.4,
          shadow: true,
        },
      }) ||
  ...
  for (const [k, v] of ipairs(rank_name_mapping)) {
    ...
    let rank_col =
      (v === "A" && _bg_col) || ((v === "K" || v === "Q" || v === "J") && G.C.WHITE) || _bg_col;
        ...
        nodes: [
          {
            n: G.UIT.T,
            config: {
              text: "" + SUITS[suit_map[j]][i].length,
              colour: _colour,
              scale: _tscale,
              shadow: true,
  ...
  for (const [k, v] of ipairs(suit_map)) {
    ...
    let t_s = new Sprite(
      ...
      0.3,
      0.3,
      G.ASSET_ATLAS["ui_" + ((G.SETTINGS.colourblind_option && 2) || 1)],
      { x: _x, y: 1 }
    );
    t_s.states.drag.can = false;
    t_s.states.hover.can = false;
      ...
      nodes: [
        {
          ...
          nodes: [{ n: G.UIT.O, config: { can_collide: false, object: t_s } }],
        },
        {
          n: G.UIT.C,
          ...
          nodes: [
            ...
            (mod_suit_counts[v] !== suit_counts[v] && {
              n: G.UIT.T,
              config: {
                text: " (" + (mod_suit_counts[v] + ")"),
          ...
          nodes: [
            {
              n: G.UIT.R,
              config: { align: "cm" },
              nodes: [{ n: G.UIT.O, config: { object: shop_sign } }],
            },
            {
              n: G.UIT.R,
              config: { align: "cm" },
                        ...
                        nodes: [
                          {
                            ...
                            config: {
                              align: "cm",
                              padding: 0.07,
                              focus_args: { button: "y", orientation: "cr" },
                              func: "set_button_pip",
                            },
                            nodes: [
                              {
                        ...
                        nodes: [
                          {
                            ...
                            config: {
                              align: "cm",
                              padding: 0.07,
                              focus_args: { button: "x", orientation: "cr" },
                              func: "set_button_pip",
                            },
                            nodes: [
                              {
...
function create_card_for_shop(area): void {
  if (
    ...
    G.SETTINGS.tutorial_progress.forced_shop[G.SETTINGS.tutorial_progress.forced_shop.length]
  ) {
      ...
      { type: "Planet", val: G.GAME.planet_rate },
      {
        type:
          (G.GAME.used_vouchers["v_illusion"] &&
            pseudorandom(pseudoseed("illusion")) > 0.6 &&
            "Enhanced") ||
          "Base",
    ...
    for (const [_, v] of ipairs(rates)) {
      if (polled_rate > check_rate && polled_rate <= check_rate + v.val) {
        ...
        if (
          (v.type === "Base" || v.type === "Enhanced") &&
          G.GAME.used_vouchers["v_illusion"] &&
          pseudorandom(pseudoseed("illusion")) > 0.8
        ) {
  ...
  G.E_MANAGER.add_event(
    new GameEvent({
      ...
      func: function () {
        ...
        let t2 = (card.ability.set === "Voucher" && {
          n: G.UIT.ROOT,
          config: {
            ref_table: card,
            minw: 1.1,
              ...
              nodes: [
                ...
                },
                {
                  ...
                  nodes: [
                    {
                      n: G.UIT.T,
                      config: { text: localize("b_and_use"), colour: G.C.WHITE, scale: 0.3 },
                    },
                  ],
                },
              ],
        ...
        card.children.buy_button = new UIBox({
          definition: t2,
          config: {
            align: "bm",
            offset: { x: 0, y: -0.3 },
        ...
        if (card.ability.consumeable) {
          card.children.buy_and_use_button = new UIBox({
            definition: t3,
            config: {
              align: "cr",
              offset: { x: -0.3, y: 0 },
...
function attention_text(args): void {
  ...
  args.uibox_config = {
    ...
    major: args.cover || args.major || undefined,
  };
  G.E_MANAGER.add_event(
    new GameEvent({
      trigger: "after",
      ...
      func: function () {
        args.AT = new UIBox({
          ...
          definition: {
            n: G.UIT.ROOT,
            config: {
              align: args.cover_align || "cm",
              minw: ((args.cover && args.cover.T.w) || 0.001) + (args.cover_padding || 0),
              minh: ((args.cover && args.cover.T.h) || 0.001) + (args.cover_padding || 0),
              padding: 0.03,
              r: 0.1,
              emboss: args.emboss,
        ...
        if (args.backdrop_colour) {
          ...
          Particles(args.pos.x, args.pos.y, 0, 0, {
            timer_type: "TOTAL",
            timer: 5,
            scale: 2.4 * (args.backdrop_scale || 1),
            lifespan: 5,
            speed: 0,
            attach: args.AT,
...
function create_UIBox_buttons(): void {
  ...
  let t = {
    n: G.UIT.ROOT,
    config: { align: "cm", minw: 1, minh: 0.3, padding: 0.15, r: 0.1, colour: G.C.CLEAR },
    nodes: [
      (G.SETTINGS.play_button_pos === 1 && discard_button) || play_button,
      {
        n: G.UIT.C,
        config: {
          align: "cm",
          ...
          outline: 1.5,
          outline_colour: mix_colours(G.C.WHITE, G.C.JOKER_GREY, 0.7),
          line_emboss: 1,
        },
        nodes: [
          {
...
function desc_from_rows(desc_nodes, empty, maxw): void {
  ...
  return {
    ...
    config: {
      align: "cm",
      colour: desc_nodes.background_colour || (empty && G.C.CLEAR) || G.C.UI.BACKGROUND_WHITE,
      r: 0.1,
      padding: 0.04,
      minw: 2,
      minh: 0.8,
      emboss: (!empty && 0.05) || undefined,
      filler: true,
    },
    ...
    nodes: [
      {
        ...
        nodes: [{ n: G.UIT.T, config: { text: name, scale: 0.32, colour: G.C.UI.TEXT_LIGHT } }],
      },
      {
        n: G.UIT.R,
        config: {
          ...
          r: 0.1,
          padding: 0.05,
          colour: desc_nodes.background_colour || G.C.WHITE,
        },
        nodes: [{ n: G.UIT.R, config: { align: "cm", padding: 0.03 }, nodes: t }],
      },
    ],
...
function name_from_rows(name_nodes, background_colour): void {
  ...
  return {
    ...
    config: {
      ...
      emboss: (background_colour && 0.05) || undefined,
    },
    nodes: name_nodes,
  };
}
G.UIDEF.card_h_popup = function (card) {
  if (card.ability_UIBox_table) {
    ...
    let card_type_background = (AUT.card_type === "Locked" && G.C.BLACK) ||
      (AUT.card_type === "Undiscovered" && darken(G.C.JOKER_GREY, 0.3)) ||
      ((AUT.card_type === "Enhanced" || AUT.card_type === "Default") && darken(G.C.BLACK, 0.1)) ||
      (debuffed && darken(G.C.BLACK, 0.1)) ||
      (card_type_colour && darken(G.C.BLACK, 0.1)) ||
      G.C.SET[AUT.card_type] || [0, 1, 1, 1];
    ...
    let [disp_type, is_playing_card] = [
      (AUT.card_type !== "Locked" &&
        AUT.card_type !== "Undiscovered" &&
        AUT.card_type !== "Default") ||
        debuffed,
      AUT.card_type === "Enhanced" || AUT.card_type === "Default",
    ];
    let info_boxes = {};
    let badges = {};
    ...
    if (AUT.badges.card_type || AUT.badges.force_rarity) {
      if (obj && (obj.set_card_type_badge || (obj.type && obj.type.set_card_type_badge))) {
        ...
        badges[badges.length + 1] = create_badge(
          ((card.ability.name === "Pluto" ||
            card.ability.name === "Ceres" ||
            card.ability.name === "Eris") &&
            localize("k_dwarf_planet")) ||
            (card.ability.name === "Planet X" && localize("k_planet_q")) ||
            card_type,
          card_type_colour,
          undefined,
          1.2
          ...
          nodes: [
            {
              ...
              nodes: [info_tip_from_rows(v, v.name)],
            },
          ],
        };
      }
    ...
    info_boxes = [
      { n: G.UIT.R, config: { align: "cm", padding: 0.05, card_pos: card.T.x }, nodes: info_cols },
    ];
    return {
      n: G.UIT.ROOT,
      config: { align: "cm", colour: G.C.CLEAR },
      nodes: [
        {
          ...
          config: {
            ...
            func: "show_infotip",
            object: Moveable(),
            ref_table: (next(info_boxes) && info_boxes) || undefined,
          },
          nodes: [
            {
              n: G.UIT.R,
              ...
              nodes: [
                {
                  ...
                  nodes: [
                    name_from_rows(AUT.name, (is_playing_card && G.C.WHITE) || undefined),
    ...
    nodes: [
      {
        ...
        nodes: [
          { n: G.UIT.B, config: { h: 0.1, w: 0.03 } },
          {
            ...
            config: {
              object: DynaText({
                string: _string || "ERROR",
                colours: [_text_col || G.C.WHITE],
                float: true,
                shadow: true,
                offset_y: -0.05,
                silent: true,
    ...
    nodes: [
      {
        ...
        nodes: [info_tip_from_rows(desc.info[1], desc.info[1].name)],
      },
    ],
  };
}
function create_popup_UIBox_tooltip(tooltip): void {
      ...
      nodes: [
        {
          n: G.UIT.C,
          config: { align: "cm" },
          nodes: [{ n: G.UIT.T, config: { text: title, colour: G.C.UI.TEXT_DARK, scale: 0.4 } }],
        },
      ],
    };
    table.insert(rows, r);
  ...
  for (let i = 1; i <= text.length; i++) {
    if (type(text[i]) === "table") {
        ...
        nodes: [
          {
            n: G.UIT.T,
            config: {
              ref_table: text[i].ref_table,
              ref_value: text[i].ref_value,
      ...
      let r = {
        n: G.UIT.R,
        config: { align: "cm", padding: 0.03 },
        nodes: [{ n: G.UIT.T, config: { text: text[i], colour: G.C.UI.TEXT_DARK, scale: 0.4 } }],
      };
      table.insert(rows, r);
    }
  }
  ...
  let t = {
    n: G.UIT.ROOT,
    config: { align: "cm", padding: 0.05, r: 0.1, colour: G.C.RED, emboss: 0.05 },
    nodes: [
      {
        n: G.UIT.C,
        config: { align: "cm", padding: 0.05, r: 0.1, colour: G.C.WHITE, emboss: 0.05 },
        nodes: rows,
      },
    ],
  };
    ...
    nodes: [
      ...
      },
      {
        ...
        nodes: [
          {
            n: G.UIT.R,
            config: { align: "cm", id: "HUD_blind_debuff", func: "HUD_blind_debuff" },
            nodes: {},
          },
          {
            n: G.UIT.R,
...
function add_tag(_tag): void {
  ...
  G.HUD_tags[G.HUD_tags.length + 1] = new UIBox({
    definition: {
      n: G.UIT.ROOT,
    ...
    config: {
      align: (G.HUD_tags[1] && "tm") || "bri",
      offset: (G.HUD_tags[1] && { x: 0, y: 0 }) || { x: 0.7, y: 0 },
      major: (G.HUD_tags[1] && G.HUD_tags[G.HUD_tags.length]) || G.ROOM_ATTACH,
    },
  });
              ...
              nodes: [
                {
                  ...
                  config: {
                    object: DynaText({
                      string: [{ ref_table: G.GAME, ref_value: "round" }],
                      colours: [G.C.IMPORTANT],
                      shadow: true,
                      scale: 2 * scale,
                    }),
            ...
            nodes: [
              {
                ...
                config: {
                  ...
                  object: DynaText({
                    string: [
                      { ref_table: G.GAME.current_round.current_hand, ref_value: "handname_text" },
                    ],
                    colours: [G.C.UI.TEXT_LIGHT],
                    shadow: true,
                    float: true,
                ...
                nodes: [
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      object: DynaText({
                        string: [
                          { ref_table: G.GAME.current_round.current_hand, ref_value: "chip_text" },
                        ],
                        colours: [G.C.UI.TEXT_LIGHT],
                        font: G.LANGUAGES["en-us"].font,
                        shadow: true,
                ...
                nodes: [
                  ...
                  { n: G.UIT.B, config: { w: 0.1, h: 0.1 } },
                  {
                    ...
                    config: {
                      ...
                      object: DynaText({
                        string: [
                          { ref_table: G.GAME.current_round.current_hand, ref_value: "mult_text" },
                        ],
                        colours: [G.C.UI.TEXT_LIGHT],
                        font: G.LANGUAGES["en-us"].font,
                        shadow: true,
        ...
        nodes: [
          ...
          },
          {
            ...
            nodes: [
              {
                n: G.UIT.O,
                config: { w: 0.5, h: 0.5, object: stake_sprite, hover: true, can_collide: false },
              },
              { n: G.UIT.B, config: { w: 0.1, h: 0.1 } },
              {
                n: G.UIT.T,
              ...
              nodes: [
                {
                  ...
                  config: {
                    ...
                    colour: G.C.UI.TEXT_LIGHT,
                    shadow: true,
                    focus_args: { button: (G.F_GUIDE && "guide") || "back", orientation: "bm" },
                    func: "set_button_pip",
                  },
                },
              ],
        ...
        nodes: [
          {
            ...
            nodes: [
              ...
              {
                n: G.UIT.R,
                config: { align: "cm", id: "row_blind", minw: 1, minh: 3.75 },
                nodes: [
...
function create_UIBox_blind_select(): void {
  G.blind_prompt_box = new UIBox({
    definition: {
      ...
      nodes: [
        ...
        ((G.GAME.used_vouchers["v_retcon"] || G.GAME.used_vouchers["v_directors_cut"]) &&
          UIBox_button({
  ...
  G.blind_select_opts.boss =
    (G.GAME.round_resets.blind_states["Boss"] !== "Hide" &&
      new UIBox({
        definition: {
          n: G.UIT.ROOT,
          config: { align: "cm", colour: G.C.CLEAR },
    ...
    nodes: [
      {
        ...
        nodes: [
          (G.GAME.round_resets.blind_states["Small"] !== "Hide" && {
            n: G.UIT.O,
            config: { align: "cm", object: G.blind_select_opts.small },
          }) ||
            undefined,
          (G.GAME.round_resets.blind_states["Big"] !== "Hide" && {
            n: G.UIT.O,
            config: { align: "cm", object: G.blind_select_opts.big },
          }) ||
            undefined,
          (G.GAME.round_resets.blind_states["Boss"] !== "Hide" && {
            n: G.UIT.O,
            config: { align: "cm", object: G.blind_select_opts.boss },
          }) ||
            undefined,
        ],
      },
        ...
        nodes: [
          {
            ...
            config: {
              text: localize("k_or"),
              scale: 0.55,
              colour: (disabled && G.C.UI.TEXT_INACTIVE) || G.C.WHITE,
              shadow: !disabled,
            },
          },
        ],
...
function create_UIBox_blind_choice(type, run_info): void {
  ...
  blind_choice.animation = new AnimatedSprite(
    0,
    0,
    1.4,
    1.4,
    G.ANIMATION_ATLAS[blind_choice.config.atlas] || G.ANIMATION_ATLAS["blind_chips"],
  ...
  G.GAME.orbital_choices[G.GAME.round_resets.ante] =
    G.GAME.orbital_choices[G.GAME.round_resets.ante] || {};
  if (!G.GAME.orbital_choices[G.GAME.round_resets.ante][type]) {
    ...
    G.GAME.orbital_choices[G.GAME.round_resets.ante][type] = pseudorandom_element(
      _poker_hands,
      pseudoseed("orbital")
    );
  }
          ...
          nodes: [
            {
              n: G.UIT.R,
              config: { align: "cm" },
              nodes: [{ n: G.UIT.O, config: { object: dt1 } }],
            },
            {
              n: G.UIT.R,
              config: { align: "cm" },
              nodes: [{ n: G.UIT.O, config: { object: dt2 } }],
            },
            {
              n: G.UIT.R,
              config: { align: "cm" },
              nodes: [{ n: G.UIT.O, config: { object: dt3 } }],
            },
          ],
        },
      ],
  ...
  for (const [k, v] of ipairs(text_table)) {
    blind_desc_nodes[blind_desc_nodes.length + 1] = {
      n: G.UIT.R,
      config: { align: "cm", maxw: 2.8 },
      nodes: [
        {
  ...
  let run_info_colour =
    run_info &&
    ((blind_state === "Defeated" && G.C.GREY) ||
      (blind_state === "Skipped" && G.C.BLUE) ||
      (blind_state === "Upcoming" && G.C.ORANGE) ||
      (blind_state === "Current" && G.C.RED) ||
      G.C.GOLD);
  let t = {
    n: G.UIT.R,
    config: {
      ...
      minh: (!run_info && 10) || undefined,
      ref_table: { deck: undefined, run_info: run_info },
      r: 0.1,
      padding: 0.05,
    },
    nodes: [
            ...
            nodes: [
              (!run_info && {
                ...
                config: {
                  ...
                  colour: (disabled && G.C.UI.BACKGROUND_INACTIVE) || G.C.ORANGE,
                  minh: 0.6,
                  minw: 2.7,
                  padding: 0.07,
                  r: 0.1,
                ...
                nodes: [
                  {
                    ...
                    config: {
                      ...
                      ref_value: type,
                      scale: 0.45,
                      colour: (disabled && G.C.UI.TEXT_INACTIVE) || G.C.UI.TEXT_LIGHT,
                      shadow: !disabled,
                    },
                  },
                ],
                ...
                nodes: [
                  {
                    ...
                    config: {
                      object: DynaText({
                        string: loc_name,
                        colours: [(disabled && G.C.UI.TEXT_INACTIVE) || G.C.WHITE],
                        shadow: !disabled,
                        float: !disabled,
                        y_offset: -4,
                        scale: 0.45,
                    ...
                    nodes: [
                      {
                        ...
                        nodes: [{ n: G.UIT.O, config: { object: blind_choice.animation } }],
                      },
                      (text_table[1] && {
                        n: G.UIT.R,
                        config: { align: "cm", minh: 0.7, padding: 0.05, minw: 2.9 },
                        nodes: blind_desc_nodes,
                      }) ||
                        undefined,
                    ],
                  },
                        ...
                        nodes: [
                          ...
                          { n: G.UIT.B, config: { h: 0.1, w: 0.1 } },
                          {
                            ...
                            config: {
                              ...
                              colour: (disabled && G.C.UI.TEXT_INACTIVE) || G.C.RED,
                              shadow: !disabled,
                            },
                          },
                        ],
                      ...
                      (_reward && {
                        ...
                        nodes: [
                          ...
                          },
                          {
                            n: G.UIT.T,
                            config: {
                              text: string.rep(localize("$"), blind_choice.config.dollars) + "+",
                              scale: 0.35,
                              colour: (disabled && G.C.UI.TEXT_INACTIVE) || G.C.MONEY,
                              shadow: !disabled,
                            },
                          },
                        ],
        ...
        [
          {
            ...
            nodes: [
              ...
              {
                n: G.UIT.R,
                config: { align: "cm", minw: width, id: "base_round_eval" },
                nodes: {},
              },
              {
                n: G.UIT.R,
                config: { align: "cm", minw: width, id: "bonus_round_eval" },
                nodes: {},
              },
            ],
          },
                ...
                nodes: [
                  {
                    ...
                    nodes: [{ n: G.UIT.O, config: { object: G.pack_cards } }],
                  },
                ],
              },
            ],
                          ...
                          nodes: [
                            {
                              ...
                              config: {
                                object: DynaText({
                                  string: localize("k_spectral_pack"),
                                  colours: [G.C.WHITE],
                                  shadow: true,
                                  rotate: true,
                                  bump: true,
                          ...
                          nodes: [
                            {
                              ...
                              config: {
                                object: DynaText({
                                  string: localize("k_standard_pack"),
                                  colours: [G.C.WHITE],
                                  shadow: true,
                                  rotate: true,
                                  bump: true,
                          ...
                          nodes: [
                            {
                              ...
                              config: {
                                object: DynaText({
                                  string: localize("k_buffoon_pack"),
                                  colours: [G.C.WHITE],
                                  shadow: true,
                                  rotate: true,
                                  bump: true,
                          ...
                          nodes: [
                            {
                              ...
                              config: {
                                object: DynaText({
                                  string: localize("k_celestial_pack"),
                                  colours: [G.C.WHITE],
                                  shadow: true,
                                  rotate: true,
                                  bump: true,
    ...
    nodes: [
      {
        ...
        config: {
          ...
          minh: 0.42,
          colour:
            (args.no_bg && G.C.CLEAR) ||
            args.bg_col ||
            (args.red_bad && darken(G.C.RED, 0.1)) ||
            G.C.RED,
          draw_layer: 1,
          emboss: 0.05,
        ...
        nodes: [
          {
            ...
            config: {
              object: DynaText({
                ...
                shadow: true,
                rotate: true,
                H_offset: args.y_offset || 0,
                bump_rate: (args.text && 3) || 7,
                bump_amount: args.bump_amount || 3,
                bump: true,
                maxw: args.maxw,
                text_rot: args.text_rot || 0.2,
                spacing: 3 * (args.scale || 1),
                scale: args.scale || 0.48,
              }),
            },
          },
        ],
...
function create_slider(args): void {
  ...
  if (args.label) {
    t = {
      n: G.UIT.R,
      config: { align: "cm", minh: 1, minw: 1, padding: 0.1 * args.label_scale, colour: G.C.CLEAR },
      nodes: [
        {
          n: G.UIT.R,
          config: { align: "cm", padding: 0 },
        ...
        { n: G.UIT.R, config: { align: "cm", padding: 0 }, nodes: [t] },
      ],
    };
  }
  return t;
...
function create_toggle(args): void {
  ...
  let check = new Sprite(0, 0, 0.5 * args.scale, 0.5 * args.scale, G.ASSET_ATLAS["icons"], {
    x: 1,
    y: 0,
  });
  ...
  if (args.info) {
    ...
    for (const [k, v] of ipairs(args.info)) {
      table.insert(info, {
        ...
        nodes: [{ n: G.UIT.T, config: { text: v, scale: 0.25, colour: G.C.UI.TEXT_LIGHT } }],
      });
    }
    info = { n: G.UIT.R, config: { align: "cm", minh: 0.05 }, nodes: info };
  }
  let t = {
    n: (args.col && G.UIT.C) || G.UIT.R,
    config: {
      align: "cm",
      padding: 0.1,
      r: 0.1,
...
function create_option_cycle(args): void {
  ...
  for (let i = 1; i <= args.options.length; i++) {
    pips[pips.length + 1] = {
      ...
      config: {
        ...
        r: 0.05,
        id: "pip_" + i,
        colour: (args.current_option === i && G.C.WHITE) || G.C.BLACK,
      },
    };
  }
  let choice_pips =
    (!args.no_pips && {
      ...
      config: {
        align: "cm",
        padding: (0.05 - ((args.options.length > 15 && 0.03) || 0)) * args.scale,
      },
      nodes: pips,
    }) ||
    undefined;
  let t = {
    ...
    config: {
      ...
      r: 0.1,
      colour: G.C.CLEAR,
      id: (args.id && ((!args.label && args.id) || undefined)) || undefined,
    ...
    nodes: [
      {
        ...
        config: {
          ...
          minw: 0.6 * args.scale,
          hover: !disabled,
          colour: (!disabled && args.colour) || G.C.BLACK,
          shadow: !disabled,
          button: (!disabled && "option_cycle") || undefined,
          ref_table: args,
          ref_value: "l",
          focus_args: { type: "none" },
        },
        nodes: [
          {
            ...
            config: {
              ...
              ref_value: "l",
              scale: args.text_scale,
              colour: (!disabled && G.C.UI.TEXT_LIGHT) || G.C.UI.TEXT_INACTIVE,
            },
          },
        ],
      },
      (args.mid && {
        n: G.UIT.C,
        config: { id: "cycle_main" },
        nodes: [
          { n: G.UIT.R, config: { align: "cm", minh: 0.05 }, nodes: [args.mid] },
          (!disabled && choice_pips) || undefined,
        ],
      }) || {
        n: G.UIT.C,
        config: {
  ...
  if (args.label || args.info) {
    t = {
      n: G.UIT.R,
      config: { align: "cm", padding: 0.05, id: args.id || undefined },
      nodes: [
        (args.label && {
          n: G.UIT.R,
          config: { align: "cm" },
  ...
  args.tabs = args.tabs || [
    {
      ...
      tab_definition_function: function () {
        return {
          n: G.UIT.ROOT,
          config: { align: "cm" },
          nodes: [{ n: G.UIT.T, config: { text: "A", scale: 1, colour: G.C.UI.TEXT_LIGHT } }],
        };
      },
    },
    {
      ...
      tab_definition_function: function () {
        return {
          n: G.UIT.ROOT,
          config: { align: "cm" },
          nodes: [{ n: G.UIT.T, config: { text: "B", scale: 1, colour: G.C.UI.TEXT_LIGHT } }],
        };
      },
    },
    {
      ...
      tab_definition_function: function () {
        return {
          n: G.UIT.ROOT,
          config: { align: "cm" },
          nodes: [{ n: G.UIT.T, config: { text: "C", scale: 1, colour: G.C.UI.TEXT_LIGHT } }],
        };
      },
    },
  ];
    ...
    nodes: [
      {
        ...
        nodes: [
            ...
            undefined,
          {
            n: G.UIT.C,
            config: {
              id: (args.no_shoulders && "no_shoulders") || "tab_shoulders",
              ref_table: args,
              align: "cm",
              padding: 0.15,
              group: 1,
        ...
        nodes: [
          {
            ...
            config: {
              id: "tab_contents",
              object: new UIBox({
                definition: args.current.v.tab_definition_function(
                  args.current.v.tab_definition_function_args
                ),
...
function create_text_input(args): void {
  ...
  for (let i = 1; i <= args.max_length; i++) {
    text.letters[i] =
      (args.ref_table[args.ref_value] &&
        (string.sub(args.ref_table[args.ref_value], i, i) || "")) ||
      "";
    ui_letters[i] = {
      n: G.UIT.T,
      config: {
  ...
  ui_letters[ui_letters.length + 1] = {
    ...
    config: {
      ...
      scale: args.text_scale,
      colour: lighten(copy_table(args.colour), 0.4),
      id: args.id + "_prompt",
    },
  };
  ui_letters[ui_letters.length + 1] = {
    ...
    nodes: [
      {
        ...
        nodes: [
          {
            n: G.UIT.R,
            config: { ref_table: args, padding: 0.05, align: "cm", r: 0.1, colour: G.C.CLEAR },
            nodes: [
              {
                n: G.UIT.R,
                config: {
...
function create_keyboard_input(args): void {
  let keyboard_rows = [
    ...
    "ASDFGHJKL",
    "ZXCVBNM",
    (args.space_key && " ") || undefined,
  ];
  let keyboard_button_rows = [{}, {}, {}, {}, {}];
  for (const [k, v] of ipairs(keyboard_rows)) {
    for (let i = 1; i <= v.length; i++) {
      let c = v.sub(i, i);
      keyboard_button_rows[k][keyboard_button_rows[k].length + 1] = create_keyboard_button(
        c,
        (c === " " && "y") || undefined
      );
    }
                    ...
                    nodes: [
                      {
                        ...
                        nodes: keyboard_button_rows[1],
                      },
                      {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.07, colour: G.C.CLEAR },
                        nodes: keyboard_button_rows[2],
                      },
                      {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.07, colour: G.C.CLEAR },
                        nodes: keyboard_button_rows[3],
                      },
                      {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.07, colour: G.C.CLEAR },
                        nodes: keyboard_button_rows[4],
                      },
                      {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.07, colour: G.C.CLEAR },
                        nodes: keyboard_button_rows[5],
                      },
                    ],
                  },
                  ((args.backspace_key || args.return_key) && {
                    n: G.UIT.C,
                    config: { align: "cm", padding: 0.05, colour: G.C.CLEAR },
                    nodes: [
                      (args.backspace_key && {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.05, colour: G.C.CLEAR },
                        nodes: [create_keyboard_button("backspace", "x")],
                      }) ||
                        undefined,
                      (args.return_key && {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.05, colour: G.C.CLEAR },
                        nodes: [create_keyboard_button("return", "start")],
                      }) ||
                        undefined,
                      {
                        n: G.UIT.R,
                        config: { align: "cm", padding: 0.05, colour: G.C.CLEAR },
                        nodes: [create_keyboard_button("back", "b")],
                      },
                    ],
                  }) ||
                    undefined,
...
function create_keyboard_button(key, binding): void {
  ...
  return UIBox_button({
    label: [key_label],
    button: "key_button",
    ref_table: { key: (key === "back" && "return") || key },
    minw:
      (key === " " && 6) ||
      (key === "return" && 2.5) ||
      (key === "backspace" && 2.5) ||
      ...
      0.8,
    minh:
      (key === "return" && 1.5) || (key === "backspace" && 1.5) || (key === "back" && 0.8) || 0.7,
    col: true,
    colour: G.C.GREY,
    focus_args:
      (binding && {
        button: binding,
        orientation: ((key === " " || key === "back") && "cr") || "bm",
        set_button_pip: true,
      }) ||
      undefined,
  });
...
function create_UIBox_options(): void {
              ...
              nodes: [
                {
                  ...
                  config: {
                    align: "cm",
                    r: 0.1,
                    colour: (G.GAME.seeded && G.C.RED) || G.C.BLACK,
                    minw: 1.8,
                    minh: 0.5,
                    padding: 0.1,
                    emboss: 0.05,
  ...
  let t = create_UIBox_generic_options({
    contents: [
      settings,
      (G.GAME.seeded && current_seed) || undefined,
      restart,
      main_menu,
      mods,
      high_scores,
...
function create_UIBox_settings(): void {
  ...
  let t = create_UIBox_generic_options({
    back_func: "options",
    contents: [create_tabs({ tabs: tabs, tab_h: 7.05, tab_alignment: "tm", snap_to_nav: true })],
  });
  return t;
}
G.UIDEF.settings_tab = function (tab) {
  if (tab === "Game") {
    return {
      ...
      nodes: [
        create_option_cycle({
          ...
          current_option:
            (G.SETTINGS.GAMESPEED === 0.5 && 1) ||
            (G.SETTINGS.GAMESPEED === 4 && 4) ||
            G.SETTINGS.GAMESPEED + 1,
        }),
        create_option_cycle({
          w: 5,
          label: localize("b_set_play_discard_pos"),
          scale: 0.8,
          options: localize("ml_play_discard_pos_opt"),
          opt_callback: "change_play_discard_position",
          current_option: G.SETTINGS.play_button_pos,
        }),
        (G.F_RUMBLE &&
          create_toggle({
            label: localize("b_set_rumble"),
            ref_table: G.SETTINGS,
            ref_value: "rumble",
          })) ||
          undefined,
        create_slider({
          label: localize("b_set_screenshake"),
          w: 4,
          h: 0.4,
          ref_table: G.SETTINGS,
        ...
        create_toggle({
          label: localize("ph_display_stickers"),
          ref_table: G.SETTINGS,
        ...
        create_toggle({
          label: localize("b_reduced_motion"),
          ref_table: G.SETTINGS,
          ref_value: "reduced_motion",
        }),
        (G.F_CRASH_REPORTS &&
          create_toggle({
            label: localize("b_set_crash_reports"),
            ref_table: G.SETTINGS,
            ref_value: "crashreports",
            info: localize("ml_crash_report_info"),
          })) ||
          undefined,
      ],
    };
    ...
    let res_option = GET_DISPLAYINFO(
      G.SETTINGS.WINDOW.screenmode,
      G.SETTINGS.WINDOW.selected_display
    );
    return {
      n: G.UIT.ROOT,
      config: { align: "cm", padding: 0.05, colour: G.C.CLEAR },
      nodes: [
        ...
        create_option_cycle({
          ...
          current_option:
            { Windowed: 1, Fullscreen: 2, Borderless: 3 }[G.SETTINGS.WINDOW.screenmode] || 1,
        }),
        {
          n: G.UIT.R,
          ...
          nodes: [
            create_option_cycle({
              ...
              scale: 0.8,
              options:
                G.SETTINGS.WINDOW.DISPLAYS[G.SETTINGS.WINDOW.selected_display].screen_resolutions
                  .strings,
              opt_callback: "change_screen_resolution",
              current_option: res_option || 1,
            }),
          ],
        },
        {
          ...
          nodes: [
            create_option_cycle({
              w: 4,
              scale: 0.8,
              options: localize("ml_vsync_opt"),
              opt_callback: "change_vsync",
              current_option: (G.SETTINGS.WINDOW.vsync === 0 && 2) || 1,
            }),
          ],
        },
        UIBox_button({
    ...
    return {
      ...
      nodes: [
        create_slider({
          label: localize("b_set_master_vol"),
          w: 5,
          h: 0.4,
        ...
        create_slider({
          label: localize("b_set_music_vol"),
          w: 5,
          h: 0.4,
          ref_table: G.SETTINGS.SOUND,
    ...
    return {
      ...
      nodes: [
        create_option_cycle({
          w: 4,
          scale: 0.8,
          label: localize("b_set_shadows"),
          options: localize("ml_shadow_opt"),
          opt_callback: "change_shadows",
          current_option: (G.SETTINGS.GRAPHICS.shadows === "On" && 1) || 2,
        }),
        create_option_cycle({
          w: 4,
          scale: 0.8,
          label: localize("b_set_pixel_smoothing"),
          options: localize("ml_smoothing_opt"),
          opt_callback: "change_pixel_smoothing",
          current_option: G.SETTINGS.GRAPHICS.texture_scaling,
        }),
        create_slider({
          label: localize("b_set_CRT"),
          w: 4,
          h: 0.4,
        ...
        create_option_cycle({
          w: 4,
          scale: 0.8,
          label: localize("b_set_CRT_bloom"),
          options: localize("ml_bloom_opt"),
          opt_callback: "change_crt_bloom",
          current_option: G.SETTINGS.GRAPHICS.bloom,
        }),
        create_option_cycle({
          label: localize("b_graphics_mipmap_level"),
          scale: 0.8,
...
function create_UIBox_test_framework(variables): void {
  ...
  for (const [k, v] of pairs(variables)) {
    if (v.type === "cycle") {
        ...
        nodes: [
          ...
          },
          {
            ...
            nodes: [
              create_option_cycle({
                options: v.options,
                opt_callback: "test_framework_cycle_callback",
      ...
      table.insert(nodes, {
        n: G.UIT.R,
        config: { align: "cm", minh: 1, minw: 1, padding: 0.05, colour: G.C.CLEAR },
        nodes: [
          {
            n: G.UIT.R,
            config: { align: "cm", padding: 0 },
      ...
      table.insert(nodes, {
        ...
        nodes: [
          ...
          },
          {
            n: G.UIT.R,
            config: { align: "cm", padding: 0 },
            nodes: [create_text_input(v.options)],
          },
        ],
      });
    }
  ...
  let t = {
    ...
    config: {
      ...
      padding: 0.15,
      r: 0.1,
      colour: [G.C.BLACK[1], G.C.BLACK[2], G.C.BLACK[3], 0.6],
    },
    nodes: [
      {
        n: G.UIT.C,
                ...
                nodes: [
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: "Back", scale: 0.5, colour: G.C.UI.TEXT_LIGHT },
                      },
                    ],
                  },
                ],
...
function create_UIBox_usage(args): void {
        ...
        nodes: [
          {
            ...
            nodes: [
              {
                n: G.UIT.R,
                config: { align: "cm", minh: 0.7 * G.CARD_H + 0.1 },
                nodes: [{ n: G.UIT.O, config: { object: cardarea } }],
              },
              {
                n: G.UIT.R,
                config: { align: "cm", padding: 0.1 },
                nodes: [
                  {
                    ...
                    config: {
                      text: v.count,
                      scale: 0.35,
                      colour: mix_colours(G.C.FILTER, G.C.WHITE, 0.8),
                      shadow: true,
                    },
                  },
                ],
                ...
                nodes: [
                  {
                    ...
                    config: {
                      ...
                      minw: 0.8,
                      colour: G.C.SECONDARY_SET[G.P_CENTERS[v.key].set] || G.C.RED,
                      res: 0.15,
                      r: 0.001,
                    },
                    nodes: {},
        ...
        nodes: [
          {
            ...
            nodes: [
              {
                n: G.UIT.R,
                config: { align: "cm", minh: 0.7 * G.CARD_H + 0.1, minw: 0.7 * G.CARD_W },
                nodes: {},
              },
              {
                n: G.UIT.R,
  ...
  let t = {
    n: G.UIT.ROOT,
    config: { align: "cm", minw: 3, padding: 0.1, r: 0.1, colour: G.C.UI.TRANSPARENT_DARK },
    nodes: [
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0.1 },
        nodes: [
          { n: G.UIT.B, config: { w: 0.2, h: 0.2, r: 0.1, colour: G.C.FILTER } },
          {
            ...
            config: {
              text:
                (_type === "joker_usage" && localize("ph_stat_joker")) ||
                (_type === "consumeable_usage" && localize("ph_stat_consumable")) ||
                (_type === "voucher_usage" && localize("ph_stat_voucher")),
              scale: 0.35,
              colour: G.C.WHITE,
            },
          },
    ...
    contents: [
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0 },
        nodes: [create_tabs({ tabs: suitTabs, snap_to_nav: true, no_shoulders: true })],
      },
    ],
  });
  return t;
...
function create_progress_box(_profile_progress, smaller): void {
  ...
  for (const [_, v] of ipairs(protos)) {
    ...
    if (v === "collection") {
      ...
      [tab, val, max] = [
        _profile_progress.joker_stickers,
        "tally",
        _profile_progress.joker_stickers.of,
      ];
      ...
      (v === "collection" && [
          ...
          config: {
            object: DynaText({
              string: [
                math.floor(
                  0.01 +
                    (100 * _profile_progress.discovered.tally) / _profile_progress.discovered.of
                ) + "%",
              ],
              colours: [G.C.WHITE],
              shadow: true,
        ...
        },
        {
          ...
          config: {
            text:
              " (" +
              (_profile_progress.discovered.tally +
                ("/" + (_profile_progress.discovered.of + ")"))),
            scale: 0.35,
            colour: G.C.JOKER_GREY,
          },
        },
      ...
      (v === "deck_stake_wins" && [
          ...
          config: {
            object: DynaText({
              string: [
                math.floor(
                  0.01 +
                    (100 * _profile_progress.deck_stakes.tally) / _profile_progress.deck_stakes.of
                ) + "%",
              ],
              colours: [G.C.WHITE],
              shadow: true,
        ...
        },
        {
          ...
          config: {
            text:
              " (" +
              (_profile_progress.deck_stakes.tally +
                ("/" + (_profile_progress.deck_stakes.of + ")"))),
            scale: 0.35,
            colour: G.C.JOKER_GREY,
          },
        },
      ...
      (v === "joker_stickers" && [
          ...
          config: {
            object: DynaText({
              string: [
                math.floor(
                  0.01 +
                    (100 * _profile_progress.joker_stickers.tally) /
                      _profile_progress.joker_stickers.of
                ) + "%",
              ],
              colours: [G.C.WHITE],
        ...
        },
        {
          ...
          config: {
            text:
              " (" +
              (_profile_progress.joker_stickers.tally +
                ("/" + (_profile_progress.joker_stickers.of + ")"))),
            scale: 0.35,
            colour: G.C.JOKER_GREY,
          },
      ...
      (v === "challenges" && [
          ...
          config: {
            object: DynaText({
              string: [
                math.floor(
                  0.01 +
                    (100 * _profile_progress.challenges.tally) / _profile_progress.challenges.of
                ) + "%",
              ],
              colours: [G.C.WHITE],
              shadow: true,
        ...
        },
        {
          ...
          config: {
            text:
              " (" +
              (_profile_progress.challenges.tally +
                ("/" + (_profile_progress.challenges.of + ")"))),
            scale: 0.35,
            colour: G.C.JOKER_GREY,
          },
        },
        ...
        },
        {
          ...
          config: {
            ...
            progress_bar: {
              ...
              ref_value: val,
              empty_col: G.C.BLACK,
              filled_col: adjust_alpha(bar_colour, 0.5),
            },
          },
          nodes: [
            {
                    ...
                    config: {
                      object: DynaText({
                        string: [
                          math.floor(
                            0.01 +
                              (100 * _profile_progress.overall_tally) / _profile_progress.overall_of
                          ) + "%",
                        ],
                        colours: [G.C.WHITE],
                        shadow: true,
...
function create_UIBox_high_scores_row(score): void {
  ...
  let label_scale =
    0.65 -
    0.025 * math.max(string.len(G.PROFILES[G.SETTINGS.profile].high_scores[score].label) - 8, 0);
    ...
    score_tab = [
      {
        ...
        config: {
          object: DynaText({
            string: [(amount < 1 && handname) || localize(handname, "poker_hands")],
            colours: [G.C.WHITE],
            shadow: true,
            float: true,
            scale: 0.55,
    ...
    score_tab = [
      {
        ...
        config: {
          object: DynaText({
            string: [
              localize("$") + number_format(G.PROFILES[G.SETTINGS.profile].high_scores[score].amt),
            ],
            colours: [G.C.MONEY],
            shadow: true,
            float: true,
            scale: score_number_scale(0.85, G.PROFILES[G.SETTINGS.profile].high_scores[score].amt),
          }),
        },
      },
    ];
    ...
    score_tab = [
      {
        ...
        config: {
          object: DynaText({
            string: [number_format(G.PROFILES[G.SETTINGS.profile].high_scores[score].amt)],
            colours: [G.C.WHITE],
            shadow: true,
            float: true,
            scale: score_number_scale(0.85, G.PROFILES[G.SETTINGS.profile].high_scores[score].amt),
      ...
      },
      {
        n: G.UIT.T,
        config: {
          text: " (" + (G.PROFILES[G.SETTINGS.profile].high_scores["current_streak"].amt + ")"),
          scale: 0.45,
          colour: G.C.JOKER_GREY,
        },
      },
    ...
    score_tab = [
      {
        n: G.UIT.C,
        config: { align: "cm" },
        nodes: [{ n: G.UIT.O, config: { w: 0.4, h: 0.4, object: chip_sprite } }],
      },
      {
        n: G.UIT.C,
        config: { align: "cm" },
        nodes: [
          {
            ...
            config: {
              object: DynaText({
                ...
                scale: math.min(
                  0.75,
                  score_number_scale(1.5, G.PROFILES[G.SETTINGS.profile].high_scores[score].amt)
                ),
              }),
            },
          },
        ...
        nodes: [
              ...
              object: DynaText({
                string: [
                  "%" +
                    math.floor(
                      0.01 +
                        (100 * G.PROFILES[G.SETTINGS.profile].high_scores[score].amt) /
                          G.PROFILES[G.SETTINGS.profile].high_scores[score].tot
                    ),
                ],
                colours: [G.C.WHITE],
                shadow: true,
          ...
          },
          {
            ...
            config: {
              text:
                " (" +
                (G.PROFILES[G.SETTINGS.profile].high_scores[score].amt +
                  ("/" + (G.PROFILES[G.SETTINGS.profile].high_scores[score].tot + ")"))),
              scale: 0.45,
              colour: G.C.JOKER_GREY,
            },
  ...
  return {
    ...
    nodes: [
        ...
        nodes: [
          {
            n: G.UIT.T,
            config: {
              text: localize(score, "high_scores"),
              scale: label_scale,
              colour: G.C.UI.TEXT_LIGHT,
              shadow: true,
            },
      ...
      {
        n: G.UIT.C,
        config: { align: "cl", minh: h, r: 0.1, minw: score_w, colour: G.C.BLACK, emboss: 0.05 },
        nodes: [
          {
            n: G.UIT.C,
            config: { align: "cm", padding: 0.05, r: 0.1, minw: score_w, maxw: score_w },
            nodes: score_tab,
          },
        ],
      },
    ...
    contents: [
      {
        ...
        nodes: [
            ...
            nodes: [
              {
                ...
                config: {
                  object: DynaText({
                    string: [localize("ph_demo_thanks_1")],
                    colours: [G.C.WHITE],
                    shadow: true,
                    float: true,
                    scale: 0.9,
            ...
            nodes: [
              {
                ...
                config: {
                  object: DynaText({
                    string: [localize("ph_demo_thanks_2")],
                    colours: [G.C.WHITE],
                    shadow: true,
                    bump: true,
                    rotate: true,
          ...
          {
            n: G.UIT.R,
            config: { align: "tm", padding: 0.12, emboss: 0.1, colour: G.C.L_BLACK, r: 0.1 },
            nodes: [
              simple_text_container("ml_demo_thanks_message", {
                colour: G.C.UI.TEXT_LIGHT,
                scale: 0.55,
                shadow: true,
              }),
...
function create_UIBox_demo_video_CTA(): void {
  ...
  video_file
    .getSource()
    .setVolume((G.SETTINGS.SOUND.volume * G.SETTINGS.SOUND.game_sounds_volume) / (100 * 100));
...
function create_UIBox_round_scores_row(score, text_colour): void {
  ...
  let score_tab = {};
  let [label_w, score_w, h] = [
    ({ hand: true, poker_hand: true }[score] && 3.5) || 2.9,
    ({ hand: true, poker_hand: true }[score] && 3.5) || 1,
    0.5,
  ];
    ...
    score_tab = [
      {
        ...
        config: {
          object: DynaText({
            string: [number_format(G.GAME.round_resets.ante)],
            colours: [text_colour || G.C.FILTER],
            shadow: true,
            float: true,
            scale: 0.45,
          }),
    ...
    score_tab = [
      {
        ...
        config: {
          object: DynaText({
            string: [number_format(G.GAME.round)],
            colours: [text_colour || G.C.FILTER],
            shadow: true,
            float: true,
            scale: 0.45,
        ...
        nodes: [
          {
            ...
            config: {
              object: DynaText({
                string: localize({ type: "name_text", key: blind_choice.config.key, set: "Blind" }),
                colours: [G.C.WHITE],
                shadow: true,
                float: true,
                maxw: 2.2,
    ...
    score_tab = [
      {
        n: G.UIT.C,
        config: { align: "cm" },
        nodes: [{ n: G.UIT.O, config: { w: 0.3, h: 0.3, object: chip_sprite } }],
      },
      {
        n: G.UIT.C,
        config: { align: "cm" },
        nodes: [
          {
            ...
            config: {
              object: DynaText({
                string: [number_format(G.GAME.round_scores[score].amt)],
                colours: [text_colour || G.C.RED],
                shadow: true,
                float: true,
                scale: math.min(0.6, score_number_scale(1.2, G.GAME.round_scores[score].amt)),
              }),
            },
          },
        ],
    ...
    score_tab = [
      {
        ...
        config: {
          object: DynaText({
            ...
            shadow: true,
            float: true,
            scale: score_number_scale(0.6, G.GAME.round_scores[score].amt),
          }),
        },
      },
    ];
  ...
  return {
    ...
    config: {
      ...
      colour: darken(G.C.JOKER_GREY, 0.1),
      emboss: 0.05,
      func: (check_high_score && "high_score_alert") || undefined,
      id: score,
    },
    nodes: [
      {
        n: (score === "defeated_by" && G.UIT.R) || G.UIT.C,
        config: { align: "cm", padding: 0.02, minw: label_w, maxw: label_w },
        nodes: [
          {
            n: G.UIT.T,
            config: { text: label, scale: label_scale, colour: G.C.UI.TEXT_LIGHT, shadow: true },
          },
        ],
      },
      {
        ...
        nodes: [
          {
            ...
            config: {
              ...
              minh: h,
              r: 0.1,
              minw: (score === "defeated_by" && label_w) || score_w,
              colour: (score === "seed" && G.GAME.seeded && G.C.RED) || G.C.BLACK,
              emboss: 0.05,
            },
            nodes: [
              {
                n: G.UIT.C,
                config: { align: "cm", padding: 0.05, r: 0.1, minw: score_w },
                nodes: score_tab,
              },
            ],
          },
...
function create_UIBox_hand_tip(handname): void {
  ...
  let cardarea = CardArea(2, 2, 3.5 * G.CARD_W, 0.75 * G.CARD_H, {
    card_limit: 5,
    type: "title",
    highlight_limit: 0,
  });
    ...
    (G.GAME.hands[handname].visible &&
      ((!simple && {
        ...
        config: {
          ...
          force_focus: true,
          on_demand_tooltip: {
            text: localize(handname, "poker_hand_descriptions"),
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: localize("k_level_prefix") + G.GAME.hands[handname].level,
                      scale: 0.5,
                      colour: G.C.UI.TEXT_DARK,
                    },
                  },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: " " + localize(handname, "poker_hands"),
                      scale: 0.45,
                      colour: G.C.UI.TEXT_LIGHT,
                      shadow: true,
                    },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: number_format(G.GAME.hands[handname].chips, 1000000),
                      scale: 0.45,
                      colour: G.C.UI.TEXT_LIGHT,
                    },
                  },
              ...
              { n: G.UIT.T, config: { text: "X", scale: 0.45, colour: G.C.MULT } },
              {
                ...
                nodes: [
                  { n: G.UIT.B, config: { w: 0.08, h: 0.01 } },
                  {
                    n: G.UIT.T,
                    config: {
                      text: number_format(G.GAME.hands[handname].mult, 1000000),
                      scale: 0.45,
                      colour: G.C.UI.TEXT_LIGHT,
                    },
                  },
            ...
            nodes: [
              {
                n: G.UIT.T,
                config: {
                  text: G.GAME.hands[handname].played,
                  scale: 0.45,
                  colour: G.C.FILTER,
                  shadow: true,
                },
        ...
        config: {
          ...
          focus_args: { snap_to: simple && handname === "Straight Flush" },
        },
        nodes: [
          {
            n: G.UIT.C,
    ...
    contents: [
      create_tabs({
        tabs: [
          ...
          { label: localize("b_blinds"), tab_definition_function: G.UIDEF.current_blinds },
          { label: localize("b_vouchers"), tab_definition_function: G.UIDEF.used_vouchers },
          (G.GAME.stake > 1 && {
  ...
  return {
    ...
    nodes: [
      (G.GAME.round_resets.blind_states["Small"] !== "Hide" && {
        ...
        nodes: [create_UIBox_blind_choice("Small", true)],
      }) ||
        undefined,
      (G.GAME.round_resets.blind_states["Big"] !== "Hide" && {
        n: G.UIT.C,
        ...
        nodes: [create_UIBox_blind_choice("Big", true)],
      }) ||
        undefined,
      (G.GAME.round_resets.blind_states["Boss"] !== "Hide" && {
        n: G.UIT.C,
        ...
        nodes: [create_UIBox_blind_choice("Boss", true)],
      }) ||
        undefined,
    ],
  };
...
G.UIDEF.deck_stake_column = function (_deck_key) {
  ...
  for (let i = G.P_CENTER_POOLS["Stake"].length; i <= 1; i += -1) {
    ...
    if (
      (deck_usage && deck_usage.wins[i - 1]) ||
      i === 1 ||
      G.PROFILES[G.SETTINGS.profile].all_unlocked
    ) {
      valid_option = true;
    }
    stake_col[stake_col.length + 1] = {
      ...
      config: {
        id: i,
        align: "cm",
        colour: (_wins > 0 && G.C.GREY) || G.C.CLEAR,
        outline: 0,
        outline_colour: G.C.WHITE,
        r: 0.1,
        minh: 0.25,
        minw: (valid_option && 0.45) || 0.25,
      ...
      nodes: [
        {
          ...
          config: {
            align: "cm",
            minh: (valid_option && 0.17) || 0.13,
            minw: (valid_option && 0.37) || 0.13,
            colour: (_wins > 0 && get_stake_col(i)) || G.C.UI.TRANSPARENT_LIGHT,
            r: 0.1,
          },
          nodes: {},
        },
    ...
    if (i > 1) {
      stake_col[stake_col.length + 1] = {
        n: G.UIT.R,
        config: { align: "cm", minh: 0.1, minw: 0.04 },
        nodes: {},
      };
    }
  }
  ...
  if (G.GAME.stake > 2) {
    let stake_desc_rows = [
      {
        ...
        nodes: [
          {
            n: G.UIT.T,
            config: { text: localize("k_also_applied"), scale: 0.4, colour: G.C.WHITE },
          },
        ],
      },
    ];
    if (false) {
      for (let i = G.GAME.stake - 1; i <= 2; i += -1) {
        ...
        stake_desc_rows[stake_desc_rows.length + 1] = {
          n: G.UIT.R,
          config: { align: "cm" },
          nodes: [
            {
    ...
    nodes: [
      {
        ...
        nodes: [
          {
            n: G.UIT.O,
            config: { colour: G.C.BLUE, object: stake_sprite, hover: true, can_collide: false },
          },
          {
            n: G.UIT.T,
            config: {
              text: localize({
                type: "name_text",
                key: G.P_CENTER_POOLS.Stake[G.GAME.stake].key,
                set: "Stake",
              }),
              scale: 0.45,
              colour: G.C.WHITE,
      ...
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0.05, colour: get_stake_col(G.GAME.stake), r: 0.05 },
        nodes: [
          {
            n: G.UIT.R,
            config: { align: "cm", padding: 0.05, colour: G.C.WHITE, r: 0.05 },
            nodes: [
              {
                n: G.UIT.R,
...
G.UIDEF.view_deck = function (unplayed_only) {
  ...
  for (let j = 1; j <= 4; j++) {
    if (SUITS[suit_map[j]][1]) {
      ...
      table.insert(deck_tables, {
        n: G.UIT.R,
        config: { align: "cm", padding: 0 },
        nodes: [{ n: G.UIT.O, config: { object: view_deck } }],
      });
      for (let i = 1; i <= SUITS[suit_map[j]].length; i++) {
        if (SUITS[suit_map[j]][i]) {
          ...
          if (
            unplayed_only &&
            !(
              (SUITS[suit_map[j]][i].area && SUITS[suit_map[j]][i].area === G.deck) ||
              SUITS[suit_map[j]][i].ability.wheel_flipped
            )
          ) {
            greyed = true;
          }
  ...
  for (const [k, v] of ipairs(G.playing_cards)) {
    if (
      ...
      (!unplayed_only || (v.area && v.area === G.deck) || v.ability.wheel_flipped)
    ) {
      if (v.ability.wheel_flipped && unplayed_only) {
        wheel_flipped = wheel_flipped + 1;
      }
      suit_tallies[v.base.suit] = (suit_tallies[v.base.suit] || 0) + 1;
      mod_suit_tallies["Spades"] =
        (mod_suit_tallies["Spades"] || 0) + ((v.is_suit("Spades") && 1) || 0);
      mod_suit_tallies["Hearts"] =
        (mod_suit_tallies["Hearts"] || 0) + ((v.is_suit("Hearts") && 1) || 0);
      mod_suit_tallies["Clubs"] =
        (mod_suit_tallies["Clubs"] || 0) + ((v.is_suit("Clubs") && 1) || 0);
      mod_suit_tallies["Diamonds"] =
        (mod_suit_tallies["Diamonds"] || 0) + ((v.is_suit("Diamonds") && 1) || 0);
  ...
  let modded =
    face_tally !== mod_face_tally ||
    mod_suit_tallies["Spades"] !== suit_tallies["Spades"] ||
    mod_suit_tallies["Hearts"] !== suit_tallies["Hearts"] ||
    mod_suit_tallies["Clubs"] !== suit_tallies["Clubs"] ||
                        ...
                        nodes: [
                          tally_sprite(
                            ...
                            [
                              ...
                              { string: "" + mod_suit_tallies["Spades"], colour: G.C.BLUE },
                            ],
                          ...
                          tally_sprite(
                            ...
                            [
                              ...
                              { string: "" + mod_suit_tallies["Hearts"], colour: G.C.BLUE },
                            ],
                        ...
                        nodes: [
                          ...
                          tally_sprite(
                            ...
                            [
                              ...
                              { string: "" + mod_suit_tallies["Diamonds"], colour: G.C.BLUE },
                            ],
...
function tally_sprite(pos, value, tooltip, suit): void {
  ...
  let t_s = new Sprite(
    ...
    0.5,
    G.ASSET_ATLAS[
      suit && SMODS.Suits[suit][(G.SETTINGS.colourblind_option && "hc_ui_atlas") || "lc_ui_atlas"]
    ] || G.ASSET_ATLAS["ui_" + ((G.SETTINGS.colourblind_option && "2") || "1")],
    { x: pos.x || 0, y: pos.y || 0 }
  );
  t_s.states.drag.can = false;
    ...
    nodes: [
      {
        ...
        nodes: [
          {
            n: G.UIT.O,
            config: { w: 0.5, h: 0.5, can_collide: false, object: t_s, tooltip: { text: tooltip } },
          },
        ],
      },
      {
        ...
        nodes: [
          (type(value) === "table" && {
            ...
            n: G.UIT.T,
            config: { text: value || "NIL", colour: text_colour, scale: 0.4, shadow: true },
          },
        ],
      },
    ],
  ...
  for (const [k, v] of ipairs(keys_used)) {
    if (next(v)) {
      ...
      voucher_areas[voucher_areas.length + 1] = CardArea(
        G.ROOM.T.x + (0.2 * G.ROOM.T.w) / 2,
        G.ROOM.T.h,
        ((v.length === 1 && 1) || 1.33) * G.CARD_W,
        ((area_count >= 10 && 0.75) || 1.07) * G.CARD_H,
      ...
      table.insert(voucher_tables, {
        n: G.UIT.C,
        config: { align: "cm", padding: 0, no_fill: true },
        nodes: [{ n: G.UIT.O, config: { object: voucher_areas[voucher_areas.length] } }],
      });
    }
  }
  table.insert(voucher_table_rows, {
...
function create_UIBox_your_collection(): void {
  ...
  if (SMODS.ConsumableType.ctype_buffer.length <= 3) {
    for (const [_, key] of ipairs(SMODS.ConsumableType.ctype_buffer)) {
      ...
      consumable_nodes[consumable_nodes.length + 1] = UIBox_button({
        ...
        count: G.DISCOVER_TALLIES[key.lower() + "s"],
        minw: 4,
        id: id,
    ...
    consumable_nodes[consumable_nodes.length + 1] = UIBox_button({
      ...
      label: [
        localize("b_stat_consumables"),
        localize({
          type: "variable",
          key: "c_types",
          vars: [SMODS.ConsumableType.ctype_buffer.length],
        }),
      ],
  ...
  let t = create_UIBox_generic_options({
    back_func: (G.STAGE === G.STAGES.RUN && "options") || "exit_overlay_menu",
    contents: [
      {
        n: G.UIT.C,
        config: { align: "cm", padding: 0.15 },
                ...
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: localize("k_cap_consumables"),
                      scale: 0.45,
                      colour: G.C.L_BLACK,
                      vert: true,
                      maxh: 2.2,
      ...
      },
      {
        ...
        nodes: [
          ...
          UIBox_button({
            ...
            label: [localize("b_booster_packs")],
...
function create_UIBox_your_collection_jokers(): void {
  ...
  for (
    let i = 1;
    i <= math.ceil(G.P_CENTER_POOLS.Joker.length / (5 * G.your_collection.length));
    i++
  ) {
    table.insert(
      joker_options,
      localize("k_page") +
        (" " +
          (tostring(i) +
            ("/" +
              tostring(math.ceil(G.P_CENTER_POOLS.Joker.length / (5 * G.your_collection.length))))))
    );
  }
  for (let i = 1; i <= 5; i++) {
...
function create_UIBox_your_collection_tarots(): void {
  ...
  for (let i = 1; i <= math.floor(G.P_CENTER_POOLS.Tarot.length / 11); i++) {
    table.insert(
      tarot_options,
      localize("k_page") +
        (" " + (tostring(i) + ("/" + tostring(math.floor(G.P_CENTER_POOLS.Tarot.length / 11)))))
    );
  }
  for (let j = 1; j <= G.your_collection.length; j++) {
    for (let i = 1; i <= 4 + j; i++) {
  ...
  INIT_COLLECTION_CARD_ALERTS();
  let t = create_UIBox_generic_options({
    back_func: (G.ACTIVE_MOD_UI && "openModUI_" + G.ACTIVE_MOD_UI.id) || "your_collection",
    contents: [
      {
        n: G.UIT.R,
...
function create_UIBox_your_collection_boosters(): void {
  ...
  for (let i = 1; i <= math.ceil(G.P_CENTER_POOLS.Booster.length / 8); i++) {
    table.insert(
      booster_options,
      localize("k_page") +
        (" " + (tostring(i) + ("/" + tostring(math.ceil(G.P_CENTER_POOLS.Booster.length / 8)))))
    );
  }
  for (let j = 1; j <= G.your_collection.length; j++) {
    for (let i = 1; i <= 4; i++) {
...
function create_UIBox_your_collection_spectrals(): void {
  ...
  for (let i = 1; i <= math.floor(G.P_CENTER_POOLS.Tarot.length / 9); i++) {
    table.insert(
      spectral_options,
      localize("k_page") +
        (" " + (tostring(i) + ("/" + tostring(math.floor(G.P_CENTER_POOLS.Spectral.length / 9)))))
    );
  }
  INIT_COLLECTION_CARD_ALERTS();
  let t = create_UIBox_generic_options({
...
function create_UIBox_your_collection_vouchers(exit): void {
  ...
  for (
    let i = 1;
    i <= math.ceil(G.P_CENTER_POOLS.Voucher.length / (4 * G.your_collection.length));
    i++
  ) {
    table.insert(
      voucher_options,
      localize("k_page") +
        (" " +
          (tostring(i) +
            ("/" +
              tostring(
                math.ceil(G.P_CENTER_POOLS.Voucher.length / (4 * G.your_collection.length))
              ))))
    );
  }
  for (let i = 1; i <= 4; i++) {
  ...
  INIT_COLLECTION_CARD_ALERTS();
  let t = create_UIBox_generic_options({
    back_func: exit || "your_collection",
    contents: [
      {
        n: G.UIT.R,
        config: { align: "cm", minw: 2.5, padding: 0.1, r: 0.1, colour: G.C.BLACK, emboss: 0.05 },
...
function create_UIBox_your_collection_editions(): void {
  ...
  let deck_tables = {
    n: G.UIT.R,
    config: { align: "cm", padding: 0, no_fill: true },
    nodes: [{ n: G.UIT.O, config: { object: G.your_collection[1] } }],
  };
              ...
              nodes: [
                ...
                },
                {
                  ...
                  nodes: [
                    {
                      n: G.UIT.R,
                      config: { align: "cm", emboss: 0.1, r: 0.1, minw: 4, maxw: 4, minh: 0.6 },
                      nodes: [
                        {
                          n: G.UIT.O,
                          config: {
                    ...
                    {
                      n: G.UIT.R,
                      config: { align: "cm", colour: G.C.WHITE, emboss: 0.1, minh: 2.2, r: 0.1 },
                      nodes: [
                        {
                          n: G.UIT.O,
                          config: {
...
function create_UIBox_your_collection_tags(): void {
  ...
  for (const [k, v] of ipairs(tag_tab)) {
    ...
    tag_matrix[math.ceil((k - 1) / 6 + 0.001)][1 + ((k - 1) % 6)] = {
      n: G.UIT.C,
      config: { align: "cm", padding: 0.1 },
      nodes: [temp_tag_ui],
    };
        ...
        nodes: [
          {
            n: G.UIT.C,
            config: { align: "cm" },
            nodes: [{ n: G.UIT.R, config: { align: "cm" }, nodes: table_nodes }],
          },
        ],
      },
    ],
...
function create_UIBox_your_collection_blinds(exit): void {
  ...
  table.sort(blind_tab, function (a, b) {
    return (
      a.order + ((a.boss && a.boss.showdown && 1000) || 0) <
      b.order + ((b.boss && b.boss.showdown && 1000) || 0)
    );
  });
  ...
  for (const [k, v] of ipairs(blind_tab)) {
    ...
    let temp_blind = new AnimatedSprite(
      0,
      0,
      s,
      s,
      G.ANIMATION_ATLAS[(discovered && v.atlas) || "blind_chips"],
      (discovered && v.pos) || G.b_undiscovered.pos
    );
    ...
    table.insert(blind_matrix[row], {
      ...
      config: { align: "cm", padding: 0.1 },
      nodes: [
        ((k - blinds_per_row) % (2 * blinds_per_row) === 1 && {
          n: G.UIT.B,
          config: { h: 0.2, w: 0.5 },
        }) ||
          undefined,
        { n: G.UIT.O, config: { object: temp_blind, focus_with_object: true } },
        ((k - blinds_per_row) % (2 * blinds_per_row) === 0 && {
          n: G.UIT.B,
          config: { h: 0.2, w: 0.5 },
        }) ||
          undefined,
  ...
  for (
    let i = 1;
    i <= math.min(16, math.max(16, G.PROFILES[G.SETTINGS.profile].high_scores.furthest_ante.amt));
    i++
  ) {
    let spacing =
      1 -
      math.min(20, math.max(15, G.PROFILES[G.SETTINGS.profile].high_scores.furthest_ante.amt)) *
        0.06;
    if (spacing > 0 && i > 1) {
      ante_amounts[ante_amounts.length + 1] = { n: G.UIT.R, config: { minh: spacing }, nodes: {} };
    }
    let blind_chip = new Sprite(
      0,
      0,
      0.2,
      0.2,
        ...
        },
        {
          ...
          nodes: [
            ...
            { n: G.UIT.C, config: { align: "cm", minw: 0.03, minh: 0.01 }, nodes: {} },
            {
              n: G.UIT.T,
              config: {
                text: number_format(get_blind_amount(i)),
                scale: 0.4,
                colour:
                  (i <= G.PROFILES[G.SETTINGS.profile].high_scores.furthest_ante.amt && G.C.RED) ||
                  G.C.JOKER_GREY,
                shadow: true,
              },
            },
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: {
                          text: localize("k_ante_cap"),
                          scale: 0.4,
                          colour: lighten(G.C.FILTER, 0.2),
                          shadow: true,
                        },
                      },
                    ],
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: {
                          text: localize("k_base_cap"),
                          scale: 0.4,
                          colour: lighten(G.C.RED, 0.2),
                          shadow: true,
                        },
                      },
                    ],
  ...
  if (discovered) {
    ...
    if (loc_target) {
      for (const [k, v] of ipairs(loc_target)) {
        ability_text[ability_text.length + 1] = {
          n: G.UIT.R,
          config: { align: "cm" },
          nodes: [
            { n: G.UIT.T, config: { text: v, scale: 0.35, shadow: true, colour: G.C.WHITE } },
          ],
        };
      }
    }
      ...
      nodes: [
        ...
        },
        {
          ...
          nodes: [
            ...
            {
              n: G.UIT.T,
              config: { text: blind.mult + localize("k_x_base"), scale: 0.4, colour: G.C.RED },
            },
          ],
        },
        {
          ...
          nodes: [
            {
              n: G.UIT.T,
              config: { text: localize("ph_blind_reward"), scale: 0.35, colour: G.C.UI.TEXT_DARK },
            },
            {
              n: G.UIT.O,
              config: {
                object: DynaText({
                  string: [(_dollars && string.rep(localize("$"), _dollars)) || "-"],
                  colours: [G.C.MONEY],
                  rotate: true,
                  bump: true,
                  silent: true,
        ...
        (ability_text[1] && {
          ...
          config: {
            align: "cm",
            padding: 0.08,
            colour: mix_colours(blind.boss_colour, G.C.GREY, 0.4),
            r: 0.1,
            emboss: 0.05,
            minw: 2.5,
            minh: 0.9,
    ...
    blind_text[blind_text.length + 1] = {
      n: G.UIT.R,
      config: { align: "cm", emboss: 0.05, r: 0.1, minw: 2.5, padding: 0.1, colour: G.C.WHITE },
      nodes: [
        {
          n: G.UIT.R,
          config: { align: "cm" },
          nodes: [
            {
              n: G.UIT.T,
              config: {
                text: localize("ph_defeat_this_blind_1"),
                scale: 0.4,
                colour: G.C.UI.TEXT_DARK,
              },
            },
          ...
          nodes: [
            {
              n: G.UIT.T,
              config: {
                text: localize("ph_defeat_this_blind_2"),
                scale: 0.4,
                colour: G.C.UI.TEXT_DARK,
              },
            },
    ...
    nodes: [
      {
        ...
        config: {
          ...
          minw: 2.5,
          padding: 0.1,
          colour: (!discovered && G.C.JOKER_GREY) || blind.boss_colour || G.C.GREY,
        },
        nodes: [
          {
            n: G.UIT.O,
            config: {
              object: DynaText({
                string: (discovered && loc_name) || localize("k_not_discovered"),
                colours: [G.C.UI.TEXT_LIGHT],
                shadow: true,
                rotate: !discovered,
                spacing: (discovered && 2) || 0,
                bump: true,
                scale: 0.4,
              }),
            },
...
function create_UIBox_card_unlock(card_center): void {
  ...
  let locked_card = Card(
    G.your_collection.T.x + G.your_collection.T.w / 2 - G.CARD_W / 2,
    G.your_collection.T.y,
    G.CARD_W,
    G.CARD_H,
    G.P_CARDS.empty,
    (card_center.set === "Voucher" && G.v_locked) || G.j_locked
  );
            ...
            nodes: [
                    ...
                    nodes: [
                      {
                        ...
                        config: {
                          object: DynaText({
                            string: [
                              (card_center.set === "Voucher" && localize("k_voucher")) ||
                                localize("k_joker"),
                            ],
                            colours: [G.C.BLUE],
                            shadow: true,
              ...
              },
              {
                ...
                nodes: [
                  {
                    n: G.UIT.R,
                    config: { align: "cm", padding: 0.05, emboss: 0.05, colour: G.C.WHITE, r: 0.1 },
                    nodes: [desc_from_rows(card.generate_UIBox_unlock_table(true).main)],
                  },
                ],
              },
            ],
...
function create_UIBox_deck_unlock(deck_center): void {
  ...
  if (deck_center.unlock_condition.type === "win_deck") {
    let other_name = localize({
      type: "name_text",
      set: "Back",
      key: deck_center.unlock_condition.deck,
    });
    localize({
      type: "descriptions",
      key: "deck_locked_win",
    ...
    let other_name = localize({
      type: "name_text",
      set: "Stake",
      key: G.P_CENTER_POOLS.Stake[deck_center.unlock_condition.stake].key,
    });
    localize({
      type: "descriptions",
      ...
      set: "Other",
      nodes: deck_criteria,
      vars: { [1]: other_name, colours: [get_stake_col(deck_center.unlock_condition.stake)] },
      default_col: G.C.WHITE,
      shadow: true,
    });
  ...
  for (const [k, v] of ipairs(deck_criteria)) {
    if (k > 1) {
      deck_criteria_cols[deck_criteria_cols.length + 1] = {
        n: G.UIT.C,
        config: { align: "cm", padding: 0, minw: 0.1 },
        nodes: {},
      };
    }
    deck_criteria_cols[deck_criteria_cols.length + 1] = {
    ...
    contents: [
        ...
        nodes: [
          {
            ...
            config: {
              object: DynaText({
                string: [
                  {
                    string: localize({ type: "name_text", set: "Back", key: deck_center.key }),
                    suffix: " " + localize("k_unlocked_ex"),
      ...
      { n: G.UIT.R, config: { align: "cm", padding: 0 }, nodes: deck_criteria_cols },
      {
        ...
        nodes: [
          ...
          {
            n: G.UIT.C,
            config: { align: "cm", r: 0.2, colour: G.C.WHITE, emboss: 0.05, padding: 0.2, minw: 4 },
            nodes: [
              {
                n: G.UIT.R,
                config: { align: "cm", padding: 0 },
...
G.UIDEF.multiline_credit_text = function (_lines) {
  ...
  for (const [k, v] of ipairs(_lines)) {
    t[t.length + 1] = {
      ...
      nodes: [{ n: G.UIT.T, config: { text: v, scale: 0.28, colour: G.C.WHITE } }],
    };
  }
  return t;
};
G.UIDEF.viewed_collab_option = function (_new_option) {
  ...
  let collab_sprite = new Sprite(
    0,
    0,
    0.8 * G.CARD_W,
    0.8 * G.CARD_H,
    G.ASSET_ATLAS[curr_collab.art + "_1"],
    { x: 2, y: 0 }
  );
  return {
    n: G.UIT.ROOT,
    ...
    nodes: [
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0.1 },
        nodes: [{ n: G.UIT.T, config: { text: G.viewed_collab, scale: 0.5, colour: G.C.WHITE } }],
      },
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0 },
        nodes: [
          ...
          {
            n: G.UIT.C,
            config: { align: "cm", padding: 0.1, minw: 3, minh: 4.2 },
            nodes: [
              {
                n: G.UIT.R,
                config: { align: "cm", padding: 0 },
                nodes: [
                  {
                    n: G.UIT.R,
                    config: { align: "cm", colour: G.C.WHITE, r: 0.3 },
                    nodes: [
                      {
                        n: G.UIT.O,
                        config: {
                          colour: G.C.BLUE,
                          object: collab_sprite,
                          hover: true,
                          can_collide: false,
                        },
                      },
                ...
                nodes: [
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: "Art created by:", scale: 0.3, colour: G.C.WHITE },
                      },
                    ],
                  },
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: curr_collab.artist, scale: 0.3, colour: G.C.GOLD },
                      },
                    ],
                  },
                  (curr_collab.artist_link && {
                    n: G.UIT.R,
                    config: { align: "cm", padding: 0 },
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: { text: curr_collab.artist_link, scale: 0.3, colour: G.C.BLUE },
                      },
                    ],
                  }) ||
                    undefined,
          ...
          create_tabs({
            tabs: [
                    ...
                    nodes: [
                      {
                        ...
                        nodes: [
                          ...
                          (G.F_EXTERNAL_LINKS && {
                            n: G.UIT.R,
                            config: { align: "cm", padding: 0 },
                            nodes: [UIBox_button({ label: ["Instagram"], button: "louisf_insta" })],
                          }) ||
                            undefined,
                          {
                            n: G.UIT.R,
                                    ...
                                    nodes: [
                                      {
                                        n: G.UIT.T,
                                        config: {
                                          text: "Lead Visual Marketing Manager",
                                          scale: text_scale * 0.35,
                                          colour: G.C.GOLD,
                                          shadow: true,
                                        },
                                    ...
                                    nodes: [
                                      {
                                        n: G.UIT.T,
                                        config: {
                                          text: "Senior User Acquisition Manager",
                                          scale: text_scale * 0.35,
                                          colour: G.C.GOLD,
                                          shadow: true,
                                        },
                                    ...
                                    nodes: [
                                      {
                                        n: G.UIT.T,
                                        config: {
                                          text: "Director of Publishing Services",
                                          scale: text_scale * 0.35,
                                          colour: G.C.GOLD,
                                          shadow: true,
                                        },
              ...
              },
              {
                label: "Collabs",
                tab_definition_function: function () {
                  G.collab_credits = G.collab_credits || {
                    ["Vault-Tec"]: {
                      artist: "Franek",
                      ml_text: [
                    ...
                    ["Cyberpunk 2077"]: {
                      artist: undefined,
                      ml_text: ["Cyberpunk 2077 \u00A9 2024 CD PROJEKT S.A. All rights reserved."],
                      art: "collab_CYP",
                    },
                    ["Shovel Knight"]: {
                      artist: "Neato",
                    ...
                    ["Among Us"]: {
                      artist: undefined,
                      ml_text: ["Among Us \u00A9 2024 Innersloth LLC. All Rights Reserved."],
                      art: "collab_AU",
                    },
                    ...
                    ["Cult of the Lamb"]: {
                      artist: undefined,
                      ml_text: ["Cult of the Lamb \u00A9 2024 Massive Monster All Rights Reserved"],
                      art: "collab_CL",
                    },
                    ...
                    ["Potion Craft"]: {
                      artist: undefined,
                      ml_text: ["Potion Craft \u00A9 2024 tinyBuild, LLC. All Rights Reserved."],
                      art: "collab_PC",
                    },
                    ["Warframe"]: {
                      artist: undefined,
                    ...
                    ["Dave the Diver"]: {
                      artist: undefined,
                      ml_text: ["Dave the Diver \u00A9 Mintrocket. All Rights Reserved."],
                      art: "collab_DTD",
                    },
                    ["Stardew Valley"]: {
                      artist: "ConcernedApe",
                    ...
                    ["1000xRESIST"]: { artist: undefined, ml_text: undefined, art: "collab_XR" },
                    ["Civilization VII"]: {
                      artist: undefined,
                      ml_text: [
                    ...
                    ["Rust"]: {
                      artist: undefined,
                      ml_text: ["Rust (c) 2025 Facepunch Studios Ltd. All Rights Reserved."],
                      art: "collab_R",
                    },
                  };
                  let middle = {
                    ...
                    nodes: [
                      {
                        n: G.UIT.O,
                        config: { id: undefined, func: "CREDITS_check_collab", object: Moveable() },
                      },
                    ],
                  };
                  let collab_options = {};
                            ...
                            nodes: [
                              {
                                n: G.UIT.T,
                                config: {
                                  text: "The Collab art for Slay the Spire and The Binding of Isaac was",
                                  scale: text_scale * 0.5,
                                  colour: G.C.UI.TEXT_LIGHT,
                                  shadow: true,
                                },
...
G.UIDEF.challenges = function (from_game_over) {
  ...
  if (!G.PROFILES[G.SETTINGS.profile].challenges_unlocked) {
    ...
    return {
      ...
      nodes: [transparent_multiline_text(loc_nodes)],
    };
  }
    ...
    nodes: [
      {
        ...
        nodes: [
            ...
            nodes: [
              {
                n: G.UIT.T,
                config: {
                  text: localize("k_challenge_mode"),
                  scale: 0.4,
                  colour: G.C.UI.TEXT_LIGHT,
                  shadow: true,
                },
          ...
          },
          {
            ...
            nodes: [
              UIBox_button({
                id: (from_game_over && "from_game_over") || undefined,
          ...
          },
          {
            ...
            config: {
              ...
              progress_bar: {
                ...
                ref_value: "comp",
                empty_col: G.C.L_BLACK,
                filled_col: adjust_alpha(G.C.GREEN, 0.5),
              },
            },
            nodes: [
              {
...
G.UIDEF.daily_overview = function () {
  ...
  let daily_results = {
    score: {
      ...
      hist: [
        0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.15, 0.1, 0.1,
      ...
      nodes: [
        {
          ...
          config: {
            colour: G.C.BLUE,
            minw: hist_width / daily_results.score.hist.length,
            ...
            tabs: [
              {
                ...
                chosen: !_challenge_chosen && !_can_continue,
    ...
    nodes: [
      {
        ...
        nodes: [
          ((_profile === G.SETTINGS.profile || !profile_data) && {
            n: G.UIT.R,
            config: { align: "cm" },
            nodes: [
              create_text_input({
            ...
            n: G.UIT.R,
            config: { align: "cm", padding: 0.1, minw: 4, r: 0.1, colour: G.C.BLACK, minh: 0.6 },
            nodes: [
              {
                n: G.UIT.T,
                config: { text: G.PROFILES[_profile].name, scale: 0.45, colour: G.C.WHITE },
              },
            ],
          },
        ],
        ...
        nodes: [
          {
            ...
            nodes: [
              (G.PROFILES[_profile].progress &&
                G.PROFILES[_profile].progress.discovered &&
                create_progress_box(G.PROFILES[_profile].progress, 0.5)) || {
                n: G.UIT.C,
                config: { align: "cm", minh: 4, minw: 5.2, colour: G.C.BLACK, r: 0.1 },
                nodes: [
                  {
                    n: G.UIT.T,
                    config: {
                      text: localize("k_empty_caps"),
                      scale: 0.5,
                      colour: G.C.UI.TRANSPARENT_LIGHT,
                    },
                  },
                    ...
                    nodes: [
                      ...
                      },
                      {
                        ...
                        nodes: [
                          {
                            n: G.UIT.T,
                            config: { text: ": ", colour: G.C.UI.TEXT_LIGHT, scale: scale * 0.7 },
                          },
                        ],
                      },
                      {
              ...
              },
              {
                ...
                nodes: [
                        ...
                        nodes: [
                          {
                            ...
                            config: {
                              text:
                                (_profile === G.SETTINGS.profile &&
                                  localize("b_current_profile")) ||
                                (profile_data && localize("b_load_profile")) ||
                                localize("b_create_profile"),
                        ...
                        nodes: [
                          {
                            ...
                            config: {
                              text:
                                (_profile === G.SETTINGS.profile && localize("b_reset_profile")) ||
                  ...
                  (_profile === G.SETTINGS.profile &&
                    ...
                    nodes: [
                      (G.PROFILES[_profile].all_unlocked &&
                        ((!G.F_NO_ACHIEVEMENTS && {
                          n: G.UIT.T,
                          config: {
                            text: localize(
                              (G.F_TROPHIES && "k_trophies_disabled") || "k_achievements_disabled"
                            ),
                            scale: 0.3,
                            colour: G.C.UI.TEXT_LIGHT,
                          },
        ...
        nodes: [
          {
            n: G.UIT.T,
            config: {
              text: localize({ type: "name_text", key: _stake_center.key, set: _stake_center.set }),
              scale: 0.35,
              colour: G.C.WHITE,
            },
          },
...
G.UIDEF.stake_option = function (_type) {
  let middle = {
    ...
    nodes: [
      { n: G.UIT.O, config: { id: undefined, func: "RUN_SETUP_check_stake2", object: Moveable() } },
    ],
  };
    ...
    nodes: [
      {
        ...
        nodes: [
          {
            n: G.UIT.T,
            config: { text: localize("k_stake"), scale: 0.4, colour: G.C.L_BLACK, vert: true },
          },
        ],
      },
      {
...
G.UIDEF.challenge_list = function (from_game_over) {
  ...
  for (let i = 1; i <= math.ceil(G.CHALLENGES.length / G.CHALLENGE_PAGE_SIZE); i++) {
    table.insert(
      ...
      localize("k_page") +
        (" " +
          (tostring(i) + ("/" + tostring(math.ceil(G.CHALLENGES.length / G.CHALLENGE_PAGE_SIZE)))))
    );
  }
  G.E_MANAGER.add_event(
    new GameEvent({
  ...
  let t = create_UIBox_generic_options({
    back_id: (from_game_over && "from_game_over") || undefined,
    back_func: "setup_run",
    ...
    contents: [
        ...
        nodes: [
          {
            ...
            nodes: [{ n: G.UIT.O, config: { id: "challenge_list", object: Moveable() } }],
          },
          {
            n: G.UIT.R,
            config: { align: "cm", padding: 0.1 },
      ...
      },
      {
        ...
        nodes: [{ n: G.UIT.O, config: { id: "challenge_area", object: Moveable() } }],
      },
    ],
  });
  return t;
...
G.UIDEF.challenge_list_page = function (_page) {
  ...
  for (const [k, v] of ipairs(G.CHALLENGES)) {
    if (
      k > G.CHALLENGE_PAGE_SIZE * (_page || 0) &&
      k <= G.CHALLENGE_PAGE_SIZE * ((_page || 0) + 1)
    ) {
      if (
        G.CONTROLLER.focused.target &&
        G.CONTROLLER.focused.target.config.id === "challenge_page"
      ) {
        snapped = true;
      }
      let challenge_completed =
        G.PROFILES[G.SETTINGS.profile].challenge_progress.completed[v.id || ""];
      let challenge_unlocked =
        G.PROFILES[G.SETTINGS.profile].challenges_unlocked &&
        ...
        nodes: [
          {
            ...
            nodes: [{ n: G.UIT.T, config: { text: k + "", scale: 0.4, colour: G.C.WHITE } }],
          },
          UIBox_button({
            id: k,
            col: true,
            label: [
              (challenge_unlocked && localize(v.id, "challenge_names")) || localize("k_locked"),
            ],
            button: (challenge_unlocked && "change_challenge_description") || "nil",
            colour: (challenge_unlocked && G.C.RED) || G.C.GREY,
            minw: 4,
            scale: 0.4,
            minh: 0.6,
            focus_args: { snap_to: !snapped },
          }),
          {
            n: G.UIT.C,
            ...
            nodes: [
              {
                ...
                config: {
                  ...
                  emboss: 0.05,
                  r: 0.1,
                  colour: (challenge_completed && G.C.GREEN) || G.C.BLACK,
                },
                nodes: [
                  (challenge_completed && {
                    n: G.UIT.O,
                    config: {
                      object: new Sprite(0, 0, 0.4, 0.4, G.ASSET_ATLAS["icons"], { x: 1, y: 0 }),
                    },
                  }) ||
                    undefined,
                ],
...
G.UIDEF.challenge_description = function (_id, daily, is_row) {
  ...
  if (!challenge) {
    return {
      ...
      nodes: [
        {
          n: G.UIT.T,
          config: { text: localize("ph_select_challenge"), scale: 0.3, colour: G.C.UI.TEXT_LIGHT },
        },
      ],
    };
  }
  let joker_size = 0.6;
  let jokers = CardArea(0, 0, 10 * joker_size, 0.6 * G.CARD_H, {
    card_limit: get_challenge_rule(challenge, "modifiers", "joker_limit") || 5,
  ...
  let joker_col = {
    n: G.UIT.C,
    config: { align: "cm", padding: 0.05, colour: G.C.L_BLACK, r: 0.1, maxh: 1.8 },
    nodes: [
      {
        n: G.UIT.T,
        config: {
          text: localize("k_jokers_cap"),
          scale: 0.5,
          colour: G.C.UI.TEXT_LIGHT,
          vert: true,
          shadow: true,
      ...
      },
      {
        ...
        nodes: [
          (jokers && { n: G.UIT.O, config: { object: jokers } }) || {
            n: G.UIT.T,
            config: { text: localize("k_none"), scale: 0.5, colour: G.C.UI.TEXT_LIGHT },
          },
        ],
      },
    ],
  };
  let consumeables = CardArea(0, 0, 3 * joker_size, 0.6 * G.CARD_H, {
    card_limit: get_challenge_rule(challenge, "modifiers", "consumable_limit") || 2,
    card_w: joker_size * G.CARD_W,
    type: "title_2",
    spread: true,
    highlight_limit: 0,
  ...
  let consumable_col = {
    ...
    nodes: [
      ...
      },
      {
        ...
        nodes: [
          (consumeables && { n: G.UIT.O, config: { object: consumeables } }) || {
            n: G.UIT.T,
            config: { text: localize("k_none"), scale: 0.5, colour: G.C.UI.TEXT_LIGHT },
          },
        ],
  ...
  let vouchers = CardArea(0, 0, 3 * joker_size, 0.6 * G.CARD_H, {
  ...
  let voucher_col = {
    ...
    nodes: [
      ...
      },
      {
        ...
        config: { align: "cm", minh: 0.6 * G.CARD_H, r: 0.1, colour: G.C.UI.TRANSPARENT_DARK },
        nodes: [
          (vouchers && { n: G.UIT.O, config: { object: vouchers } }) || {
            n: G.UIT.T,
            config: { text: localize("k_none"), scale: 0.5, colour: G.C.UI.TEXT_LIGHT },
          },
        ],
  ...
  return {
    n: (is_row && G.UIT.R) || G.UIT.ROOT,
    config: { align: "cm", r: 0.1, colour: G.C.BLACK },
    nodes: [
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0.1 },
        nodes: [joker_col, consumable_col, voucher_col],
      },
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0 },
  ...
  if (args._tab === "Rules") {
    ...
    if (challenge.rules) {
      if (challenge.rules.modifiers) {
        for (const [k, v] of ipairs(challenge.rules.modifiers)) {
          base_modifiers[v.id] = {
            value: v.value,
            order: (base_modifiers[v.id] && base_modifiers[v.id].order) || bonus_mods,
            custom: true,
            old_val: base_modifiers[v.id].value,
          };
      ...
      if (v.old_val) {
        ...
        start_rules[start_rules.length + 1] = {
          ...
          nodes: localize({
            ...
            key: "ch_m_" + v.key,
            vars: [v.value],
            default_col: (!v.custom && G.C.UI.TEXT_INACTIVE) || undefined,
          }),
        };
      }
    }
      ...
      if (challenge.rules.custom) {
        for (const [k, v] of ipairs(challenge.rules.custom)) {
          game_rules[game_rules.length + 1] = {
            n: G.UIT.R,
            config: { align: "cl" },
            nodes: localize({ type: "text", key: "ch_c_" + v.id, vars: [v.value] }),
          };
        }
      }
    }
    if (!start_rules[1] && !modded_starts) {
      start_rules[start_rules.length + 1] = {
        n: G.UIT.R,
        config: { align: "cl" },
        nodes: localize({ type: "text", key: "ch_m_none", vars: {} }),
      };
    }
    if (!game_rules[1]) {
      game_rules[game_rules.length + 1] = {
        n: G.UIT.R,
        config: { align: "cl" },
        nodes: localize({ type: "text", key: "ch_c_none", vars: {} }),
      };
    }
    let starting_rule_list = {
      n: G.UIT.C,
      ...
      nodes: [
          ...
          nodes: [
            {
              n: G.UIT.T,
              config: {
                text: localize("k_game_modifiers"),
                scale: 0.4,
                colour: G.C.UI.TEXT_LIGHT,
                shadow: true,
              },
        ...
        {
          n: G.UIT.R,
          config: { align: "cm", minh: 4.1, minw: 4.2, padding: 0.05, r: 0.1, colour: G.C.WHITE },
          nodes: start_rules,
        },
      ],
    };
    let override_rule_list = {
      n: G.UIT.C,
      config: { align: "cm", minw: 3, r: 0.1, colour: G.C.BLUE },
      nodes: [
        {
    ...
    return {
      ...
      nodes: [
        {
          n: G.UIT.C,
          config: { align: "cm", padding: 0.1, colour: G.C.L_BLACK, r: 0.1, minw: 3 },
    ...
    if (challenge.restrictions) {
      if (challenge.restrictions.banned_cards) {
        ...
        let n_rows = math.max(
          1,
          math.floor(challenge.restrictions.banned_cards.length / 10) +
            2 -
            math.floor(math.log(6, challenge.restrictions.banned_cards.length))
        );
        let max_width = 1;
        for (const [k, v] of ipairs(challenge.restrictions.banned_cards)) {
          let _row = math.floor(
            ((k - 1) * n_rows) / challenge.restrictions.banned_cards.length + 1
          );
        ...
        for (const [_, row_card] of ipairs(row_cards)) {
          let banned_card_area = CardArea(0, 0, 6.7, 3.3 / n_rows, {
            card_limit: undefined,
            type: "title_2",
            view_deck: true,
            highlight_limit: 0,
          ...
          table.insert(banned_cards, {
            n: G.UIT.R,
            config: { align: "cm", padding: 0 },
            nodes: [{ n: G.UIT.O, config: { object: banned_card_area } }],
          });
      ...
      if (challenge.restrictions.banned_tags) {
        ...
        for (const [k, v] of ipairs(tag_tab)) {
          ...
          let temp_tag_ui = temp_tag.generate_UI(
            1.1 - 0.25 * math.sqrt(challenge.restrictions.banned_tags.length)
          );
      ...
      if (challenge.restrictions.banned_other) {
        ...
        for (const [k, v] of ipairs(other_tab)) {
          let temp_blind = new AnimatedSprite(
            ...
            1,
            1,
            G.ANIMATION_ATLAS[v.atlas || ""] || G.ANIMATION_ATLAS["blind_chips"],
            v.pos
          );
          temp_blind.define_draw_steps([
            { shader: "dissolve", shadow_height: 0.05 },
          ...
          table.insert(banned_other, {
            n: G.UIT.R,
            config: { align: "cm", padding: 0 },
            nodes: [{ n: G.UIT.O, config: { object: temp_blind } }],
          });
        }
      }
    }
    ...
    let banned_cards = {
      ...
      nodes: [
        ...
        {
          n: G.UIT.R,
          config: { align: "cm", minh: 4.1, minw: 7.33, padding: 0.05, r: 0.1, colour: G.C.WHITE },
          nodes: banned_cards,
        },
      ],
    };
    let banned_tags = {
      ...
      nodes: [
        ...
        {
          n: G.UIT.R,
          config: { align: "cm", minh: 4.1, minw: 1.48, padding: 0.05, r: 0.1, colour: G.C.WHITE },
          nodes: banned_tags,
        },
      ],
    };
    let banned_other = {
      ...
      nodes: [
        ...
        {
          n: G.UIT.R,
          config: { align: "cm", minh: 4.1, minw: 2, padding: 0.05, r: 0.1, colour: G.C.WHITE },
          nodes: banned_other,
        },
      ],
    };
      ...
      nodes: [
        {
          ...
          nodes: [banned_cards, banned_tags, banned_other],
        },
      ],
    };
    ...
    if (!card_protos) {
      ...
      for (const [k, v] of pairs(G.P_CARDS)) {
        ...
        if (
          type(SMODS.Ranks[v.value].in_pool) === "function" &&
          !SMODS.Ranks[v.value].in_pool({ initial_deck: true, suit: v.suit })
        ) {
          keep = false;
        }
        if (
          type(SMODS.Suits[v.suit].in_pool) === "function" &&
          !SMODS.Suits[v.suit].in_pool({ initial_deck: true, rank: v.value })
        ) {
          keep = false;
        }
        if (_de) {
    ...
    for (let j = 1; j <= suit_map.length; j++) {
      if (SUITS[suit_map[j]][1]) {
        ...
        let view_deck = CardArea(
          ...
          0,
          5.5 * G.CARD_W,
          (0.42 - ((num_suits <= 4 && 0) || (num_suits >= 8 && 0.28) || 0.07 * (num_suits - 4))) *
            G.CARD_H,
          {
            card_limit: SUITS[suit_map[j]].length,
            type: "title_2",
...
G.UIDEF.run_setup_option = function (type) {
  ...
  let area = CardArea(G.ROOM.T.x + (0.2 * G.ROOM.T.w) / 2, G.ROOM.T.h, G.CARD_W, G.CARD_H, {
    card_limit: 5,
    type: "deck",
    highlight_limit: 0,
    deck_height: 0.75,
    ...
    nodes: [
        ...
        nodes: [
          {
            ...
            nodes: [
              {
                n: G.UIT.C,
                config: { align: "cm", colour: G.C.BLACK, padding: 0.15, r: 0.1, emboss: 0.05 },
                nodes: [
                  {
                    n: G.UIT.C,
                    config: { align: "cm" },
                  ...
                  },
                  {
                    ...
                    nodes: [
                      {
                        n: G.UIT.R,
                        config: { align: "cm", r: 0.1, minw: 4, maxw: 4, minh: 0.6 },
                        nodes: [
                          {
                            n: G.UIT.O,
                            config: {
                                ...
                                nodes: [
                                  {
                                    n: G.UIT.T,
                                    config: {
                                      text: number_format(saved_game.GAME.round_scores.hand.amt),
                                      colour: G.C.RED,
                                      scale: scale_number(
                                        saved_game.GAME.round_scores.hand.amt,
                                        0.8 * scale,
                                        100000000000
                                      ),
                                    },
                    ...
                    nodes: [
                      {
                        ...
                        config: {
                          ...
                          object: new UIBox({
                            definition: G.UIDEF.deck_stake_column(
                              G.GAME.viewed_back.effect.center.key
                            ),
                            config: { offset: { x: 0, y: 0 } },
                          }),
                        },
              ...
              nodes: [
                {
                  ...
                  nodes: [
                    ...
                    {
                      n: G.UIT.C,
                      config: { align: "cm", minh: 1.7, r: 0.1, colour: G.C.L_BLACK, padding: 0.1 },
                      nodes: [
                        {
                          n: G.UIT.R,
                          config: { align: "cm", r: 0.1, minw: 4, maxw: 4, minh: 0.6 },
      ...
      },
      {
        ...
        nodes: [
          {
            n: G.UIT.O,
            config: { align: "cm", func: "toggle_seeded_run", object: Moveable() },
            nodes: {},
          },
        ],
      },
...
function create_button_binding_pip(args): void {
  let button_sprite_map = {
    ["a"]: (G.F_SWAP_AB_PIPS && 1) || 0,
    ["b"]: (G.F_SWAP_AB_PIPS && 0) || 1,
    ["x"]: 2,
    ["y"]: 3,
    ["leftshoulder"]: 4,
    ["rightshoulder"]: 5,
  ...
  return {
    n: G.UIT.ROOT,
    config: { align: "cm", colour: G.C.CLEAR },
    nodes: [{ n: G.UIT.O, config: { object: BUTTON_SPRITE } }],
  };
}
  ...
  if (G.F_DISP_USERNAME) {
    for (const [_, c] of utf8.chars(G.F_DISP_USERNAME)) {
      ...
      letters[letters.length + 1] = {
        n: G.UIT.T,
        config: {
          lang: G.LANGUAGES[(leng && "all1") || "all2"],
          text: _char,
          scale: 0.3,
          colour: mix_colours(G.C.GREEN, G.C.WHITE, 0.7),
          shadow: true,
        },
      };
    }
            ...
            nodes: [
              {
                ...
                config: {
                  ...
                  r: 0.1,
                  hover: true,
                  colour: mix_colours(G.C.WHITE, G.C.GREY, 0.2),
        ...
        nodes: [
          {
            ...
            nodes: [
              UIBox_button({
                id: "main_menu_play",
                button: (!G.SETTINGS.tutorial_complete && "start_run") || "setup_run",
                colour: G.C.BLUE,
                minw: 3.65,
                minh: 1.55,
              ...
              }),
              {
                ...
                nodes: [
                  UIBox_button({
                    ...
                    minw: 2.65,
                    minh: 1.35,
                    label: [localize("b_options_cap")],
                    scale: text_scale * 1.2,
                    col: true,
                  }),
                  (G.F_QUIT_BUTTON && {
                    n: G.UIT.C,
                    config: { align: "cm", minw: 0.2 },
                    nodes: {},
                  }) ||
                    undefined,
                  (G.F_QUIT_BUTTON &&
    ...
    if (!G.F_HIDE_BETA_LANGS || !v.beta) {
      _row[_row.length + 1] = {
        ...
        config: {
          ...
          minh: 0.7,
          minw: 4.5,
          button: (v.beta && "warn_lang") || "change_lang",
          ref_table: v,
          colour: (v.beta && G.C.RED) || G.C.BLUE,
          hover: true,
          shadow: true,
        ...
        nodes: [
          {
            ...
            config: {
              ...
              minh: 0.8,
              hover: true,
              colour: mix_colours(G.C.GREEN, G.C.GREY, 0.4),
              button: "loc_survey",
              shadow: true,
            },
            nodes: [
...
function create_UIBox_generic_options(args): void {
        ...
        func: function () {
          if (G.OVERLAY_MENU) {
            ...
            if (_infotip_object) {
              ...
              _infotip_object.config.object = new UIBox({
  ...
  return {
    ...
    config: {
      ...
      padding: 0.1,
      r: 0.1,
      colour: args.bg_colour || [G.C.GREY[1], G.C.GREY[2], G.C.GREY[3], 0.7],
    },
    nodes: [
      {
        n: G.UIT.R,
        config: {
          ...
          padding: 0.07,
          minw: 1,
          colour: args.outline_colour || G.C.JOKER_GREY,
          emboss: 0.1,
        },
        nodes: [
          {
            ...
            config: {
              ...
              padding: 0.2,
              minw: 1,
              colour: args.colour || G.C.L_BLACK,
            },
            nodes: [
              {
                n: G.UIT.R,
                config: { align: "cm", padding: args.padding || 0.2, minw: args.minw || 7 },
                nodes: contents,
              },
              (!args.no_back && {
                n: G.UIT.R,
                config: {
                  id: args.back_id || "overlay_menu_back_button",
                  align: "cm",
                  minw: 2.5,
                  ...
                  r: 0.1,
                  hover: true,
                  colour: args.back_colour || G.C.ORANGE,
                  button: back_func,
                  shadow: true,
                    ...
                    nodes: [
                      {
                        n: G.UIT.T,
                        config: {
                          id: args.back_id || undefined,
                          text: args.back_label || localize("b_back"),
                          scale: 0.5,
                          colour: G.C.UI.TEXT_LIGHT,
                          shadow: true,
                          func: (!args.no_pip && "set_button_pip") || undefined,
                          focus_args:
                            (!args.no_pip && { button: args.back_button || "b" }) || undefined,
                        },
                      },
                    ],
                  },
      ...
      },
      {
        n: G.UIT.R,
        config: { align: "cm" },
        nodes: [{ n: G.UIT.O, config: { id: "overlay_menu_infotip", object: Moveable() } }],
      },
    ],
  };
}
function UIBox_dyn_container(
  inner_table,
  horizontal,
  colour_override,
  background_override,
  ...
  return {
    ...
    nodes: [
      {
        n: G.UIT.R,
        config: { align: "cm", padding: 0.05, colour: colour_override || G.C.DYN_UI.MAIN, r: 0.1 },
        nodes: [
          {
            n: G.UIT.R,
            config: {
              align: (horizontal && "cl") || (flipped && "bm") || "tm",
              colour: background_override || G.C.DYN_UI.BOSS_DARK,
              minw: (horizontal && 100) || 0,
              minh: (horizontal && 0) || 30,
              r: 0.1,
...
function simple_text_container(_loc, args): void {
  ...
  if (loc_result && type(loc_result) === "table") {
        ...
        nodes: [
          {
            ...
            config: {
              text: v,
              scale: args.scale || 0.35,
              colour: args.colour || G.C.UI.TEXT_DARK,
              shadow: args.shadow,
            },
          },
        ],
    ...
    return {
      n: (args.col && G.UIT.C) || G.UIT.R,
      config: { align: "cm", padding: args.padding || 0.03 },
      nodes: container,
    };
  }
}
      ...
      nodes: [
        {
          ...
          config: {
            ...
            shadow: args.shadow,
            focus_args: (button_pip && args.focus_args) || undefined,
            func: button_pip,
            ref_table: args.ref_table,
          },
        },
    ...
    nodes: [
      {
        ...
        config: {
          ...
          button: (args.button !== "nil" && args.button) || undefined,
          choice: args.choice,
          chosen: args.chosen,
          focus_args: args.focus_args,
          minh: args.minh - 0.3 * ((args.count && 1) || 0),
          shadow: true,
          func: args.func,
          id: args.id,
