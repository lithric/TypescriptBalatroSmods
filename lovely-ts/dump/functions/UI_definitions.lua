LOVELY_INTEGRITY = '591f5d9b6bee4486f1d4cde02ebfe4aeca4688cd1203e50c605f4c5ffbe2f211'
          ...
          args.AT = UIBox{
            ...
            definition = 
              {n=G.UIT.ROOT, config = {align = args.cover_align or 'cm', minw = (args.cover and args.cover.T.w or 0.001) + (args.cover_padding or 0), minh = (args.cover and args.cover.T.h or 0.001) + (args.cover_padding or 0), padding = 0.03, r = 0.1, emboss = args.emboss, colour = args.cover_colour}, nodes={
                {n=G.UIT.O, config={draw_layer = 1, object = DynaText({
                        scale = args.scale,
                        string = args.text,
                        maxw = args.maxw,
                        colours = { args.colour },
...
function create_UIBox_deck_unlock(deck_center)
  ...
  elseif deck_center.unlock_condition.type == 'win_stake' then
    ...
    localize{type = 'descriptions', key = 'deck_locked_stake', set = "Other", nodes = deck_criteria, vars = {
        [1] = other_name, colours = {get_stake_col(deck_center.unlock_condition.stake)}}, default_col = G.C.WHITE, shadow = true}
