LOVELY_INTEGRITY = '97f0c54fe6318c01091d1a71ab04dee842386687e75849d46bfd6f5036a09796'
...
function Card:generate_UIBox_ability_table(vars_only)
    ...
    elseif self.ability.set == 'Joker' then -- all remaining jokers
        ...
        elseif self.ability.name == 'The Idol' then loc_vars = {[1] = self.ability.extra, [2] = localize(G.GAME.current_round.idol_card.rank, 'ranks'), [3] = localize(G.GAME.current_round.idol_card.suit, 'suits_plural'), colours = {G.C.SUITS[G.GAME.current_round.idol_card.suit]}}
        ...
        elseif self.ability.name == 'Ancient Joker' then loc_vars = {[1] = self.ability.extra,[2] = localize(G.GAME.current_round.ancient_card.suit, 'suits_singular'), colours = {G.C.SUITS[G.GAME.current_round.ancient_card.suit]}}
        ...
        elseif self.ability.name == 'Castle' then loc_vars = {[1] = self.ability.extra.chip_mod,[2] = localize(G.GAME.current_round.castle_card.suit, 'suits_singular'),[3] = self.ability.extra.chips, colours = {G.C.SUITS[G.GAME.current_round.castle_card.suit]}}
