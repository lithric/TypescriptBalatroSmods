...
class Card extends Moveable {
  ...
  update_alert() {
    if (
      this.ability.set === "Default" &&
      this.config.center &&
      this.config.center.key === "c_base" &&
      this.seal
    ) {
      if (G.P_SEALS[this.seal].alerted && this.children.alert) {
        ...
        !G.P_SEALS[this.seal].alerted &&
        !this.children.alert &&
        G.P_SEALS[this.seal].discovered
      ) {
        this.children.alert = new UIBox({
          definition: create_UIBox_card_alert(),
          config: { align: "tli", offset: { x: 0.1, y: 0.1 }, parent: this },
        });
      }
    }
    if (
      this.ability.set === "Joker" ||
      this.ability.set === "Voucher" ||
      this.ability.consumeable ||
      this.ability.set === "Edition" ||
      this.ability.set === "Booster"
    ) {
      if (this.area && this.area.config.collection && this.config.center) {
        if (this.config.center.alerted && this.children.alert) {
          ...
          !this.config.center.alerted &&
          !this.children.alert &&
          this.config.center.discovered
        ) {
          this.children.alert = new UIBox({
            definition: create_UIBox_card_alert(),
            config: {
              align:
                (this.ability.set === "Voucher" && this.config.center.order % 2 === 1 && "tli") ||
                "tri",
              offset: {
                x:
                  (this.ability.set === "Voucher" && this.config.center.order % 2 === 1 && 0.1) ||
                  -0.1,
                y: 0.1,
              },
              parent: this,
  ...
  set_base(card, initial) {
    ...
    this.base = {
      ...
      suit: this.config.card.suit,
      value: this.config.card.value,
      nominal: 0,
      suit_nominal: 0,
      face_nominal: 0,
      colour: G.C.SUITS[this.config.card.suit],
      times_played: 0,
    };
    ...
    if (_center) {
      if (_center.set) {
        if (this.children.center) {
          this.children.center.atlas =
            G.ASSET_ATLAS[
              _center.atlas ||
                ((_center.set === "Joker" || _center.consumeable || _center.set === "Voucher") &&
                  _center.set) ||
                "centers"
            ];
          ...
          if (
            _center.set === "Joker" &&
            !_center.unlocked &&
            !this.params.bypass_discovery_center
          ) {
            this.children.center = Sprite(
              this.T.x,
              this.T.y,
              this.T.w,
              this.T.h,
            ...
            this.config.center.set === "Voucher" &&
            !this.config.center.unlocked &&
            !this.params.bypass_discovery_center
          ) {
            this.children.center = Sprite(
              this.T.x,
            ...
            this.children.center = Sprite(
              ...
              G.ASSET_ATLAS[
                (_center.undiscovered &&
                  (_center.undiscovered[
                    (G.SETTINGS.colourblind_option && "hc_atlas") || "lc_atlas"
                  ] ||
                    _center.undiscovered.atlas)) ||
                  (SMODS.UndiscoveredSprites[_center.set] &&
                    (SMODS.UndiscoveredSprites[_center.set][
                      (G.SETTINGS.colourblind_option && "hc_atlas") || "lc_atlas"
                    ] ||
              ...
              (_center.undiscovered && _center.undiscovered.pos) ||
                (SMODS.UndiscoveredSprites[_center.set] &&
                  SMODS.UndiscoveredSprites[_center.set].pos) ||
                (_center.set === "Joker" && G.j_undiscovered.pos) ||
                (_center.set === "Edition" && G.j_undiscovered.pos) ||
                (_center.set === "Tarot" && G.t_undiscovered.pos) ||
                (_center.set === "Planet" && G.p_undiscovered.pos) ||
                (_center.set === "Spectral" && G.s_undiscovered.pos) ||
                (_center.set === "Voucher" && G.v_undiscovered.pos) ||
                (_center.set === "Booster" && G.booster_undiscovered.pos) ||
            ...
            this.children.center = Sprite(
              ...
              this.T.h,
              G.ASSET_ATLAS[
                _center[(G.SETTINGS.colourblind_option && "hc_atlas") || "lc_atlas"] ||
                  _center.atlas ||
                  _center.set
              ],
            ...
            this.children.center = Sprite(
              ...
              this.T.w,
              this.T.h,
              G.ASSET_ATLAS[_center.atlas || "centers"],
              _center.pos
            );
          }
        ...
        if (
          _center.name === "Square Joker" &&
          (_center.discovered || this.bypass_discovery_center)
        ) {
          this.children.center.scale.y = this.children.center.scale.x;
        }
        if (
          _center.pixel_size &&
          _center.pixel_size.h &&
          (_center.discovered || this.bypass_discovery_center)
        ) {
          ...
          G.ASSET_ATLAS[
            ((G.GAME.viewed_back || G.GAME.selected_back) &&
              ((G.GAME.viewed_back || G.GAME.selected_back)[
                ...
                (G.GAME.viewed_back || G.GAME.selected_back).atlas)) ||
              "centers"
          ],
          this.params.bypass_back ||
            (this.playing_card && G.GAME[this.back].pos) ||
            G.P_CENTERS["b_red"].pos
        );
  ...
  set_ability(center, initial, delay_sprites) {
    ...
    if (
      center.display_size &&
      center.display_size.h &&
      (center.discovered || this.bypass_discovery_center)
    ) {
    ...
    let new_ability = {
      ...
      extra: copy_table(center.config.extra) || undefined,
      extra_value: 0,
      type: center.config.type || "",
      order: center.order || undefined,
      forced_selection: (this.ability && this.ability.forced_selection) || undefined,
      perma_bonus: (this.ability && this.ability.perma_bonus) || 0,
    };
    ...
    if (this.ability.name === "To Do List") {
      ...
      while (!this.ability.to_do_poker_hand) {
        this.ability.to_do_poker_hand = pseudorandom_element(
          _poker_hands,
          pseudoseed((this.area && this.area.config.type === "title" && "false_to_do") || "to_do")
        );
  ...
  set_cost() {
    ...
    this.cost = math.max(
      1,
      math.floor(((this.base_cost + this.extra_cost + 0.5) * (100 - G.GAME.discount_percent)) / 100)
    );
    ...
    if (
      this.ability.set === "Booster" &&
      !G.SETTINGS.tutorial_complete &&
      G.SETTINGS.tutorial_progress &&
      !G.SETTINGS.tutorial_progress.completed_parts["shop_1"]
    ) {
      this.cost = this.cost + 3;
    }
    if (
      (this.ability.set === "Planet" ||
        (this.ability.set === "Booster" && this.ability.name.find("Celestial"))) &&
      find_joker("Astronomer").length > 0
    ) {
      this.cost = 0;
    }
    ...
    if (
      this.area &&
      this.ability.couponed &&
      (this.area === G.shop_jokers || this.area === G.shop_booster)
    ) {
      this.cost = 0;
    }
  ...
  add_to_deck(from_debuff) {
    ...
    if (!this.added_to_deck) {
      ...
      if (
        ...
        play_sound("timpani");
        card_eval_status_text(this, "extra", undefined, undefined, undefined, {
          ...
          if (this.edition && this.edition.card_limit) {
            if (this.ability.consumeable) {
              G.consumeables.config.card_limit =
                G.consumeables.config.card_limit + this.edition.card_limit;
            } else {
  ...
  generate_UIBox_ability_table(vars_only) {
    ...
    if (
      !this.bypass_lock &&
      this.config.center.unlocked !== false &&
      (this.ability.set === "Joker" ||
        this.ability.set === "Edition" ||
        this.ability.consumeable ||
        this.ability.set === "Voucher" ||
        this.ability.set === "Booster") &&
      !this.config.center.discovered &&
      ((this.area !== G.jokers && this.area !== G.consumeables && this.area) || !this.area)
    ) {
    ...
    if (this.config.center.unlocked === false && !this.bypass_lock) {
      ...
      loc_vars = {
        debuffed: true,
        playing_card: !!this.base.colour,
        value: this.base.value,
        suit: this.base.suit,
        colour: this.base.colour,
      };
      ...
      loc_vars = {
        ...
        suit: this.base.suit,
        colour: this.base.colour,
        nominal_chips: (this.base.nominal > 0 && this.base.nominal) || undefined,
        bonus_chips:
          (this.ability.bonus + (this.ability.perma_bonus || 0) > 0 &&
            this.ability.bonus + (this.ability.perma_bonus || 0)) ||
          undefined,
      };
    } else if (this.ability.set === "Joker") {
      if (this.ability.name === "Joker") {
        ...
        this.ability.name === "Jolly Joker" ||
        this.ability.name === "Zany Joker" ||
        this.ability.name === "Mad Joker" ||
        this.ability.name === "Crazy Joker" ||
        this.ability.name === "Droll Joker"
      ) {
        loc_vars = [this.ability.t_mult, localize(this.ability.type, "poker_hands")];
      } else if (
        this.ability.name === "Sly Joker" ||
        this.ability.name === "Wily Joker" ||
        this.ability.name === "Clever Joker" ||
        this.ability.name === "Devious Joker" ||
        this.ability.name === "Crafty Joker"
      ) {
        ...
        loc_vars = [
          this.ability.extra,
          (G.GAME.consumeable_usage_total && G.GAME.consumeable_usage_total.tarot) || 0,
        ];
        ...
        this.ability.name === "Greedy Joker" ||
        this.ability.name === "Lusty Joker" ||
        this.ability.name === "Wrathful Joker" ||
        this.ability.name === "Gluttonous Joker"
      ) {
        loc_vars = [this.ability.extra.s_mult, localize(this.ability.extra.suit, "suits_singular")];
      } else if (this.ability.name === "Blue Joker") {
        loc_vars = [
          this.ability.extra,
          this.ability.extra * ((G.deck && G.deck.cards && G.deck.cards.length) || 52),
        ];
              ...
              object: new DynaText({
                string: [
                  { string: "rand()", colour: G.C.JOKER_GREY },
                  {
                    string:
                      "#@" +
                      (((G.deck && G.deck.cards[1] && G.deck.cards[G.deck.cards.length].base.id) ||
                        11) +
                        ((G.deck &&
                          G.deck.cards[1] &&
                          G.deck.cards[G.deck.cards.length].base.suit.sub(1, 1)) ||
                          "D")),
                    colour: G.C.RED,
                  },
                  loc_mult,
        ...
        loc_vars = [
          this.ability.extra.Xmult,
          this.ability.extra.every + 1,
          localize({
            type: "variable",
            key: (this.ability.loyalty_remaining === 0 && "loyalty_active") || "loyalty_inactive",
            vars: [this.ability.loyalty_remaining],
          }),
        ];
        ...
        loc_vars = [
          this.ability.extra,
          ((G.jokers && G.jokers.cards && G.jokers.cards.length) || 0) * this.ability.extra,
        ];
      } else if (this.ability.name === "Delayed Gratification") {
        loc_vars = [this.ability.extra];
      } else if (this.ability.name === "Gros Michel") {
        loc_vars = [
          this.ability.extra.mult,
          "" + ((G.GAME && G.GAME.probabilities.normal) || 1),
          this.ability.extra.odds,
        ];
        ...
        loc_vars = [
          this.ability.extra.dollars,
          localize(this.ability.to_do_poker_hand, "poker_hands"),
        ];
        ...
        loc_vars = {
          [1]: this.ability.extra,
          [2]: localize(G.GAME.current_round.idol_card.rank, "ranks"),
          [3]: localize(G.GAME.current_round.idol_card.suit, "suits_plural"),
        ...
        this.ability.name === "The Duo" ||
        this.ability.name === "The Trio" ||
        this.ability.name === "The Family" ||
        this.ability.name === "The Order" ||
        this.ability.name === "The Tribe"
      ) {
        ...
        if (has_message) {
          let disableable =
            G.GAME.blind && !G.GAME.blind.disabled && G.GAME.blind.get_type() === "Boss";
          main_end = [
            {
              n: G.UIT.C,
              config: { align: "bm", minh: 0.4 },
              nodes: [
                {
                  ...
                  config: {
                    ref_table: this,
                    align: "m",
                    colour: (disableable && G.C.GREEN) || G.C.RED,
                    r: 0.05,
                    padding: 0.06,
                  },
                  nodes: [
                    {
                      ...
                      config: {
                        text:
                          " " +
                          (localize((disableable && "k_active") || "ph_no_boss_active") + " "),
                        colour: G.C.UI.TEXT_LIGHT,
                        scale: 0.32 * 0.9,
                      },
                    },
        ...
        loc_vars = [
          ...
          math.max(
            0,
            this.ability.extra *
              ((G.playing_cards && G.GAME.starting_deck_size - G.playing_cards.length) || 0)
          ),
        ...
        loc_vars = {
          [1]: this.ability.extra,
          [2]: localize(G.GAME.current_round.ancient_card.suit, "suits_singular"),
        ...
        loc_vars = {
          [1]: this.ability.extra.chip_mod,
          [2]: localize(G.GAME.current_round.castle_card.suit, "suits_singular"),
          [3]: this.ability.extra.chips,
        ...
        loc_vars = [
          ...
          this.ability.extra.dollars,
          this.ability.extra.mult *
            math.floor((G.GAME.dollars + (G.GAME.dollar_buffer || 0)) / this.ability.extra.dollars),
        ];
        ...
        loc_vars = [
          this.ability.extra.xmult,
          this.ability.extra.discards,
          this.ability.yorick_discards,
          this.ability.x_mult,
        ];
    ...
    let badges = {};
    if (
      (card_type !== "Locked" && card_type !== "Undiscovered" && card_type !== "Default") ||
      this.debuff
    ) {
    ...
    if (this.edition) {
      if (this.edition.type === "negative" && this.ability.consumeable) {
        ...
        this.edition.type === "negative" &&
        (this.ability.set === "Enhanced" || this.ability.set === "Default")
      ) {
        badges[badges.length + 1] = "negative_playing_card";
      } else {
        badges[badges.length + 1] =
          (this.edition.type === "holo" && "holographic") || this.edition.type;
      }
    }
    if (this.seal) {
    ...
    if (
      this.sticker ||
      (this.sticker_run && this.sticker_run !== "NONE" && G.SETTINGS.run_stake_stickers)
    ) {
      loc_vars = loc_vars || {};
  ...
  get_nominal(mod) {
    ...
    if (
      this.ability.effect === "Stone Card" ||
      (this.config.center.no_suit && this.config.center.no_rank)
    ) {
      mult = -10000;
    ...
    return (
      10 * this.base.nominal * rank_mult +
      this.base.suit_nominal * mult +
      (this.base.suit_nominal_original || 0) * 0.0001 * mult +
      10 * this.base.face_nominal * rank_mult +
      0.000001 * this.unique_val
    );
  }
  get_id() {
  ...
  get_end_of_round_effect(context) {
    ...
    if (
      this.seal === "Blue" &&
      G.consumeables.cards.length + G.GAME.consumeable_buffer < G.consumeables.config.card_limit &&
      !this.ability.extra_enhancement
    ) {
  ...
  use_consumeable(area, copier) {
    ...
    if (
      this.ability.name === "Talisman" ||
      this.ability.name === "Deja Vu" ||
      this.ability.name === "Trance" ||
      this.ability.name === "Medium"
    ) {
    ...
    if (this.ability.name === "Sigil" || this.ability.name === "Ouija") {
          ...
          G.E_MANAGER.add_event(
            new GameEvent({
              func: function () {
                ...
                let rank_suffix =
                  (card.base.id < 10 && tostring(card.base.id)) ||
                  (card.base.id === 10 && "T") ||
                  (card.base.id === 11 && "J") ||
                  (card.base.id === 12 && "Q") ||
                  (card.base.id === 13 && "K") ||
      ...
      if (this.ability.name === "Ouija") {
        let _rank = pseudorandom_element(
    ...
    if (this.ability.consumeable.hand_type) {
      update_hand_text(
        { sound: "button", volume: 0.7, pitch: 0.8, delay: 0.3 },
        {
          handname: localize(this.ability.consumeable.hand_type, "poker_hands"),
          chips: G.GAME.hands[this.ability.consumeable.hand_type].chips,
          mult: G.GAME.hands[this.ability.consumeable.hand_type].mult,
          level: G.GAME.hands[this.ability.consumeable.hand_type].level,
        }
      );
    ...
    if (this.ability.consumeable.remove_card) {
      ...
      if (this.ability.name === "The Hanged Man") {
        ...
        this.ability.name === "Familiar" ||
        this.ability.name === "Grim" ||
        this.ability.name === "Incantation"
      ) {
        destroyed_cards[destroyed_cards.length + 1] = pseudorandom_element(
          G.hand.cards,
          pseudoseed("random_destroy")
        );
        G.E_MANAGER.add_event(
          new GameEvent({
            trigger: "after",
    ...
    if (this.ability.name === "The Emperor" || this.ability.name === "The High Priestess") {
      for (
        ...
        i <=
        math.min(
          this.ability.consumeable.tarots || this.ability.consumeable.planets,
          G.consumeables.config.card_limit - G.consumeables.cards.length
        );
        i++
      ) {
        G.E_MANAGER.add_event(
          new GameEvent({
            ...
            func: function () {
              if (G.consumeables.config.card_limit > G.consumeables.cards.length) {
                play_sound("timpani");
                let card = create_card(
                  (this.ability.name === "The Emperor" && "Tarot") ||
                    (this.ability.name === "The High Priestess" && "Planet"),
                  G.consumeables,
                  undefined,
                  undefined,
                  undefined,
                  undefined,
                  undefined,
                  (this.ability.name === "The Emperor" && "emp") ||
                    (this.ability.name === "The High Priestess" && "pri")
                );
                card.add_to_deck();
                G.consumeables.emplace(card);
                used_tarot.juice_up(0.3, 0.5);
        ...
        new GameEvent({
          ...
          func: function () {
            ...
            let card = create_card(
              "Joker",
              G.jokers,
              this.ability.name === "The Soul",
              undefined,
              undefined,
              undefined,
              undefined,
              (this.ability.name === "Judgement" && "jud") || "sou"
            );
            card.add_to_deck();
        ...
        new GameEvent({
          ...
          func: function () {
            let card = copy_card(
              ...
              undefined,
              undefined,
              chosen_joker.edition && chosen_joker.edition.negative
            );
    ...
    if (
      this.ability.name === "The Wheel of Fortune" ||
      this.ability.name === "Ectoplasm" ||
      this.ability.name === "Hex"
    ) {
      let temp_pool =
        (this.ability.name === "The Wheel of Fortune" && this.eligible_strength_jokers) ||
        ((this.ability.name === "Ectoplasm" || this.ability.name === "Hex") &&
          this.eligible_editionless_jokers) ||
        {};
      if (
        this.ability.name === "Ectoplasm" ||
        this.ability.name === "Hex" ||
        pseudorandom("wheel_of_fortune") < G.GAME.probabilities.normal / this.ability.extra
      ) {
        G.E_MANAGER.add_event(
          new GameEvent({
            trigger: "after",
            ...
            func: function () {
              let over = false;
              let eligible_card = pseudorandom_element(
                temp_pool,
                pseudoseed(
                  (this.ability.name === "The Wheel of Fortune" && "wheel_of_fortune") ||
                    (this.ability.name === "Ectoplasm" && "ectoplasm") ||
                    (this.ability.name === "Hex" && "hex")
                )
              );
  ...
  can_use_consumeable(any_state, skip_check) {
    ...
    if (
      ...
      if (
        this.ability.name === "The Hermit" ||
        this.ability.consumeable.hand_type ||
        this.ability.name === "Temperance" ||
        this.ability.name === "Black Hole"
      ) {
        return true;
      }
      ...
      if (this.ability.name === "Aura") {
        if (
          G.hand &&
          G.hand.highlighted.length === 1 &&
          G.hand.highlighted[1] &&
          !G.hand.highlighted[1].edition
        ) {
          return true;
        }
      }
      ...
      if (
        this.ability.name === "Judgement" ||
        this.ability.name === "The Soul" ||
        this.ability.name === "Wraith"
      ) {
      ...
      if (
        ...
        if (this.ability.consumeable.max_highlighted) {
          if (
            this.ability.consumeable.mod_num >= G.hand.highlighted.length &&
            G.hand.highlighted.length >= (this.ability.consumeable.min_highlighted || 1)
          ) {
            return true;
          }
        }
        if (
          (this.ability.name === "Familiar" ||
            this.ability.name === "Grim" ||
            this.ability.name === "Incantation" ||
            this.ability.name === "Immolate" ||
            this.ability.name === "Sigil" ||
            this.ability.name === "Ouija") &&
          G.hand.cards.length > 1
        ) {
          return true;
        }
      }
                      ...
                      G.E_MANAGER.add_event(
                        new GameEvent({
                          ...
                          func: function () {
                            ...
                            G.CONTROLLER.recall_cardarea_focus(
                              (area === G.jokers && "jokers") || "consumeables"
                            );
                            return true;
                          },
                        })
  ...
  can_sell_card(context) {
    ...
    if (
      (G.SETTINGS.tutorial_complete ||
        G.GAME.pseudorandom.seed !== "TUTORIAL" ||
        G.GAME.round_resets.ante > 1) &&
      this.area &&
      this.area.config.type === "joker" &&
      !this.ability.eternal
    ) {
      return true;
    }
    return false;
  ...
  calculate_dollar_bonus() {
    ...
    if (this.ability.set === "Joker") {
      ...
      if (
        this.ability.name === "Cloud 9" &&
        this.ability.nine_tally &&
      ...
      if (
        this.ability.name === "Delayed Gratification" &&
                ...
                func: function () {
                  ...
                  for (let i = 1; i <= _size; i++) {
                    ...
                    if (booster_obj.create_card && type(booster_obj.create_card) === "function") {
                      ...
                      if (
                        type((_card_to_spawn || {}).is) === "function" &&
                        _card_to_spawn.is(Card)
                      ) {
                        card = _card_to_spawn;
                      } else {
                      ...
                      card = create_card(
                        (pseudorandom(pseudoseed("stdset" + G.GAME.round_resets.ante)) > 0.6 &&
                          "Enhanced") ||
                          "Base",
                        G.pack_cards,
                        undefined,
    ...
    if (this.ability.set === "Voucher") {
      ...
      G.E_MANAGER.add_event(
        new GameEvent({
          ...
          delay: 0.4,
          func: function () {
            top_dynatext = new DynaText({
              string: localize({
                type: "name_text",
                set: this.config.center.set,
                key: this.config.center.key,
              }),
              colours: [G.C.WHITE],
              rotate: 1,
              shadow: true,
            ...
            play_sound("card1");
            play_sound("coin1");
            this.children.top_disp = new UIBox({
              definition: {
                n: G.UIT.ROOT,
                config: { align: "tm", r: 0.15, colour: G.C.CLEAR, padding: 0.15 },
                nodes: [{ n: G.UIT.O, config: { object: top_dynatext } }],
              },
              config: { align: "tm", offset: { x: 0, y: 0 }, parent: this },
            });
            this.children.bot_disp = new UIBox({
              definition: {
                n: G.UIT.ROOT,
                config: { align: "tm", r: 0.15, colour: G.C.CLEAR, padding: 0.15 },
                nodes: [{ n: G.UIT.O, config: { object: bot_dynatext } }],
              },
              config: { align: "bm", offset: { x: 0, y: 0 }, parent: this },
            });
            return true;
          },
        })
  ...
  apply_to_run(center) {
    let card_to_save =
      (this && copy_card(this)) || new Card(0, 0, G.CARD_W, G.CARD_H, G.P_CARDS.empty, center);
    [card_to_save.VT.x, card_to_save.VT.y] = [G.vouchers.T.x, G.vouchers.T.y];
    G.vouchers.emplace(card_to_save);
    let center_table = {
      name: (center && center.name) || (this && this.ability.name),
      extra: (center && center.config.extra) || (this && this.ability.extra),
    };
        ...
        new GameEvent({
          func: function () {
            ...
            G.GAME.current_round.reroll_cost = math.max(
              0,
              G.GAME.current_round.reroll_cost - center_table.extra
            );
            return true;
          },
        })
  ...
  explode(dissolve_colours, explode_time_fac) {
    ...
    let childParts1 = new Particles(0, 0, 0, 0, {
      timer_type: "TOTAL",
      ...
      new GameEvent({
        ...
        func: function () {
          if (this.juice) {
            ...
            this.juice.r =
              0.05 *
              (math.sin(5 * G.TIMERS.TOTAL) +
                math.cos(0.33 + 41.15332 * G.TIMERS.TOTAL) +
                math.cos(67.12 * G.TIMERS.TOTAL)) *
              percent;
    ...
    G.E_MANAGER.add_event(
      new GameEvent({
        ...
        delay: 0.9 * explode_time,
        func: function () {
          childParts2 = new Particles(0, 0, 0, 0, {
            timer_type: "TOTAL",
            pulse_max: 30,
            timer: 0.003,
            scale: 0.6,
  ...
  shatter() {
    ...
    this.juice_up();
    let childParts = new Particles(0, 0, 0, 0, {
      timer_type: "TOTAL",
    ...
    G.E_MANAGER.add_event(
      new GameEvent({ trigger: "after", blockable: false, delay: 0.51 * dissolve_time })
    );
  }
  start_dissolve(dissolve_colours, silent, dissolve_time_fac, no_juice) {
    let dissolve_time = 0.7 * (dissolve_time_fac || 1);
    this.dissolve = 0;
    this.dissolve_colours = dissolve_colours || [
      G.C.BLACK,
      G.C.ORANGE,
      G.C.RED,
      G.C.GOLD,
    ...
    G.E_MANAGER.add_event(
      new GameEvent({ trigger: "after", blockable: false, delay: 1.051 * dissolve_time })
    );
  }
  start_materialize(dissolve_colours, silent, timefac) {
    ...
    this.dissolve = 1;
    this.dissolve_colours = dissolve_colours ||
      (this.ability.set === "Joker" && [G.C.RARITY[this.config.center.rarity]]) ||
      (this.ability.set === "Planet" && [G.C.SECONDARY_SET.Planet]) ||
      (this.ability.set === "Tarot" && [G.C.SECONDARY_SET.Tarot]) ||
      (this.ability.set === "Spectral" && [G.C.SECONDARY_SET.Spectral]) ||
      (this.ability.set === "Booster" && [G.C.BOOSTER]) ||
      (this.ability.set === "Voucher" && [G.C.SECONDARY_SET.Voucher, G.C.CLEAR]) || [G.C.GREEN];
    this.juice_up();
    ...
    if (!silent) {
      if (
        !G.last_materialized ||
        G.last_materialized + 0.01 < G.TIMERS.REAL ||
      ...
      if (this.ability.perish_tally === 1) {
        ...
        card_eval_status_text(this, "extra", undefined, undefined, undefined, {
          message: localize({
            type: "variable",
            key: "a_remaining",
            vars: [this.ability.perish_tally],
          }),
          colour: G.C.FILTER,
          delay: 0.45,
        });
  ...
  calculate_joker(context) {
    ...
    if (this.ability.set === "Joker" && !this.debuff) {
      ...
      if (context.open_booster) {
        if (
          this.ability.name === "Hallucination" &&
          G.consumeables.cards.length + G.GAME.consumeable_buffer < G.consumeables.config.card_limit
        ) {
          if (
            pseudorandom("halu" + G.GAME.round_resets.ante) <
            G.GAME.probabilities.normal / this.ability.extra
          ) {
            G.GAME.consumeable_buffer = G.GAME.consumeable_buffer + 1;
            G.E_MANAGER.add_event(
              new GameEvent({
        ...
        if (
          this.ability.name === "Invisible Joker" &&
          this.ability.invis_rounds >= this.ability.extra &&
          !context.blueprint
        ) {
        ...
        if (this.ability.name === "Flash Card" && !context.blueprint) {
          ...
          G.E_MANAGER.add_event(
            new GameEvent({
              func: function () {
                card_eval_status_text(this, "extra", undefined, undefined, undefined, {
                  message: localize({ type: "variable", key: "a_mult", vars: [this.ability.mult] }),
                  colour: G.C.MULT,
                });
                return true;
              },
          ...
          if (G.consumeables.cards[1]) {
            G.E_MANAGER.add_event(
              new GameEvent({
                func: function () {
                  let card = copy_card(
                    pseudorandom_element(G.consumeables.cards, pseudoseed("perkeo")),
                    undefined
                  );
        ...
        if (
          ...
          card_eval_status_text(this, "extra", undefined, undefined, undefined, {
            message: localize({ type: "variable", key: "a_xmult", vars: [this.ability.x_mult] }),
          });
          return [undefined, true];
        }
        ...
        if (this.ability.name === "Madness" && !context.blueprint && !context.blind.boss) {
          ...
          for (let i = 1; i <= G.jokers.cards.length; i++) {
            if (
              G.jokers.cards[i] !== this &&
              !G.jokers.cards[i].ability.eternal &&
              !G.jokers.cards[i].getting_sliced
            ) {
              destructable_jokers[destructable_jokers.length + 1] = G.jokers.cards[i];
            }
          }
          let joker_to_destroy =
            (destructable_jokers.length > 0 &&
              pseudorandom_element(destructable_jokers, pseudoseed("madness"))) ||
            undefined;
        ...
        if (
          this.ability.name === "Riff-raff" &&
          !(context.blueprint_card || this).getting_sliced &&
          G.jokers.cards.length + G.GAME.joker_buffer < G.jokers.config.card_limit
        ) {
          let jokers_to_create = math.min(
            2,
            G.jokers.config.card_limit - (G.jokers.cards.length + G.GAME.joker_buffer)
          );
        ...
        if (this.ability.name === "Ceremonial Dagger" && !context.blueprint) {
          ...
          if (
            ...
            !this.getting_sliced &&
            !G.jokers.cards[my_pos + 1].ability.eternal &&
            !G.jokers.cards[my_pos + 1].getting_sliced
          ) {
            ...
            card_eval_status_text(this, "extra", undefined, undefined, undefined, {
              message: localize({
                type: "variable",
                key: "a_mult",
                vars: [this.ability.mult + 2 * sliced_card.sell_cost],
              }),
              colour: G.C.RED,
              no_juice: true,
            });
        ...
        if (
          this.ability.name === "Marble Joker" &&
          !(context.blueprint_card || this).getting_sliced
        ) {
          G.E_MANAGER.add_event(
            new GameEvent({
        ...
        if (
          this.ability.name === "Sixth Sense" &&
          context.full_hand.length === 1 &&
          context.full_hand[1].get_id() === 6 &&
          G.GAME.current_round.hands_played === 0
        ) {
          if (
            G.consumeables.cards.length + G.GAME.consumeable_buffer <
            G.consumeables.config.card_limit
          ) {
            G.GAME.consumeable_buffer = G.GAME.consumeable_buffer + 1;
            G.E_MANAGER.add_event(
              ...
              new GameEvent({
                func: function () {
                  G.E_MANAGER.add_event(
                    new GameEvent({
                      func: function () {
                        this.ability.caino_xmult =
                          this.ability.caino_xmult + faces * this.ability.extra;
                        return true;
                      },
                    })
                  );
                  card_eval_status_text(this, "extra", undefined, undefined, undefined, {
                    message: localize({
                      type: "variable",
                      key: "a_xmult",
                      vars: [this.ability.caino_xmult + faces * this.ability.extra],
                    }),
                  });
                  return true;
                },
                ...
                func: function () {
                  ...
                  card_eval_status_text(this, "extra", undefined, undefined, undefined, {
                    message: localize({
                      type: "variable",
                      key: "a_xmult",
                      vars: [this.ability.x_mult + this.ability.extra * glasses],
                    }),
                  });
                  return true;
                },
                ...
                func: function () {
                  G.E_MANAGER.add_event(
                    new GameEvent({
                      func: function () {
                        this.ability.x_mult =
                          this.ability.x_mult + this.ability.extra * glass_cards;
                        return true;
                      },
                    })
                  );
                  card_eval_status_text(this, "extra", undefined, undefined, undefined, {
                    message: localize({
                      type: "variable",
                      key: "a_xmult",
                      vars: [this.ability.x_mult + this.ability.extra * glass_cards],
                    }),
                  });
                  return true;
                },
        ...
        if (
          this.ability.name === "Glass Joker" &&
          !context.blueprint &&
          context.consumeable.ability.name === "The Hanged Man"
        ) {
        ...
        if (
          this.ability.name === "Fortune Teller" &&
          !context.blueprint &&
              ...
              func: function () {
                card_eval_status_text(this, "extra", undefined, undefined, undefined, {
                  message: localize({
                    type: "variable",
                    key: "a_mult",
                    vars: [G.GAME.consumeable_usage_total.tarot],
                  }),
                });
                return true;
              },
        ...
        if (
          this.ability.name === "Constellation" &&
          !context.blueprint &&
        ...
        if (
          this.ability.name === "Trading Card" &&
          !context.blueprint &&
          G.GAME.current_round.discards_used <= 0 &&
          context.full_hand.length === 1
        ) {
          ease_dollars(this.ability.extra);
          return {
            message: localize("$") + this.ability.extra,
            colour: G.C.MONEY,
            delay: 0.45,
            remove: true,
            card: this,
        ...
        if (
          this.ability.name === "Castle" &&
          !context.other_card.debuff &&
          context.other_card.is_suit(G.GAME.current_round.castle_card.suit) &&
          !context.blueprint
        ) {
        ...
        if (
          this.ability.name === "Mail-In Rebate" &&
          !context.other_card.debuff &&
        ...
        if (
          this.ability.name === "Hit the Road" &&
          !context.other_card.debuff &&
        ...
        if (
          this.ability.name === "Green Joker" &&
          !context.blueprint &&
          context.other_card === context.full_hand[context.full_hand.length]
        ) {
          ...
          if (this.ability.mult !== prev_mult) {
            return {
              message: localize({
                type: "variable",
                key: "a_mult_minus",
                vars: [this.ability.extra.discard_sub],
              }),
              colour: G.C.RED,
              card: this,
            };
        ...
        if (
          this.ability.name === "Faceless Joker" &&
          context.other_card === context.full_hand[context.full_hand.length]
        ) {
          let face_cards = 0;
              ...
              new GameEvent({
                func: function () {
                  ...
                  card_eval_status_text(
                    ...
                    undefined,
                    {
                      message: localize("$") + this.ability.extra.dollars,
                      colour: G.C.MONEY,
                      delay: 0.45,
                    }
                  );
        ...
        if (context.individual) {
          ...
          if (context.cardarea === G.hand) {
            if (
              this.ability.name === "Mime" &&
              (next(context.card_effects[1]) || context.card_effects.length > 1)
            ) {
              return {
                message: localize("k_again_ex"),
                repetitions: this.ability.extra,
                card: this,
              };
            }
          }
          ...
          if (this.ability.name === "Gros Michel" || this.ability.name === "Cavendish") {
            if (
              pseudorandom((this.ability.name === "Cavendish" && "cavendish") || "gros_michel") <
              G.GAME.probabilities.normal / this.ability.extra.odds
            ) {
              G.E_MANAGER.add_event(
                new GameEvent({
                  func: function () {
          ...
          if (
            this.ability.name === "Mr. Bones" &&
            context.game_over &&
            G.GAME.chips / G.GAME.blind.chips >= 0.25
          ) {
            G.E_MANAGER.add_event(
              new GameEvent({
                func: function () {
        ...
        if (context.cardarea === G.play) {
          if (this.ability.name === "Hiker") {
            ...
            context.other_card.ability.perma_bonus =
              context.other_card.ability.perma_bonus + this.ability.extra;
            return {
          ...
          if (
            this.ability.name === "Lucky Cat" &&
            context.other_card.lucky_trigger &&
            !context.blueprint
          ) {
            this.ability.x_mult = this.ability.x_mult + this.ability.extra;
            return {
              extra: { focus: this, message: localize("k_upgrade_ex"), colour: G.C.MULT },
              card: this,
            };
          }
          if (
            this.ability.name === "Wee Joker" &&
            context.other_card.get_id() === 2 &&
            !context.blueprint
          ) {
            this.ability.extra.chips = this.ability.extra.chips + this.ability.extra.chip_mod;
            return {
              extra: { focus: this, message: localize("k_upgrade_ex") },
              card: this,
              colour: G.C.CHIPS,
            };
          }
          ...
          if (
            this.ability.name === "8 Ball" &&
            G.consumeables.cards.length + G.GAME.consumeable_buffer <
              G.consumeables.config.card_limit
          ) {
            if (
              context.other_card.get_id() === 8 &&
              pseudorandom("8ball") < G.GAME.probabilities.normal / this.ability.extra
            ) {
              G.GAME.consumeable_buffer = G.GAME.consumeable_buffer + 1;
              return {
                extra: {
          ...
          if (
            this.ability.name === "The Idol" &&
            context.other_card.get_id() === G.GAME.current_round.idol_card.id &&
            context.other_card.is_suit(G.GAME.current_round.idol_card.suit)
          ) {
            return { x_mult: this.ability.extra, colour: G.C.RED, card: this };
          }
          ...
          if (
            this.ability.name === "Golden Ticket" &&
          ...
          if (
            this.ability.name === "Walkie Talkie" &&
            (context.other_card.get_id() === 10 || context.other_card.get_id() === 4)
          ) {
            return { chips: this.ability.extra.chips, mult: this.ability.extra.mult, card: this };
          }
          if (
            this.ability.name === "Business Card" &&
            context.other_card.is_face() &&
            pseudorandom("business") < G.GAME.probabilities.normal / this.ability.extra
          ) {
          ...
          if (
            this.ability.name === "Even Steven" &&
            context.other_card.get_id() <= 10 &&
            context.other_card.get_id() >= 0 &&
            context.other_card.get_id() % 2 === 0
          ) {
            return { mult: this.ability.extra, card: this };
          }
          if (
            this.ability.name === "Odd Todd" &&
            ((context.other_card.get_id() <= 10 &&
              context.other_card.get_id() >= 0 &&
              context.other_card.get_id() % 2 === 1) ||
              context.other_card.get_id() === 14)
          ) {
            return { chips: this.ability.extra, card: this };
          }
          if (
            this.ability.effect === "Suit Mult" &&
            context.other_card.is_suit(this.ability.extra.suit)
          ) {
          ...
          if (
            this.ability.name === "Bloodstone" &&
            context.other_card.is_suit("Hearts") &&
            pseudorandom("bloodstone") < G.GAME.probabilities.normal / this.ability.extra.odds
          ) {
            return { x_mult: this.ability.extra.Xmult, card: this };
          }
          if (
            this.ability.name === "Ancient Joker" &&
            context.other_card.is_suit(G.GAME.current_round.ancient_card.suit)
          ) {
            return { x_mult: this.ability.extra, card: this };
          }
          if (
            this.ability.name === "Triboulet" &&
            (context.other_card.get_id() === 12 || context.other_card.get_id() === 13)
          ) {
            return { x_mult: this.ability.extra, colour: G.C.RED, card: this };
          }
        }
        if (context.cardarea === G.hand) {
          ...
          if (
            this.ability.name === "Reserved Parking" &&
            context.other_card.is_face() &&
            pseudorandom("parking") < G.GAME.probabilities.normal / this.ability.extra.odds
          ) {
            if (context.other_card.debuff) {
              return { message: localize("k_debuffed"), colour: G.C.RED, card: this };
            } else {
        ...
        if (context.cardarea === G.play) {
          ...
          if (
            this.ability.name === "Hanging Chad" &&
        ...
        if (
          this.ability.name === "Baseball Card" &&
          (context.other_joker.config.center.rarity === 2 ||
            context.other_joker.config.center.rarity === "Uncommon") &&
          this !== context.other_joker
        ) {
          G.E_MANAGER.add_event(
            new GameEvent({
              func: function () {
          ...
          return {
            message: localize({ type: "variable", key: "a_xmult", vars: [this.ability.extra] }),
            Xmult_mod: this.ability.extra,
          };
        }
      } else {
        if (context.cardarea === G.jokers) {
          if (context.before) {
            if (
              this.ability.name === "Spare Trousers" &&
              (next(context.poker_hands["Two Pair"]) || next(context.poker_hands["Full House"])) &&
              !context.blueprint
            ) {
              this.ability.mult = this.ability.mult + this.ability.extra;
            ...
            if (
              this.ability.name === "Space Joker" &&
              pseudorandom("space") < G.GAME.probabilities.normal / this.ability.extra
            ) {
              return { card: this, level_up: true, message: localize("k_level_up_ex") };
            }
            if (
              this.ability.name === "Square Joker" &&
              context.full_hand.length === 4 &&
              !context.blueprint
            ) {
              this.ability.extra.chips = this.ability.extra.chips + this.ability.extra.chip_mod;
            ...
            if (
              this.ability.name === "To Do List" &&
              context.scoring_name === this.ability.to_do_poker_hand
            ) {
              ease_dollars(this.ability.extra.dollars);
              G.GAME.dollar_buffer = (G.GAME.dollar_buffer || 0) + this.ability.extra.dollars;
              G.E_MANAGER.add_event(
            ...
            if (this.ability.name === "Green Joker" && !context.blueprint) {
              ...
              return {
                ...
                message: localize({
                  type: "variable",
                  key: "a_mult",
                  vars: [this.ability.extra.hand_add],
                }),
              };
            }
              ...
              if (this.ability.extra.chips - this.ability.extra.chip_mod <= 0) {
                ...
                return {
                  message: localize({
                    type: "variable",
                    key: "a_chips_minus",
                    vars: [this.ability.extra.chip_mod],
                  }),
                  colour: G.C.CHIPS,
                };
              }
            ...
            if (this.ability.name === "Loyalty Card") {
              this.ability.loyalty_remaining =
                (this.ability.extra.every -
                  1 -
                  (G.GAME.hands_played - this.ability.hands_played_at_create)) %
                (this.ability.extra.every + 1);
                ...
                if (this.ability.loyalty_remaining === this.ability.extra.every) {
                  return {
                    message: localize({
                      type: "variable",
                      key: "a_xmult",
                      vars: [this.ability.extra.Xmult],
                    }),
                    Xmult_mod: this.ability.extra.Xmult,
                  };
                }
              } else {
            ...
            if (
              this.ability.name !== "Seeing Double" &&
              this.ability.x_mult > 1 &&
              (this.ability.type === "" || next(context.poker_hands[this.ability.type]))
            ) {
              return {
                message: localize({
                  type: "variable",
                ...
                colour: G.C.RED,
                Xmult_mod: this.ability.x_mult,
              };
            }
            if (this.ability.t_mult > 0 && next(context.poker_hands[this.ability.type])) {
              return {
                message: localize({ type: "variable", key: "a_mult", vars: [this.ability.t_mult] }),
                mult_mod: this.ability.t_mult,
              };
            }
            if (this.ability.t_chips > 0 && next(context.poker_hands[this.ability.type])) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_chips",
                  vars: [this.ability.t_chips],
                }),
                chip_mod: this.ability.t_chips,
              };
            }
            if (
              this.ability.name === "Half Joker" &&
              context.full_hand.length <= this.ability.extra.size
            ) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_mult",
                  vars: [this.ability.extra.mult],
                }),
                mult_mod: this.ability.extra.mult,
              };
            }
            if (this.ability.name === "Abstract Joker") {
              ...
              return {
                message: localize({
                  type: "variable",
                  key: "a_mult",
                  vars: [x * this.ability.extra],
                }),
                mult_mod: x * this.ability.extra,
              };
            }
            ...
            if (
              this.ability.name === "Mystic Summit" &&
              G.GAME.current_round.discards_left === this.ability.extra.d_remaining
            ) {
              return {
                message: localize({
                  type: "variable",
            ...
            if (this.ability.name === "Misprint") {
              let temp_Mult = pseudorandom(
                "misprint",
                this.ability.extra.min,
                this.ability.extra.max
              );
              return {
            ...
            if (this.ability.name === "Banner" && G.GAME.current_round.discards_left > 0) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_chips",
                  vars: [G.GAME.current_round.discards_left * this.ability.extra],
                }),
                chip_mod: G.GAME.current_round.discards_left * this.ability.extra,
              };
            }
            if (this.ability.name === "Stuntman") {
              return {
                ...
                chip_mod: this.ability.extra.chip_mod,
              };
            }
            if (this.ability.name === "Matador") {
              if (G.GAME.blind.triggered) {
            ...
            if (this.ability.name === "Supernova") {
              return {
                message: localize({
                  type: "variable",
                  key: "a_mult",
                  vars: [G.GAME.hands[context.scoring_name].played],
                }),
            ...
            if (this.ability.name === "Ceremonial Dagger" && this.ability.mult > 0) {
              return {
                message: localize({ type: "variable", key: "a_mult", vars: [this.ability.mult] }),
                mult_mod: this.ability.mult,
              };
            }
            if (
              this.ability.name === "Vagabond" &&
              G.consumeables.cards.length + G.GAME.consumeable_buffer <
                G.consumeables.config.card_limit
            ) {
            ...
            if (
              this.ability.name === "Superposition" &&
              G.consumeables.cards.length + G.GAME.consumeable_buffer <
                G.consumeables.config.card_limit
            ) {
              let aces = 0;
              ...
              for (let i = 1; i <= context.scoring_hand.length; i++) {
                if (SMODS.has_any_suit(context.scoring_hand[i])) {
                  if (context.scoring_hand[i].is_suit("Hearts") && suits["Hearts"] === 0) {
                    ...
                    context.scoring_hand[i].is_suit("Diamonds") &&
                    suits["Diamonds"] === 0
                  ) {
                    suits["Diamonds"] = suits["Diamonds"] + 1;
            ...
            if (this.ability.name === "Seeing Double") {
              ...
              if (
                (suits["Hearts"] > 0 || suits["Diamonds"] > 0 || suits["Spades"] > 0) &&
                suits["Clubs"] > 0
              ) {
                return {
                  message: localize({
            ...
            if (this.ability.name === "Wee Joker") {
              return {
                message: localize({
                  type: "variable",
                  key: "a_chips",
                  vars: [this.ability.extra.chips],
                }),
                chip_mod: this.ability.extra.chips,
                colour: G.C.CHIPS,
              };
            }
            ...
            if (this.ability.name === "Blue Joker" && G.deck.cards.length > 0) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_chips",
                  vars: [this.ability.extra * G.deck.cards.length],
                }),
                chip_mod: this.ability.extra * G.deck.cards.length,
                colour: G.C.CHIPS,
              };
            }
            if (
              this.ability.name === "Erosion" &&
              G.GAME.starting_deck_size - G.playing_cards.length > 0
            ) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_mult",
                  vars: [this.ability.extra * (G.GAME.starting_deck_size - G.playing_cards.length)],
                }),
                mult_mod: this.ability.extra * (G.GAME.starting_deck_size - G.playing_cards.length),
                colour: G.C.MULT,
              };
            }
            ...
            if (this.ability.name === "Stone Joker" && this.ability.stone_tally > 0) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_chips",
                  vars: [this.ability.extra * this.ability.stone_tally],
                }),
                chip_mod: this.ability.extra * this.ability.stone_tally,
                colour: G.C.CHIPS,
              };
            }
            if (this.ability.name === "Steel Joker" && this.ability.steel_tally > 0) {
              return {
                message: localize({
                  type: "variable",
                  key: "a_xmult",
                  vars: [1 + this.ability.extra * this.ability.steel_tally],
                }),
                Xmult_mod: 1 + this.ability.extra * this.ability.steel_tally,
                colour: G.C.MULT,
              };
            }
            if (this.ability.name === "Bull" && G.GAME.dollars + (G.GAME.dollar_buffer || 0) > 0) {
              return {
                message: localize({
                  ...
                  key: "a_chips",
                  vars: [
                    this.ability.extra * math.max(0, G.GAME.dollars + (G.GAME.dollar_buffer || 0)),
                  ],
                }),
                chip_mod:
                  this.ability.extra * math.max(0, G.GAME.dollars + (G.GAME.dollar_buffer || 0)),
            ...
            if (
              ...
              G.GAME.consumeable_usage_total.tarot > 0
            ) {
              return {
                message: localize({
                  type: "variable",
            ...
            if (
              this.ability.name === "Card Sharp" &&
              G.GAME.hands[context.scoring_name] &&
            ...
            if (
              this.ability.name === "Bootstraps" &&
              math.floor(
                (G.GAME.dollars + (G.GAME.dollar_buffer || 0)) / this.ability.extra.dollars
              ) >= 1
            ) {
              return {
                message: localize({
            ...
            if (this.ability.name === "Caino" && this.ability.caino_xmult > 1) {
              return {
                ...
                Xmult_mod: this.ability.caino_xmult,
              };
            }
          }
        }
  ...
  is_suit(suit, bypass_debuff, flush_calc) {
    if (flush_calc) {
      ...
      if (
        ...
        (this.base.suit === "Hearts" || this.base.suit === "Diamonds") ===
    ...
    if (G.STAGE === G.STAGES.RUN) {
      ...
      if (this.ability.name === "Swashbuckler") {
        ...
        for (let i = 1; i <= G.jokers.cards.length; i++) {
          if (
            G.jokers.cards[i] !== this &&
            G.jokers.cards[i].area &&
            G.jokers.cards[i].area === G.jokers
          ) {
  ...
  align_h_popup() {
    ...
    let popup_direction =
      ((this.children.buy_button ||
        (this.area && this.area.config.view_deck) ||
        (this.area && this.area.config.type === "shop")) &&
        "cl") ||
      (this.T.y < G.CARD_H * 0.8 && "bm") ||
      "tm";
    return {
      major: this.children.focused_ui || this,
      parent: this,
      xy_bond: "Strong",
      r_bond: "Weak",
      wh_bond: "Weak",
      offset: {
        x:
          (popup_direction !== "cl" && 0) ||
          (focused_ui && -0.05) ||
          (this.ability.consumeable && 0) ||
          (this.ability.set === "Voucher" && 0) ||
          -0.05,
        y:
          (focused_ui &&
            ((popup_direction === "tm" &&
              ((this.area && this.area === G.hand && -0.08) || -0.15)) ||
              (popup_direction === "bm" && 0.12) ||
              0)) ||
          (popup_direction === "tm" && -0.13) ||
          (popup_direction === "bm" && 0.1) ||
          0,
      },
  ...
  hover() {
    ...
    if (
      this.facing === "front" &&
      (!this.states.drag.is || G.CONTROLLER.HID.touch) &&
      !this.no_ui &&
      !G.debug_tooltip_toggle
    ) {
  ...
  juice_up(scale, rot_amount) {
    let rot_amt =
      (rot_amount && 0.4 * ((math.random() > 0.5 && 1) || -1) * rot_amount) ||
  ...
  draw(layer) {
    ...
    if (layer === "shadow" || layer === "both") {
      ...
      this.ARGS.send_to_shader[1] =
        math.min(this.VT.r * 3, 1) +
        math.sin(G.TIMERS.REAL / 28) +
        1 +
        ((this.juice && this.juice.r * 20) || 0) +
        this.tilt_var.amt;
    ...
    G.shared_shadow =
      (this.sprite_facing === "front" && this.children.center) || this.children.back;
    if (
      !this.no_shadow &&
      G.SETTINGS.GRAPHICS.shadows === "On" &&
      (layer === "shadow" || layer === "both") &&
      this.ability.effect !== "Glass Card" &&
      !this.greyed &&
      this.should_draw_shadow() &&
      ((this.area && this.area !== G.discard && this.area.config.type !== "deck") ||
        !this.area ||
        this.states.drag.is)
    ) {
      this.shadow_height =
        0 * (0.08 + 0.4 * math.sqrt(this.velocity.x ^ 2)) +
        ((((this.highlighted && this.area === G.play) || this.states.drag.is) && 0.35) ||
          (this.area && this.area.config.type === "title_2" && 0.04) ||
          0.1);
    ...
    if (layer === "card" || layer === "both") {
      this.tilt_var = this.tilt_var || {
        mx: 0,
        my: 0,
        dx: this.tilt_var.dx || 0,
        dy: this.tilt_var.dy || 0,
        amt: 0,
      };
      let tilt_factor = 0.3;
      if (this.states.focus.is) {
        [this.tilt_var.mx, this.tilt_var.my] = [
          G.CONTROLLER.cursor_position.x + this.tilt_var.dx * this.T.w * G.TILESCALE * G.TILESIZE,
          G.CONTROLLER.cursor_position.y + this.tilt_var.dy * this.T.h * G.TILESCALE * G.TILESIZE,
        ];
        this.tilt_var.amt =
          math.abs(
            this.hover_offset.y + this.hover_offset.x - 1 + this.tilt_var.dx + this.tilt_var.dy - 1
          ) * tilt_factor;
        ...
        this.tilt_var.mx =
          ((0.5 + 0.5 * this.ambient_tilt * math.cos(tilt_angle)) * this.VT.w +
            this.VT.x +
            G.ROOM.T.x) *
          G.TILESIZE *
          G.TILESCALE;
        this.tilt_var.my =
          ((0.5 + 0.5 * this.ambient_tilt * math.sin(tilt_angle)) * this.VT.h +
            this.VT.y +
            G.ROOM.T.y) *
          G.TILESIZE *
          G.TILESCALE;
      ...
      if (this.vortex) {
        ...
        if (
          (this.edition && this.edition.negative) ||
          (this.ability.name === "Antimatter" &&
            (this.config.center.discovered || this.bypass_discovery_center))
        ) {
          this.children.center.draw_shader("negative", undefined, this.ARGS.send_to_shader);
          if (
            this.children.front &&
            this.ability.effect !== "Stone Card" &&
            !this.config.center.replace_base_card
          ) {
        ...
        if (
          !this.config.center.discovered &&
          (this.ability.consumeable || this.config.center.unlocked) &&
          !this.config.center.demo &&
          !this.bypass_discovery_center
        ) {
          let shared_sprite =
            ((this.ability.set === "Edition" || this.ability.set === "Joker") &&
              G.shared_undiscovered_joker) ||
            G.shared_undiscovered_tarot;
          ...
          if (
            (this.config.center.undiscovered && !this.config.center.undiscovered.no_overlay) ||
            !(
              SMODS.UndiscoveredSprites[this.ability.set] &&
              SMODS.UndiscoveredSprites[this.ability.set].no_overlay
            )
          ) {
            ...
            if (
              SMODS.UndiscoveredSprites[this.ability.set] &&
              SMODS.UndiscoveredSprites[this.ability.set].overlay_sprite
            ) {
              SMODS.UndiscoveredSprites[this.ability.set].overlay_sprite.draw_shader(
                "dissolve",
                undefined,
                undefined,
                undefined,
        ...
        if (true) {
          if (
            (this.ability.set === "Voucher" || this.config.center.demo) &&
            (this.ability.name !== "Antimatter" ||
              !(this.config.center.discovered || this.bypass_discovery_center))
          ) {
            if (this.should_draw_base_shader()) {
          ...
          if (
            (this.ability.set === "Booster" || this.ability.set === "Spectral") &&
            this.should_draw_base_shader()
          ) {
          ...
          if (type(seal.draw) === "function") {
            ...
            G.shared_seals[this.seal].draw_shader(
              "dissolve",
              undefined,
              undefined,
              undefined,
          ...
          if (this.sticker && G.shared_stickers[this.sticker]) {
            ...
            G.shared_stickers[this.sticker].draw_shader(
              "dissolve",
              undefined,
              undefined,
              undefined,
          ...
          if (
            ...
            let rotate_mod =
              0.1 * math.sin(1.219 * G.TIMERS.REAL) +
              0.07 *
          ...
          if (
            ...
            let scale_mod =
              ...
              0 *
                ...
                ((1 - (G.TIMERS.REAL - math.floor(G.TIMERS.REAL))) ^ 3);
            let rotate_mod =
              0.05 * math.sin(1.219 * G.TIMERS.REAL) +
              0 *
                math.sin(G.TIMERS.REAL * math.pi * 5) *
                ((1 - (G.TIMERS.REAL - math.floor(G.TIMERS.REAL))) ^ 2);
            if (this.ability.name === "Hologram") {
              this.hover_tilt = this.hover_tilt * 1.5;
              this.children.floating_sprite.draw_shader(
                "hologram",
                undefined,
                this.ARGS.send_to_shader,
                undefined,
  ...
  highlight(is_higlighted) {
    ...
    if (
      this.ability.consumeable ||
      this.ability.set === "Joker" ||
      (this.area && this.area === G.pack_cards)
    ) {
      if (this.highlighted && this.area && this.area.config.type !== "shop") {
        let x_off = (this.ability.consumeable && -0.1) || 0;
        this.children.use_button = new UIBox({
          definition: G.UIDEF.use_and_sell_buttons(this),
          config: {
            align: ((this.area === G.jokers || this.area === G.consumeables) && "cr") || "bmi",
            offset: ((this.area === G.jokers || this.area === G.consumeables) && {
              x: x_off - 0.4,
              y: 0,
            }) || { x: 0, y: 0.65 },
            parent: this,
  ...
  save() {
    cardTable = {
      ...
      save_fields: { center: this.config.center_key, card: this.config.card_key },
      params: this.params,
      no_ui: this.no_ui,
      base_cost: this.base_cost,
      extra_cost: this.extra_cost,
      cost: this.cost,
      sell_cost: this.sell_cost,
      facing: this.facing,
      sprite_facing: this.facing,
      flipping: undefined,
      highlighted: this.highligted,
      debuff: this.debuff,
      rank: this.rank,
      added_to_deck: this.added_to_deck,
      joker_added_to_deck_but_debuffed: this.joker_added_to_deck_but_debuffed,
      label: this.label,
      playing_card: this.playing_card,
      base: this.base,
      ability: this.ability,
      pinned: this.pinned,
      edition: this.edition,
      seal: this.seal,
      bypass_discovery_center: this.bypass_discovery_center,
      bypass_discovery_ui: this.bypass_discovery_ui,
      bypass_lock: this.bypass_lock,
      unique_val: this.unique_val,
      unique_val__saved_ID: this.ID,
      ignore_base_shader: this.ignore_base_shader,
      ignore_shadow: this.ignore_shadow,
    };
    return cardTable;
  }
