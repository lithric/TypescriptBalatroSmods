...
class Game extends LuaObject {
      ...
      DISPLAYS: [
        {
          ...
          DPI_scale: 1,
          MONITOR_DIMS: { width: NaN, height: NaN },
        },
      ],
    },
    CUSTOM_DECK: {
      Collabs: { Spades: "default", Hearts: "default", Clubs: "default", Diamonds: "default" },
    },
  ...
  METRICS = {
    cards: { used: {}, bought: {}, appeared: {} },
    decks: { chosen: {}, win: {}, lose: {} },
    bosses: { faced: {}, win: {}, lose: {} },
  };
  PROFILES = [{}, {}, {}];
  TILESIZE = 20;
  TILESCALE = 3.65;
  ...
  C: HexColorSelection = {
    ...
    BLIND: { Small: HEX("50846e"), Big: HEX("50846e"), Boss: HEX("b44430"), won: HEX("4f6367") },
    HAND_LEVELS: [
      HEX("efefef"),
      HEX("95acff"),
      HEX("65efaf"),
    ...
    BACKGROUND: { L: [1, 1, 0, 1], D: HEX("374244"), C: HEX("374244"), contrast: 1 },
    UI_CHIPS: [NaN, NaN, NaN, NaN],
    UI_MULT: [NaN, NaN, NaN, NaN],
  };
  ...
  button_mapping = {
    a: (G.F_SWAP_AB_BUTTONS && "b") || undefined,
    b: (G.F_SWAP_AB_BUTTONS && "a") || undefined,
    y: (G.F_SWAP_XY_BUTTONS && "x") || undefined,
    x: (G.F_SWAP_XY_BUTTONS && "y") || undefined,
  };
  keybind_mapping = [
    {
      a: "dpleft",
  ...
  SOUND_MANAGER?: ThreadManager; // can be undefined in case the sound is turned off I guess? The greatest programming decision I've ever seen to not include an essential part of the game's function just because the user didn't want sound. Good luck making sound based abilities work when the user turns the sound off LMAO!!
  SAVE_MANAGER: ThreadManager;
  HTTP_MANAGER: ThreadManager;
  ...
  F_STREAMER_EVENT:
    | boolean
    | { name: string; prev_name: string; submission_name?: string; score: number };
  PROGRESS: any;
  ...
  start_up() {
    ...
    if (settings) {
      ...
      if (
        G.VERSION >= "1.0.0" &&
        love.system.getOS() === "NOPE" &&
        (!settings_file.version || settings_file.version < "1.0.0")
      ) {
        for (let i = 1; i <= 3; i++) {
    ...
    if (this.SETTINGS.GRAPHICS.texture_scaling) {
      this.SETTINGS.GRAPHICS.texture_scaling =
        (this.SETTINGS.GRAPHICS.texture_scaling > 1 && 2) || 1;
    }
    ...
    this.shared_debuff = new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["centers"], {
      x: 4,
      y: 0,
    });
    this.shared_soul = new Sprite(
      0,
      0,
      this.CARD_W,
      this.CARD_H,
      this.ASSET_ATLAS["centers"],
      this.P_CENTERS.soul.pos
    );
    this.shared_undiscovered_joker = new Sprite(
      0,
      0,
      this.CARD_W,
      this.CARD_H,
      this.ASSET_ATLAS["centers"],
      this.P_CENTERS.undiscovered_joker.pos
    );
    this.shared_undiscovered_tarot = new Sprite(
      0,
      0,
      this.CARD_W,
      this.CARD_H,
      this.ASSET_ATLAS["centers"],
      this.P_CENTERS.undiscovered_tarot.pos
    );
    this.shared_sticker_eternal = new Sprite(
      0,
      0,
      this.CARD_W,
      this.CARD_H,
      this.ASSET_ATLAS["stickers"],
      { x: 0, y: 0 }
    );
    this.shared_sticker_perishable = new Sprite(
      0,
      0,
      this.CARD_W,
      this.CARD_H,
    ...
    this.shared_sticker_rental = new Sprite(
      0,
      0,
      this.CARD_W,
      this.CARD_H,
    ...
    this.shared_stickers = {
      White: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 1,
        y: 0,
      }),
      Red: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], { x: 2, y: 0 }),
      Green: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 3,
        y: 0,
      }),
      Black: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 0,
        y: 1,
      }),
      Blue: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 4,
        y: 0,
      }),
      Purple: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 1,
        y: 1,
      }),
      Orange: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 2,
        y: 1,
      }),
      Gold: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["stickers"], {
        x: 3,
        y: 1,
      }),
    };
    this.shared_seals = {
      Gold: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["centers"], { x: 2, y: 0 }),
      Purple: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["centers"], {
        x: 4,
        y: 4,
      }),
      Red: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["centers"], { x: 5, y: 4 }),
      Blue: new Sprite(0, 0, this.CARD_W, this.CARD_H, this.ASSET_ATLAS["centers"], { x: 6, y: 4 }),
    };
  ...
  init_item_prototypes() {
    ...
    this.P_CENTERS = {
      ...
      j_smeared: {
        ...
        unlock_condition: {
          type: "modify_deck",
          extra: { count: 3, enhancement: "Wild Card", e_key: "m_wild" },
        },
      },
      j_throwback: {
        order: 114,
      ...
      j_glass: {
        ...
        unlock_condition: {
          type: "modify_deck",
          extra: { count: 5, enhancement: "Glass Card", e_key: "m_glass" },
        },
    ...
    for (const [k, v] of pairs(this.P_CENTERS)) {
      if (!v.wip && !v.demo) {
        ...
        if (
          !v.unlocked &&
          (string.find(k, "^j_") || string.find(k, "^b_") || string.find(k, "^v_")) &&
          meta.unlocked[k]
        ) {
          v.unlocked = true;
        }
    ...
    table.sort(this.P_CENTER_POOLS["Demo"], function (a, b) {
      return (
        (a?.order ?? 0) + ((a.set === "Joker" && 1000) || 0) <
        (b?.order ?? 0) + ((b.set === "Joker" && 1000) || 0)
      );
    });
    for (let i = 0; i < 4; i++) {
  ...
  set_language() {
    ...
    this.LANG =
      this.LANGUAGES[this.SETTINGS.real_language || this.SETTINGS.language] ||
        ...
        assert(
          loadstring(
            (love.filesystem.read("localization/" + (G.SETTINGS.language + ".lua")) ||
              love.filesystem.read("localization/en-us.lua"))[0] as string
          )
  ...
  set_render_settings() {
    ...
    love.graphics.setDefaultFilter(
      (this.SETTINGS.GRAPHICS.texture_scaling === 1 && "nearest") || "linear",
      (this.SETTINGS.GRAPHICS.texture_scaling === 1 && "nearest") || "linear",
      1
    );
    ...
    this.animation_atli = [
      {
        name: "blind_chips",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/BlindChips.png"),
        px: 34,
        py: 34,
        frames: 21,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/ShopSignAnimation.png"),
        px: 113,
        py: 57,
        frames: 4,
      },
    ...
    this.asset_atli = [
      {
        name: "cards_1",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/8BitDeck.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "cards_2",
        path:
          "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/8BitDeck_opt2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "centers",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/Enhancers.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "Joker",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/Jokers.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "Tarot",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/Tarots.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "Voucher",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/Vouchers.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "Booster",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/boosters.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "ui_1",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/ui_assets.png"),
        px: 18,
        py: 18,
        type: undefined,
      },
      {
        name: "ui_2",
        path:
          "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/ui_assets_opt2.png"),
        px: 18,
        py: 18,
        type: undefined,
      },
      {
        name: "balatro",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/balatro.png"),
        px: 333,
        py: 216,
        type: undefined,
      },
      {
        name: "gamepad_ui",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/gamepad_ui.png"),
        px: 32,
        py: 32,
        type: undefined,
      },
      {
        name: "icons",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/icons.png"),
        px: 66,
        py: 66,
        type: undefined,
      },
      {
        name: "tags",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/tags.png"),
        px: 34,
        py: 34,
        type: undefined,
      },
      {
        name: "stickers",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/stickers.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        name: "chips",
        path: "resources/textures/" + (this.SETTINGS.GRAPHICS.texture_scaling + "x/chips.png"),
        px: 29,
        py: 29,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_AU_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_AU_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_TW_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_TW_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_VS_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_VS_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_DTD_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_DTD_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_CYP_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_CYP_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_STS_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_STS_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_TBoI_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_TBoI_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_SV_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_SV_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_SK_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_SK_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_DS_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_DS_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_CL_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_CL_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_D2_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_D2_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_PC_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_PC_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_WF_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_WF_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_EG_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_EG_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_XR_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_XR_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_CR_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_CR_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_BUG_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_BUG_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_FO_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_FO_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_DBD_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_DBD_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_C7_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_C7_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_R_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_R_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_AC_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_AC_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_STP_1.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
      {
        ...
        path:
          "resources/textures/" +
          (this.SETTINGS.GRAPHICS.texture_scaling + "x/collabs/collab_STP_2.png"),
        px: 71,
        py: 95,
        type: undefined,
      },
    ...
    for (let i = 0; i < this.animation_atli.length; i++) {
      ...
      this.ANIMATION_ATLAS[this.animation_atli[i].name].image = love.graphics.newImage(
        this.animation_atli[i].path,
        { mipmaps: true, dpiscale: this.SETTINGS.GRAPHICS.texture_scaling }
      );
    ...
    for (let i = 0; i < this.asset_atli.length; i++) {
      ...
      this.ASSET_ATLAS[this.asset_atli[i].name].image = love.graphics.newImage(
        this.asset_atli[i].path,
        { mipmaps: true, dpiscale: this.SETTINGS.GRAPHICS.texture_scaling }
      );
      let mipmap_level =
        SMODS.config.graphics_mipmap_level_options[SMODS.config.graphics_mipmap_level];
    ...
    for (let i = 0; i < this.asset_images.length; i++) {
      ...
      this.ASSET_ATLAS[this.asset_images[i].name].image = love.graphics.newImage(
        this.asset_images[i].path,
  ...
  init_window(reset?: boolean) {
    ...
    this.WINDOWTRANS = {
      x: 0,
      y: 0,
      w: this.TILE_W + 2 * this.ROOM_PADDING_W,
      h: this.TILE_H + 2 * this.ROOM_PADDING_H,
    };
    this.window_prev = {
      orig_scale: this.TILESCALE,
      w: this.WINDOWTRANS.w * this.TILESIZE * this.TILESCALE,
      h: this.WINDOWTRANS.h * this.TILESIZE * this.TILESCALE,
      orig_ratio:
        (this.WINDOWTRANS.w * this.TILESIZE * this.TILESCALE) /
        (this.WINDOWTRANS.h * this.TILESIZE * this.TILESCALE),
    };
  ...
  save_progress() {
    ...
    for (const [k, v] of pairs(this.P_CENTERS)) {
      G.ARGS.save_progress.UDA[k] =
        ((v.unlocked && "u") || "") + (((v.discovered && "d") || "") + ((v.alerted && "a") || ""));
    }
    for (const [k, v] of pairs(this.P_BLINDS)) {
      G.ARGS.save_progress.UDA[k] =
        ((v.unlocked && "u") || "") + (((v.discovered && "d") || "") + ((v.alerted && "a") || ""));
  ...
  prep_stage(new_stage, new_state, new_game_obj) {
    ...
    this.ROOM = new LuaNode({
      T: { x: this.ROOM_PADDING_W, y: this.ROOM_PADDING_H, w: this.TILE_W, h: this.TILE_H },
    });
    this.ROOM.jiggle = 0;
    this.ROOM.states.drag.can = false;
    this.ROOM.set_container(this.ROOM);
    this.ROOM_ATTACH = new Moveable({
      T: {
        x: 0,
        y: 0,
        w: this.TILE_W,
  ...
  main_menu(change_context?: "splash" | "game") {
    ...
    if (
      ...
      G.SETTINGS.tutorial_progress?.completed_parts["big_blind"]
    ) {
    ...
    G.SPLASH_BACK = new Sprite(-30, -13, G.ROOM.T.w + 60, G.ROOM.T.h + 22, G.ASSET_ATLAS["ui_1"], {
      x: 2,
      y: 0,
    });
    G.SPLASH_BACK.set_alignment({ major: G.ROOM_ATTACH, type: "cm", offset: { x: 0, y: 0 } });
    ...
    this.title_top = new CardArea(0, 0, CAI.TITLE_TOP_W, CAI.TITLE_TOP_H, {
      card_limit: 1,
      type: "title",
    });
    G.SPLASH_LOGO = new Sprite(
      0,
      0,
      13 * SC_scale,
    ...
    G.E_MANAGER.add_event(
      new GameEvent({
        trigger: "after",
        delay: (change_context === "game" && 1.5) || 0,
        blockable: false,
        blocking: false,
        func: function () {
          if (change_context === "splash") {
    ...
    G.E_MANAGER.add_event(
      new GameEvent({
        trigger: "after",
        delay: (change_context === "splash" && 1.8) || (change_context === "game" && 2) || 0.5,
        blockable: false,
        blocking: false,
        func: function () {
          play_sound(
            "magic_crumple" + ((change_context === "splash" && 2) || 3),
            (change_context === "splash" && 1) || 1.3,
            0.9
          );
          ...
          new GameEvent({
            ...
            func: function () {
              card = new Card(
                ...
                1.2 * G.CARD_H * SC_scale,
                undefined,
                pseudorandom_element(viable_unlockables) || this.P_CENTERS.j_joker
              );
    ...
    G.E_MANAGER.add_event(
      new GameEvent({
        trigger: "after",
        delay: (change_context === "splash" && 4.05) || (change_context === "game" && 3) || 1.5,
        blockable: false,
        blocking: false,
        func: function () {
          set_main_menu_UI();
    ...
    new UIBox({
      definition: {
        ...
        nodes: [{ n: G.UIT.T, config: { text: G.VERSION, scale: 0.3, colour: G.C.UI.TEXT_LIGHT } }],
      },
  ...
  demo_cta() {
    ...
    let localthunk = new Sprite(0, 0, (1 * 1390) / 560, 1, G.ASSET_ATLAS["localthunk_logo"], {
      x: 0,
      y: 0,
    });
    localthunk.states.drag.can = false;
    this.MAIN_MENU_UI = new UIBox({
      definition: {
        n: G.UIT.ROOT,
        config: { align: "cm", colour: G.C.CLEAR },
        nodes: [
  ...
  init_game_object() {
    ...
    return {
      ...
      round_resets: {
        ...
        discards: 1,
        reroll_cost: 1,
        temp_reroll_cost: undefined,
        temp_handsize: undefined,
        ante: 1,
        blind_ante: 1,
  ...
  start_run(args) {
    ...
    if (!saveTable) {
      ...
      ease_background_colour_blind(
        G.STATE,
        (saveTable.BLIND.name.gsub("%s+", "") !== "" && saveTable.BLIND.name) || "Small Blind"
      );
    }
    let selected_back =
      (saveTable && saveTable.BACK.name) ||
      (args.challenge && args.challenge.deck && args.challenge.deck.type) ||
      (this.GAME.viewed_back && this.GAME.viewed_back.name) ||
      (this.GAME.selected_back && this.GAME.selected_back.name) ||
      "Red Deck";
    ...
    if (!saveTable) {
      ...
      this.GAME.pseudorandom.seed =
        args.seed ||
        (!(
          G.SETTINGS.tutorial_complete || G.SETTINGS.tutorial_progress?.completed_parts["big_blind"]
        ) &&
          "TUTORIAL") ||
    ...
    if (!saveTable) {
      ...
      this.GAME.current_round.voucher =
        (G.SETTINGS.tutorial_progress && G.SETTINGS.tutorial_progress.forced_voucher) ||
        get_next_voucher_key();
      this.GAME.round_resets.blind_tags.Small =
        (G.SETTINGS.tutorial_progress &&
          G.SETTINGS.tutorial_progress.forced_tags &&
          G.SETTINGS.tutorial_progress.forced_tags[1]) ||
        get_next_tag_key();
      this.GAME.round_resets.blind_tags.Big =
        (G.SETTINGS.tutorial_progress &&
          G.SETTINGS.tutorial_progress.forced_tags &&
          G.SETTINGS.tutorial_progress.forced_tags[2]) ||
        get_next_tag_key();
    } else {
    ...
    this.consumeables = new CardArea(0, 0, CAI.consumeable_W, CAI.consumeable_H, {
      card_limit: this.GAME.starting_params.consumable_slots,
      type: "joker",
      highlight_limit: 1,
    });
    this.jokers = new CardArea(0, 0, CAI.joker_W, CAI.joker_H, {
      card_limit: this.GAME.starting_params.joker_slots,
      type: "joker",
      highlight_limit: 1,
    });
    this.discard = new CardArea(0, 0, CAI.discard_W, CAI.discard_H, {
      card_limit: 500,
      type: "discard",
    });
    this.vouchers = new CardArea(G.discard.T.x, G.discard.T.y, G.discard.T.w, G.discard.T.h, {
      type: "discard",
      card_limit: 1e308,
    });
    this.deck = new CardArea(0, 0, CAI.deck_W, CAI.deck_H, { card_limit: 52, type: "deck" });
    this.hand = new CardArea(0, 0, CAI.hand_W, CAI.hand_H, {
      card_limit: this.GAME.starting_params.hand_size,
      type: "hand",
    });
    this.play = new CardArea(0, 0, CAI.play_W, CAI.play_H, { card_limit: 5, type: "play" });
    G.playing_cards = {};
    set_screen_positions();
    G.SPLASH_BACK = new Sprite(-30, -6, G.ROOM.T.w + 60, G.ROOM.T.h + 12, G.ASSET_ATLAS["ui_1"], {
      x: 2,
      y: 0,
    });
    ...
    G.E_MANAGER.add_event(
      new GameEvent({
        ...
        func: function () {
          ...
          G.TIMERS.BACKGROUND =
            G.TIMERS.BACKGROUND - 60 * (G.ARGS.spin.eased - G.ARGS.spin.amount) * _dt;
        },
      })
    );
    if (saveTable) {
    ...
    this.HUD_tags = {};
    G.hand_text_area = {
      chips: this.HUD.get_UIE_by_ID("hand_chips"),
      mult: this.HUD.get_UIE_by_ID("hand_mult"),
      ante: this.HUD.get_UIE_by_ID("ante_UI_count"),
      round: this.HUD.get_UIE_by_ID("round_UI_count"),
      chip_total: this.HUD.get_UIE_by_ID("hand_chip_total"),
      handname: this.HUD.get_UIE_by_ID("hand_name"),
      hand_level: this.HUD.get_UIE_by_ID("hand_level"),
      game_chips: this.HUD.get_UIE_by_ID("chip_UI_count"),
      blind_chips: this.HUD_blind.get_UIE_by_ID("HUD_blind_count"),
      blind_spacer: this.HUD.get_UIE_by_ID("blind_spacer"),
    };
  ...
  update(dt: number) {
    ...
    if (!G.fbf || G.new_frame) {
      ...
      if (G.GAME.blind && G.boss_throw_hand && this.STATE === this.STATES.SELECTING_HAND) {
        if (!this.boss_warning_text) {
          this.boss_warning_text = new UIBox({
            definition: {
              n: G.UIT.ROOT,
    ...
    if (
      ...
      G.GAME.round_resets.loc_blind_states.Small = localize(
        G.GAME.round_resets.blind_states.Small,
        "blind_states"
      );
      ...
      G.GAME.round_resets.loc_blind_states.Boss = localize(
        G.GAME.round_resets.blind_states.Boss,
        "blind_states"
      );
    }
    if (
      G.STEAM &&
      G.STEAM.send_control.update_queued &&
      (G.STEAM.send_control.force ||
        G.STEAM.send_control.last_sent_stage !== G.STAGE ||
        G.STEAM.send_control.last_sent_time < G.TIMERS.UPTIME - 120)
    ) {
    ...
    if (
      G.FILE_HANDLER &&
      G.FILE_HANDLER &&
      G.FILE_HANDLER.update_queued &&
      (G.FILE_HANDLER.force ||
        G.FILE_HANDLER.last_sent_stage !== G.STAGE ||
        (G.FILE_HANDLER.last_sent_pause !== G.SETTINGS.paused && G.FILE_HANDLER.run) ||
        !G.FILE_HANDLER.last_sent_time ||
        G.FILE_HANDLER.last_sent_time < G.TIMERS.UPTIME - G.F_SAVE_TIMER)
    ) {
  ...
  draw() {
    ...
    if (!G.debug_UI_toggle) {
      ...
      if (G.debug_splash_size_toggle) {
        ...
        if (!this.OVERLAY_MENU || !this.F_HIDE_BG) {
          ...
          for (const [k, v] of pairs(this.I.UIBOX)) {
            if (
              ...
              v !== this.OVERLAY_MENU &&
              v !== this.screenwipe &&
              v !== this.OVERLAY_TUTORIAL &&
              v !== this.debug_tools &&
              v !== this.online_leaderboard &&
              v !== this.achievement_notification
            ) {
              love.graphics.push();
              v.translate_container();
              v.draw();
          ...
          for (const [k, v] of pairs(this.I.CARD)) {
            if (
              !v.parent &&
              v !== this.CONTROLLER.dragging.target &&
              v !== this.CONTROLLER.focused.target
            ) {
              love.graphics.push();
              v.translate_container();
              v.draw();
        ...
        if (
          this.CONTROLLER.dragging.target &&
          this.CONTROLLER.dragging.target !== this.CONTROLLER.focused.target
        ) {
          love.graphics.push();
        ...
        if (
          this.CONTROLLER.focused.target &&
          this.CONTROLLER.focused.target instanceof Card &&
          (this.CONTROLLER.focused.target.area !== G.hand ||
            this.CONTROLLER.focused.target === this.CONTROLLER.dragging.target)
        ) {
          love.graphics.push();
        ...
        love.graphics.translate(
          -this.CURSOR.T.w * G.TILESCALE * G.TILESIZE * 0.5,
          -this.CURSOR.T.h * G.TILESCALE * G.TILESIZE * 0.5
        );
        this.CURSOR.draw();
        love.graphics.pop();
    ...
    if ((!G.recording_mode || G.video_control) && true) {
      ...
      G.screenwipe_amt =
        (G.screenwipe_amt &&
          0.95 * G.screenwipe_amt +
            0.05 * ((this.screenwipe && 0.4) || (this.screenglitch && 0.4) || 0)) ||
        1;
      G.SETTINGS.GRAPHICS.crt = G.SETTINGS.GRAPHICS.crt * 0.3;
      G.SHADERS["CRT"].send("distortion_fac", [
        1 + (0.07 * G.SETTINGS.GRAPHICS.crt) / 100,
        1 + (0.1 * G.SETTINGS.GRAPHICS.crt) / 100,
      ]);
      G.SHADERS["CRT"].send("scale_fac", [
        1 - (0.008 * G.SETTINGS.GRAPHICS.crt) / 100,
        1 - (0.008 * G.SETTINGS.GRAPHICS.crt) / 100,
      ]);
      ...
      G.SHADERS["CRT"].send(
        "mouse_screen_pos",
        (G.video_control && [love.graphics.getWidth() / 2, love.graphics.getHeight() / 2]) || [
          G.ARGS.eased_cursor_pos.sx,
          G.ARGS.eased_cursor_pos.sy,
        ]
      );
      ...
      if (G.check && G.SETTINGS.perf_mode) {
        ...
        for (const [a, b] of ipairs([G.check.update, G.check.draw])) {
          for (const [k, v] of ipairs(b.checkpoint_list)) {
            ...
            love.graphics.print(
              v.label + (": " + (stringFormat("%.2f", 1000 * (v.average || 0)) + "\\n")),
              10,
              -section_h + 30 + v_off
            );
  ...
  state_col(_state) {
    return [
      ((_state * 15251252.2) / 5.132) % 1,
      ((_state * 1422.5641311) / 5.42) % 1,
      ((_state * 1522.1523122) / 5.132) % 1,
      1,
    ];
  }
  update_selecting_hand(dt: number) {
    if (
      ...
      ((this.deck &&
        this.deck.cards[1] &&
        this.deck.cards[1].states.collide.is &&
        (!this.deck.cards[1].states.drag.is || this.CONTROLLER.HID.touch) &&
        !this.CONTROLLER.HID.controller) ||
        G.CONTROLLER.held_buttons.triggerleft)
    ) {
      if (this.buttons) {
        this.buttons.states.visible = false;
      }
      this.deck_preview = new UIBox({
        definition: this.UIDEF.deck_preview(),
        config: { align: "tm", offset: { x: 0, y: -0.8 }, major: this.hand, bond: "Weak" },
      });
      this.E_MANAGER.add_event(
        new GameEvent({
          blocking: false,
          blockable: false,
          func: function () {
                  ...
                  if (math.abs(G.shop.T.y - G.shop.VT.y) < 3) {
                    ...
                    if (!shop_exists) {
                      if (G.load_shop_jokers) {
                        ...
                        for (
                          let i = 1;
                          i <= G.GAME.shop.joker_max - G.shop_jokers.cards.length;
                          i++
                        ) {
            ...
            G.E_MANAGER.add_event(
              new GameEvent({
                ...
                func: function () {
                  ...
                  G.blind_select.alignment.offset.y =
                    0.8 - (G.hand.T.y - G.jokers.T.y) + G.blind_select.T.h;
                  G.ROOM.jiggle = G.ROOM.jiggle + 3;
      ...
      G.E_MANAGER.add_event(
        new GameEvent({
          ...
          func: function () {
            ...
            G.round_eval = new UIBox({
              definition: create_UIBox_round_evaluation(),
              config: {
                align: "bm",
                offset: { x: 0, y: G.ROOM.T.y + 19 },
                major: G.hand,
                bond: "Weak",
              },
            });
    ...
    if (!G.STATE_COMPLETE) {
      ...
      G.E_MANAGER.add_event(
        new GameEvent({
          trigger: "immediate",
          func: function () {
            G.booster_pack_sparkles = new Particles(1, 1, 0, 0, {
              timer: 0.015,
              scale: 0.2,
              initialize: true,
              lifespan: 1,
              ...
              colours: [
                G.C.WHITE,
                lighten(G.C.PURPLE, 0.4),
                lighten(G.C.PURPLE, 0.2),
                lighten(G.C.GOLD, 0.2),
              ],
              fill: true,
            });
            G.booster_pack_sparkles.fade_alpha = 1;
            G.booster_pack_sparkles.fade(1, 0);
            G.booster_pack = new UIBox({
      ...
      G.E_MANAGER.add_event(
        new GameEvent({
          ...
          func: function () {
            ...
            G.booster_pack_stars = new Particles(1, 1, 0, 0, {
              timer: 0.07,
              scale: 0.1,
              initialize: true,
              lifespan: 15,
            ...
            G.booster_pack_meteors = new Particles(1, 1, 0, 0, {
              timer: 2,
              scale: 0.05,
              lifespan: 1.5,
              speed: 4,
